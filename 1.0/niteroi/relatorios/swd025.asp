...
'	end select	
	...
	if RS1.EOF then
		...
		if curso=0 then
			...
			nome_unidade= GeraNomes("U",unidade,variavel2,variavel3,variavel4,variavel5,CON0,outro)
			...
			no_unidade = unidade&" - "&nome_unidade
...
'INÍCIO DO RECIBO==================================================================================
		...
		'===========================================================================
			...
			unidade = unidade*1	
			if unidade = 1 then			
			   largura_logo_pqno=formatnumber(Logo1.Width*0.3,0)
			   altura_logo_pqno=formatnumber(Logo1.Height*0.3,0)
			   Set Param_Logo_Pqno = Pdf.CreateParam
			   Param_Logo_Pqno("x") = margem 
			   Param_Logo_Pqno("y") = altura_logo_pqno+60
			   Param_Logo_Pqno("ScaleX") = 0.3
			   Param_Logo_Pqno("ScaleY") = 0.3
			   Page.Canvas.DrawImage Logo1, Param_Logo_Pqno				
			else
			   largura_logo_pqno=formatnumber(Logo2.Width*0.3,0)
			   altura_logo_pqno=formatnumber(Logo2.Height*0.3,0)
			   Set Param_Logo_Pqno = Pdf.CreateParam
			   Param_Logo_Pqno("x") = margem 
			   Param_Logo_Pqno("y") = altura_logo_pqno+40
			   Param_Logo_Pqno("ScaleX") = 0.3
			   Param_Logo_Pqno("ScaleY") = 0.3
			   Page.Canvas.DrawImage Logo2, Param_Logo_Pqno									
			end if	
			

			
			x_texto_recibo=largura_logo_pqno+ 43
			y_texto_recibo=altura_logo_pqno+80
			...
			Text_recibo = "<p><center><i><b>"&nome_unidade&"</b></i></center></p>"

		...
		if no_periodo<>"QF1" and no_periodo<>"QF2" and no_periodo<>"MB" and no_periodo<>"MT"  and no_periodo<>"MF" then	
			...
			elseif no_periodo="MF" then
				...
				if m5="&nbsp;" or m5="" or isnull(m5) then
					...
					resultado=Calc_Med_An_Fin(unidade, curso, co_etapa, turma, cod_aluno, codigo_materia, caminho_nota, tb_nota, wrk_qtd_periodos, wrk_periodo_m2, wrk_periodo_m3,"final", outro)						
					media_qf=split(resultado,"#!#")
					media=media_qf(0)			
				end if				
...
'				media=media_qf(0)
				media=""
			elseif no_periodo="MF" then
'				m5=Calcula_Media_T_F_F_N(unidade, curso, co_etapa, turma, cod_aluno, codigo_materia, caminho_nota, tb_nota, wrk_periodo_m2)	
'				if m5="&nbsp;" or m5="" or isnull(m5) then
'					acumula_media=acumula_media
'					media="&nbsp;"
'				else

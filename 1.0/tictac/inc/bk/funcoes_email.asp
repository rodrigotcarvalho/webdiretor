...
function email_anexo(p_vencimento, p_cod_aluno, p_eh_segunda_via)

e_vencimento = p_vencimento
e_cod = p_cod_aluno
ano_letivo = session("ano_letivo")
eh_segunda_via = p_eh_segunda_via

gerado =  GeraBloqueto(dados, e_cod, e_vencimento, "S") 
...
session("nvg")=chave
	...
	email_financeiro="secretaria@tictictac.com.br"
...
from=email_financeiro
	...
	for e = 0 to ubound(dados_form)
		...
		if InStr(end_email,"@")=0 then
			...
			if Mid(ambiente_escola,1,5) = "teste" or Mid(ambiente_escola,1,6) = "ateste" then

...
if ubound(alunos_encontrados)=-1 then
	...
	SQLc = "SELECT * FROM TB_Cabecalhos WHERE CO_Documento="&unidade
	RSc.Open SQLc, CON0	
	...
	if cabec_6="" or isnull(cabec_6) then
	else
		cabec_6=replace_latin_char(cabec_6,"html")	
	end if	
...
'						wend						
'					end if					
'					resultados=Calc_Med_An_Fin(unidade, curso, co_etapa, turma, cod_cons, vetor_materia, caminho_nota, tb_nota, 5, 5, 0, "final", 0)		
'
'
...
'					else				
'							resultado_final_aluno=apura_resultado_aluno(curso, co_etapa, vetor_materia)						
'					end if
					...
					for r=0 to ubound(vetor_materia_resultado)
						m3=Calc_Ter_Media (unidade, curso, co_etapa, turma, cod_cons, vetor_materia_resultado(r), caminho_nota, tb_nota, prd_ter_media, "sem_calculo", outro)	
						res=split(m3,"#!#")
						if r=0 then
...
'response.Write(gera_relatorio_aluno&"<BR>")
		...
		'CABEÇALHO==========================================================================================		
					...
					if unidade = 1 then
						...
						altura_cabecalho = formatnumber(altura_logo_gde*1.4,0)
					else
						largura_logo_gde=formatnumber(Logo2.Width*0.6,0)
						altura_logo_gde=formatnumber(Logo2.Height*0.6,0)
						area_utilizavel=Page.Width-(margem*2)
						Param_Logo_Gde("x") = margem
						Param_Logo_Gde("y") = Page.Height - altura_logo_gde -margem
						...
						altura_cabecalho = formatnumber(altura_logo_gde*1.3,0)	
					end if
					...
					if cabec_6="" or isnull(cabec_6) then
						...
						cabec_6_tx="<font style=""font-size:10pt;"">"&cabec_6&"</font><br>"
					end if					
					
					
					SET Param = Pdf.CreateParam("x="&x_texto&";y="&y_texto&"; height="&altura_cabecalho&"; width="&width_texto&"; alignment=center; color=#000000; html=true")
					Text = "<center>"&cabec_1_tx&cabec_2_tx&cabec_3_tx&cabec_4_tx&cabec_5_tx&cabec_6_tx&"</center>"
					...
					y_titulo=y_texto-altura_logo_gde-50	

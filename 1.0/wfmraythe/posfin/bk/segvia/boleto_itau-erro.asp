...
.cptit{ FONT: bold 8px Arial; COLOR: black }
		...
		RS2.Open SQL2, CON0
			...
			if RS2.EOF then
				...
				if InStr(cep_sede,"-")= 0 then
					cep_sede = "CEP: "&left(cep_sede,5)&"-"&right(cep_sede,5)
				end if
...
var_instrucoes="<BR>"&msg01&"<BR>"&msg02&"<BR>"&msg03&"<BR> Após vencimento pagar com acréscimo de multa de 2% + comissão permanência diária de R$ 0,033<br>Este bloqueto perderá a validade após 55 dias do vencimento . O pagador deverá procurar o colégio." 
...
<TABLE WIDTH="660" BORDER=1 CELLSPACING=0 CELLPADDING=1>
  <TR>
			<TD COLSPAN=5 WIDTH=500>
					...
					<FONT class=cptit>ATÉ O VENCIMENTO, PAGUE EM QUALQUER BANCO OU CORRESPONDENTE NÃO BANCÁRIO. APÓS O VENCIMENTO, ACESSE ITAU.COM.BR/BOLETOS E PAGUE EM QUALQUER BANCO OU CORRESPONDENTE NÃO BANCÁRIO.</FONT>
			</TD>
	...
	<TR>
			<TD COLSPAN=5 WIDTH=500><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    <tr>
      <td width="9%"><FONT class=ct>Benefici&aacute;rio</FONT></td>
      <td width="50%"><FONT class=cn><%=cons_cedente%></FONT></td>
      <td rowspan="2"><FONT class=ct>CNPJ</FONT></td>
      <td width="32%" rowspan="2"><FONT class=cn><%=cnpj_formatado%></FONT></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><FONT class=cn><%=endereco_sede%></FONT></td>
    </tr>
  </tbody>
</table>
</TD>
	...
	<TR>
			...
			<TD valign=top><table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td align="center"><font class="cn">DM</font></td>
				</tr>
			</table></TD>
			<TD valign=top>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<TR>
			<TH COLSPAN=5 ROWSPAN=5 valign=top align=LEFT ><FONT class=ct>INSTRUÇÕES DE RESPONSABILIDADE DO BENEFICIÁRIO. QUALQUER DÚVIDA SOBRE ESTE BOLETO, CONTATE O BENEFICIÁRIO</FONT><BR>

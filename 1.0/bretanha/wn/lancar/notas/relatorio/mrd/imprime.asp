...
<table width="950" border="0" align="center" cellspacing="0" class="tb_corpo">
  <tr> 
    <td width="203" height="15" bgcolor="#FFFFFF"><img src="../img/logo_preto.gif" width="95" height="92"> 
    </td>
...
if nota ="TB_NOTA_A" then
CAMINHOn = CAMINHO_na
Call imp_mapa_notas(CAMINHOa,CAMINHOn,unidades,grau,serie,turma,co_materia,periodo,ano_letivo,co_usr,1,0,0)
elseif nota="TB_NOTA_B" then
	CAMINHOn = CAMINHO_nb
	Call imp_mapa_notas(CAMINHOa,CAMINHOn,unidades,grau,serie,turma,co_materia,periodo,ano_letivo,co_usr,2,0,0)
elseif nota ="TB_NOTA_C" then
		CAMINHOn = CAMINHO_nc
		Call imp_mapa_notas(CAMINHOa,CAMINHOn,unidades,grau,serie,turma,co_materia,periodo,ano_letivo,co_usr,3,0,0)
else
		response.Write("ERRO")
End if

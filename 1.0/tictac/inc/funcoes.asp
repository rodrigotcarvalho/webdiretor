...
case 74
if dados = "E" then
	wrt = "Já existe Pasta com o mesmo nome!"
else
...
case 318
wrt = "Entrevista incluída com sucesso!"

case 319
wrt = "Entrevista alterada com sucesso!"

case 320
wrt = "Entrevista excluída com sucesso!"

case 321
wrt = "Preencha os dados abaixo e clique no botão Confirmar para Incluir uma nova entrevista."

case 322
wrt = "Preencha os dados abaixo e clique no botão Confirmar para atualizar esta entrevista."

case 323
wrt = "Preencha os dados abaixo e clique no botão Confirmar para incluir o conteúdo desta entrevista."

case 324
wrt = "Conteúdo de entrevista incluído com sucesso!"

case 325
wrt = "O conteúdo da entrevista inicial deve ser feito pela função Atualizar Dados Complementares!"

case 326
wrt = "Confirma a exclusão dessa(s) entrevista(s)."
...
dados_msg=dados
if dados_msg = "T" then
	wrt = "Avaliação lançada com sucesso para todos os alunos da turma."
else
	wrt = "Avaliação lançada com sucesso."
end if
...
'
'case 701
'wrt = "É necessário selecionar o local da base de dados Posicao.mdb"
'
'case 702
...
case 801
if dados = "C" then
	wrt = "Não foi encontrado nenhum fornecedor com este código."
else
	wrt = "Não foi encontrado nenhum fornecedor com este nome."
end if

case 802
wrt = "Fornecedor código "&cod_cons&" incluído com sucesso!"

case 803
wrt = "Escolha um fornecedor para atualizar o cadastro. Os fornecedores em vermelho estão inativos."

case 804
wrt = "Confirme se é o fornecedor correto para atualizar o cadastro."

case 805
wrt = "Preencha cuidadosamente os dados do Fornecedor e click no bot&atilde;o CONFIRMAR para atualizar o cadastro"

case 806
wrt = "Dados do fornecedor código "&cod_cons&" alterados com sucesso!"
...
case 808
if dados = "C" then
	wrt = "Não foi encontrado nenhum item com este código."
else
	wrt = "Não foi encontrado nenhum item com este nome."
end if

case 809
wrt = "Item código "&cod_cons&" incluído com sucesso!"

case 810
wrt = "Escolha um item para atualizar o cadastro. Os itens em vermelho estão inativos."

case 811
wrt = "Confirme se é o item correto para atualizar o cadastro."

case 812
wrt = "Preencha cuidadosamente os dados do Item e clique no bot&atilde;o CONFIRMAR para atualizar o cadastro"

case 813
wrt = "Dados do item código "&cod_cons&" alterados com sucesso!"

case 814
wrt = "Selecione um grupo para atualizar o inventário!"
...
case 818
wrt = "Grupo incluído com sucesso!"
...
case 821
wrt = "Projeto incluído com sucesso!"

case 822
wrt = "Projeto atualizado com sucesso!"

case 823
wrt = "Nota de compra incluída com sucesso!"

case 824
wrt = "Nota de compra alterada com sucesso!"

case 825
wrt = "Nota(s) de compra excluída(s) com sucesso!"

case 826
wrt = "Preencha os dados abaixo e clique no botão Confirmar para Incluir uma nova nota de compra."

case 827
wrt = "Preencha os dados abaixo e clique no botão Confirmar para atualizar esta nota de compra."

case 828
wrt = "Confirma a exclusão da(s) nota(s) de compra abaixo?"

case 829
wrt = "Movimentação de estoque incluída com sucesso!"

case 830
wrt = "Movimentação de estoque alterada com sucesso!"

case 831
wrt = "Movimentação(ões) de estoque cancelada(s) com sucesso!"

case 832
wrt = "Preencha os dados abaixo e clique no botão Confirmar para Incluir uma nova movimentação de estoque."

case 833
wrt = "Preencha os dados abaixo e clique no botão Confirmar para atualizar esta nova movimentação de estoque."

case 834
wrt = "Confirma o cancelamento da(s) movimentação(ões) de estoque abaixo?"

case 835
wrt = "Para imprimir a relação de projetos clique <a class='avisos' href=../../../../relatorios/swd835.asp>aqui</a>."

case 836
wrt = "Para imprimir a relação de fornecedores clique <a class='avisos' href=../../../../relatorios/swd836.asp?obr="&obr&">aqui</a>."

case 837
wrt = "Para imprimir a relação de grupos clique <a class='avisos' href=../../../../relatorios/swd837.asp?obr="&obr&">aqui</a>."

case 838
wrt = "Para imprimir a relação de itens clique <a class='avisos' href=../../../../relatorios/swd838.asp?obr="&obr&">aqui</a>."
...
case 9718
wrt = "Não foi possível fazer o upload. Entre em contato com o suporte!"

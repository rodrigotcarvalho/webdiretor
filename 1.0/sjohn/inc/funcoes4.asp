...
%> 
 <form action="bdl.asp?opt=cln" name="nota" method="post" onSubmit="return checksubmit()">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="20" class="tb_subtit"> <div align="center">N&ordm;</div></td>
    <td width="780" class="tb_subtit"> 
...
%> 
 <form action="bdm.asp?opt=cln" name="nota" method="post" onSubmit="return checksubmit()">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="20" class="tb_subtit"> <div align="center">N&ordm;</div></td>
    <td width="780" class="tb_subtit"> 
...
%> 
 <form action="bdl.asp" name="nota" method="post" onSubmit="return checksubmit()">
...
%> 
<form action="bdm.asp" name="nota" method="post" onSubmit="return checksubmit()">

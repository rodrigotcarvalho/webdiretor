    ...
    <td width="741" bgcolor="#FFFFFF"><table width="100%" border="0" align="right" cellspacing="0">
        ...
        <tr> 
          <td colspan="2"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>LISTA 
            DE REUNI&Atilde;O</strong></font></td>
        </tr>
      </table></td>
  </tr>
  <tr> 
    <td height="12" colspan="2" bgcolor="#EEEEEE" class="linhaTopoL"><table width="900" border="0" cellspacing="0">
        <tr class="tabela"> 
          ...
          <td width="38">&nbsp;</td>
          <td width="198">&nbsp;</td>
          <td width="86"><div align="right"><strong>Data da Reuni&atilde;o:</strong></div></td>
          <td width="290"><%response.Write(dr)%>/<%response.Write(mr)%>/<%response.Write(ar)%>
</td>
        </tr>
        <tr class="tabela"> 
...
response.Write(no_curso)%> </td>
          ...
          <td width="86"><div align="right"><strong>Motivo:</strong></div></td>
          <td width="290"><%response.Write(motivo)%></td>
        </tr>
        <tr class="tabela"> 
...
' response.Write(larg&"_"&i)%> 
      <table width="950" border="0" align="left" cellspacing="0" bordercolor="#000000">
        <tr>
          ...
          <td width="70" class="tabelaTit"> 
            <div align="center">Matr&iacute;cula</div></td>
          <td width="250" class="tabelaTit"> <div align="left"><strong>Nome do 
              Aluno</strong></div></td>
          <td width="300" class="tabelaTit"><div align="center">Nome do Respons&aacute;vel</div></td>
          <td width="300" height="40" class="tabelaTit"> 
            <div align="center">Assinatura 
              do Respons&aacute;vel</div></td>
        </tr>
        <%  check = 2
nu_chamada_check = 1
...
nu_chamada_check=nu_chamada_check+1%>
        <tr>
          ...
          <td width="70" class="tabela"> 
            <div align="center"> 
              <%response.Write(nu_matricula)%>
            </div></td>
          <td width="250"  class="tabela"> 
            <div align="left"> 
              <%response.Write(NO_Aluno)%>
            </div></td>
          <td width="300"  class="tabela">&nbsp;</td>
          <td width="300"  class="tabela"> 
...
%>
        <tr>
          <td width="30" bgcolor="#E4E4E4"  class="tabela"> 
            <div align="center"> 
              <%response.Write(nu_chamada_check)%>
            </div></td>
          <td width="70" bgcolor="#E4E4E4"  class="tabela"> 
            <div align="center">&nbsp;</div></td>

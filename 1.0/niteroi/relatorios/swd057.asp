...
'	
	...
	'CABEÇALHO==========================================================================================		
			...
			Loop 
			if unidade_form = 1 then
				y_texto=y_texto-altura_logo_gde+15
				curso_cabecalho = "Curso: Ensino M&eacute;dio"			
			else
				y_texto=y_texto-altura_logo_gde+30
				curso_cabecalho = "Cursos: Educa&ccedil;&atilde;o Infantil, Fundamental I e II"							
			end if	
			...
			Text = Text&"<font style=""font-size:14pt;"">"&curso_cabecalho&"</font></center>"
			...
			Page.Canvas.SetParams "LineCap=0" 
			altura_segundo_separador= y_texto-40
			With Page.Canvas

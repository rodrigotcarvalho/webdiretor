...
'				end if												
				...
				dados_gravados = insereTbAnoHistorico(co_matricula, ano_form, seq_historico, curso_t, co_etapa_t, "Escola Dínamis Ltda", "Brasil", no_munic, co_uf, nu_aprovado, NULL, ano_form,  "A", NULL, frequencia)								

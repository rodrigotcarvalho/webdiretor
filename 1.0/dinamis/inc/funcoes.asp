...
case 417
wrt = "Selecione uma ordem para exibição."
...
case 636
wrt = "Para imprimir clique <a class='avisos' href='#' onClick=MM_openBrWindow('imprime.asp?or=01&obr="&obr&"&p="&dados&"','','status=yes,menubar=yes,scrollbars=yes,resizable=yes,width=1030,height=500,top=50,left=50')>aqui</a>."
...
case 711
wrt = "Escolha o documento."

case 714
wrt = "Históricos importados com sucesso!"

case 750
wrt = "N&atilde;o existe contrato para o ano letivo "&session("ano_letivo")+1
...
case 9714
wrt = "Para imprimir clique <a class='avisos' href='imprime.asp?or=01&obr="&obr&"&p="&dados&"'>aqui</a>."

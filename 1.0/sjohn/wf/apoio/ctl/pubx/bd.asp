...
if unidade_grava="nulo" or unidade_grava="" or isnull(unidade_grava) then
sql_un="Unidade = NULL, "
unidade_grava= NULL
else
...
if curso_grava="nulo" or curso_grava="" or isnull(curso_grava) then
sql_cu="Curso = NULL,"
curso_grava=NULL
else
...
if etapa_grava="nulo" or etapa_grava="" or isnull(etapa_grava) then
sql_et="Etapa = NULL, "
etapa_grava=NULL
else
...
if turma_grava="nulo" or turma_grava="" or isnull(turma_grava) then
sql_tu="Turma = NULL , "
turma_grava=NULL
else
...
if unidade_grava1="nulo" or unidade_grava1="" or isnull(unidade_grava1) then
'sql_un="Unidade = NULL, "
'unidade_grava1= NULL
else
...
if curso_grava1="nulo" or curso_grava1="" or isnull(curso_grava1) then
'sql_cu="Curso = NULL,"
curso_grava1=NULL
'else
...
if etapa_grava1="nulo" or etapa_grava1="" or isnull(etapa_grava1) then
'sql_et="Etapa = NULL, "
etapa_grava1=NULL
'else
...
if turma_grava1="nulo" or turma_grava1="" or isnull(turma_grava1) then
'sql_tu="Turma = NULL , "
turma_grava1=NULL
'else
...
if unidade_grava2="nulo" or unidade_grava2="" or isnull(unidade_grava2) then
'sql_un="Unidade = NULL, "
unidade_grava2= NULL
'else
...
if curso_grava2="nulo" or curso_grava2="" or isnull(curso_grava2) then
'sql_cu="Curso = NULL,"
curso_grava2=NULL
'else
...
if etapa_grava2="nulo" or etapa_grava2="" or isnull(etapa_grava2) then
'sql_et="Etapa = NULL, "
etapa_grava2=NULL
'else
...
if turma_grava2="nulo" or turma_grava2="" or isnull(turma_grava2) then
'sql_tu="Turma = NULL , "
turma_grava2=NULL
'else
...
if unidade_grava3="nulo" or unidade_grava3="" or isnull(unidade_grava3) then
'sql_un="Unidade = NULL, "
unidade_grava3= NULL
'else
...
if curso_grava3="nulo" or curso_grava3="" or isnull(curso_grava3) then
'sql_cu="Curso = NULL,"
curso_grava3=NULL
'else
...
if etapa_grava3="nulo" or etapa_grava3="" or isnull(etapa_grava3) then
'sql_et="Etapa = NULL, "
etapa_grava3=NULL
'else
...
if turma_grava3="nulo" or turma_grava3="" or isnull(turma_grava3) then
'sql_tu="Turma = NULL , "
turma_grava3=NULL
'else
...
if unidade_grava4="nulo" or unidade_grava4="" or isnull(unidade_grava4) then
'sql_un="Unidade = NULL, "
unidade_grava4= NULL
else
...
if curso_grava4="nulo" or curso_grava4="" or isnull(curso_grava4) then
'sql_cu="Curso = NULL,"
curso_grava4=NULL
else
...
if etapa_grava4="nulo" or etapa_grava4="" or isnull(etapa_grava4) then
'sql_et="Etapa = NULL, "
etapa_grava4=NULL
else
...
if turma_grava4="nulo" or turma_grava4="" or isnull(turma_grava4) then
'sql_tu="Turma = NULL , "
turma_grava4=NULL
else

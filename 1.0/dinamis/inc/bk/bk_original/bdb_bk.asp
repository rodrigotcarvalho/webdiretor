...
'////////////////////////////////////////////////////
'Nomes
dados_tabela=dados_planilha_notas(ano_letivo,unidade,curso,etapa,turma,co_materia,0,periodo,"B",outro)
...
if grava = "ok" then
		...
		CONEXAO0 = "Select * from TB_Nota_B WHERE CO_Matricula = "& nu_matricula &" AND CO_Materia_Principal = '"& co_materia_pr &"' AND CO_Materia = '"& co_materia &"'"
...
'if periodo=1 then
'teste= "UPDATE TB_Nota_B SET "&no_apr1&" ='"&va_apr1&"', "&no_apr2&" ='"&va_apr2&"', "&no_apr3&" ='"&va_apr3&"', "&no_apr4&" ='"&va_apr4&"', "&no_apr5&" ='"&va_apr5&"', "
...
if periodo=1 then
	sql_atualiza= "UPDATE TB_Nota_B SET "&variaveis_bd(0)&" ='"&va_apr1&"', "&variaveis_bd(1)&" ='"&va_apr2&"', "&variaveis_bd(2)&" ='"&va_apr3&"', "&variaveis_bd(3)&" ='"

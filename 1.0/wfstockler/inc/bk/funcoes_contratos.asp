...
if left(p_tp_contrato_adendo,8) = "CONTRATO" then
    ...
    resultado = resultado&"<br>Estado Civil: "&SpacePad(estadoCivil,"&nbsp;",49, "R")&" Profiss&atilde;o:"&no_ocupaca
	...
	elseif p_tp_contrato_adendo = "CONTRATO1A" or p_tp_contrato_adendo = "CONTRATO1B" or p_tp_contrato_adendo = "CONTRATO8" or p_tp_contrato_adendo = "CONTRATOG1" then
...
elseif tp_contrato_adendo = "ADENDOGAV2" then
	converte_nome_adendo = "ADENDO_2"		
...
'	else
		resultado = resultado&SpacePad(endereco,"&nbsp;",45,"L")&Server.HTMLEncode(nomeDaEscola)&SpacePad(endereco,"&nbsp;",45,"L")&"Contratante" 
'	end if
end if
...
function geraNomeEscola(p_tp_contrato_adendo)
	...
	if session("ano_letivo")>=2017 then
		if p_tp_contrato_adendo = "CONTRATO_G1" or  p_tp_contrato_adendo = "ADENDO_G1" or p_tp_contrato_adendo = "CONTRATOG1" or p_tp_contrato_adendo = "CONTRATOG1" or p_tp_contrato_adendo = "ADENDOGAVA" or p_tp_contrato_adendo = "ADENDOGAVB" or p_tp_contrato_adendo = "ADENDOGAVC" or p_tp_contrato_adendo = "ADENDOGAV2" then
		...
		if p_tp_contrato_adendo = "CONTRATO_1A" or p_tp_contrato_adendo = "CONTRATO_1B" or p_tp_contrato_adendo = "CONTRATO_8" or p_tp_contrato_adendo = "ADENDO_1A" or p_tp_contrato_adendo = "ADENDO_8" or p_tp_contrato_adendo = "CONTRATO_2A" or p_tp_contrato_adendo = "CONTRATO_2B" OR p_tp_contrato_adendo = "ADENDO_2A" or p_tp_contrato_adendo = "ADENDO_2B" or p_tp_contrato_adendo = "ADENDO_2A2B" or p_tp_contrato_adendo = "CONTRATO_3" or  p_tp_contrato_adendo = "ADENDO_3" or p_tp_contrato_adendo = "CONTRATO_5" or p_tp_contrato_adendo = "ADENDO_5" or p_tp_contrato_adendo = "ADENDOESC1"  or p_tp_contrato_adendo = "ADENDOESC2" or p_tp_contrato_adendo = "ADENDOESC3" or p_tp_contrato_adendo = "ADENDOBL1" or p_tp_contrato_adendo = "ADENDOBL2" or p_tp_contrato_adendo = "ADENDOBL3" or p_tp_contrato_adendo = "ADENDOCMP1" or p_tp_contrato_adendo = "ADENDOCMP2" or p_tp_contrato_adendo = "ADENDOCMP3" then
			escola	 = "Escola Dínamis Ltda."		

...
%>
        <tr valign="bottom"> 
          <td height="20" colspan="18" class="tabela"> <div align="right"> T-Teste, MT–Média dos Testes, 
...
%>
        <tr valign="bottom"> 
          <td height="20" colspan="16" class="tabela"> <div align="right">T-Teste, MT–Média dos Testes, 

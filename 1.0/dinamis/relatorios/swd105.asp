...
'response.Write(resultados_apurados(a)&"<BR>")
				...
				for n=0 to ubound(co_materia_exibe)	
					...
					IF ISNUMERIC(resultados_materia(0))= TRUE THEN
						media=FORMATNUMBER(resultados_materia(0),1)
					ELSE
						media=resultados_materia(0)						
					END IF	
					Notas_Tit(linha, coluna).AddText "<div align=""center"">"&media&"</DIV>", param_materias	
					coluna=coluna+1	

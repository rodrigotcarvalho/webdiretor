...
'response.Write(SQL)
	...
	elseif(mae=TRUE and fil=FALSE and in_co=TRUE and isnull(peso)) then		
		...
		if no_periodo<>"QF1" and no_periodo<>"QF2" and no_periodo<>"MB" and no_periodo<>"MF" then	
			...
			media=Calcula_Media_T_F_T_N(unidade, curso, co_etapa, turma, tp_modelo, tp_freq, cod_aluno, codigo_materia, vetor_materia, caminho_nota, tb_nota, periodo, nome_nota, outro)
		else
			acumula_media=0
			if no_periodo="QF1" then
			periodo_qf=periodo_m1-1
				for periodo=1 to periodo_qf
					qf=Calcula_Media_T_F_T_N(unidade, curso, co_etapa, turma, tp_modelo, tp_freq, cod_aluno, codigo_materia, vetor_materia, caminho_nota, tb_nota, periodo, nome_nota, outro)	
					'response.Write(acumula_media&"p"&periodo&"<br>")
					if qf="&nbsp;" or qf="" or isnull(qf) then
						acumula_media=acumula_media
					else
			...
			elseif no_periodo="MB" then		
				...
				media=media_qf(0)
			elseif no_periodo="MF" then
				m5=Calcula_Media_T_F_T_N(unidade, curso, co_etapa, turma, tp_modelo, tp_freq, cod_aluno, codigo_materia, vetor_materia, caminho_nota, tb_nota, 5, nome_nota, outro)
				if m5="&nbsp;" or m5="" or isnull(m5) then
					acumula_media=acumula_media
					media="&nbsp;"
				else
...
Function Calcula_Media_T_F_T_N(unidade, curso, co_etapa, turma, tp_modelo, tp_freq, cod_aluno, codigo_materia_pr, vetor_materia, caminho_nota, tb_nota, periodo, nome_nota, outro)	

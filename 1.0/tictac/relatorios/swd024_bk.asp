...
'CABEÇALHO==========================================================================================		
   ...
   Page.Canvas.DrawImage Logo, Param_Logo_Gde
	...
	Set param_table1 = Pdf.CreateParam("width=547; height=100; rows=4; cols=8; border=0; cellborder=0; cellspacing=0;")
	...
	End With
		...
		Table(3, 7).ColSpan = 2				
		Table(4, 2).ColSpan = 4				
		Table.Rows(1).Cells(1).Height = 20			
		Table.Rows(2).Cells(1).Height = 15			
		Table.Rows(3).Cells(1).Height = 20			
		Table.Rows(4).Cells(1).Height = 45			
...
if isnull(da_atendido) or da_atendido="" then
	...
	Table(1, 2).AddText "<div align=""Left"">"&seq_pd&"</div>", "size=7;html=true", Font 
	Table(1, 3).AddText "<b>Data do Pedido:</b>", "size=7;html=true", Font 
	Table(1, 4).AddText "<div align=""Left"">"&da_show&"</div>", "size=7;html=true", Font 		
	Table(1, 5).AddText "<b>Projeto:</b>", "size=8;html=true", Font 
	Table(1, 6).AddText "<div align=""Left"">"&no_projeto&"</div>", "size=7;html=true", Font 	
	...
	Table(4, 2).AddText "<div align=""Left"">"&observacao&"</div>", "size=7;html=true", Font 	
	Table(4, 6).AddText "<b>Solicitado por:</b>", "size=8;html=true", Font 
	Table(4, 7).AddText "<div align=""Left"">"&no_registrador&"</div>", "size=7;html=true", Font 	
	Page.Canvas.DrawTable Table, "x="&x_primeira_tabela&", y="&y_primeira_tabela&"" 	
	
	Page.Canvas.SetParams "LineWidth=2" 
	Page.Canvas.SetParams "LineCap=0" 
	altura_terceiro_separador= y_primeira_tabela-100
	With Page.Canvas

...
mensagem="O(A) Professor(a) "& nome &" lançou todas as avaliações de "& NO_Materia &" do "& no_serie &" do "& no_grau &", unidade: "& no_unidades &", turma "& turma&" do Periodo "& periodo&""
'Dim objCDO
Set objCDO = Server.CreateObject("CDONTS.NewMail")
objCDO.From = email_suporte_escola
objCDO.To = mail
objCDO.CC = ""
objCDO.BCC = mail_CC

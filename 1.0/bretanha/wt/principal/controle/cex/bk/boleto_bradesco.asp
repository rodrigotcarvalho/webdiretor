...
<img src=../../../../img/boleto_bradesco/2.gif width=<%=fino%> height=<%=altura%> border=0><img 
src=../../../../img/boleto_bradesco/1.gif width=<%=fino%> height=<%=altura%> border=0><img 
src=../../../../img/boleto_bradesco/2.gif width=<%=fino%> height=<%=altura%> border=0><img 
src=../../../../img/boleto_bradesco/1.gif width=<%=fino%> height=<%=altura%> border=0><img 
...
do while len(texto) > 0
  ...
  for i = 1 to 10 step 2
    ...
    %>
    src=../../../../img/boleto_bradesco/2.gif width=<%=f1%> height=<%=altura%> border=0><img 
    <%
    ...
    %>
    src=../../../../img/boleto_bradesco/1.gif width=<%=f2%> height=<%=altura%> border=0><img 
    <%
  next
loop
...
' Draw guarda final
%>
src=../../../../img/boleto_bradesco/2.gif width=<%=largo%> height=<%=altura%> border=0><img 
src=../../../../img/boleto_bradesco/1.gif width=<%=fino%> height=<%=altura%> border=0><img 
src=../../../../img/boleto_bradesco/2.gif width=<%=1%> height=<%=altura%> border=0>
...
cons_moeda="9"
cons_especie="R$"
cons_cedente="<table width='400' border='0' cellspacing='0' cellpadding='0'><tbody><tr><td><FONT class=ct>Benefici&aacute;rio</FONT></td><td><FONT class=cn>"&no_cedente&" "&exibe_cnpj&"</FONT></td></tr><tr><td>&nbsp;</td><td><FONT class=cn>Rua Miritiba 317 - Freguesia - Ilha do Governador</FONT></td></tr></tbody></table>"
...
var_nossonumero=cons_carteira&"/"&nosso_numero
...
'var_instrucoes=msg01&"<BR>"&msg02&"<BR>"&msg03&"<BR> Após o vencimento pagar somente no Bradesco com multa de 2% + permanência diária de 0,033%<BR><BR><b>ATEN&Ccedil;&Atilde;O!</b><BR>PAGAMENTO após 30 dias do vencimento SOMENTE NA ESCOLA" 
'var_instrucoes=msg01&"<BR>"&msg02&"<BR>Após o vencimento de "&var_datavencimento&", pagar somente no Bradesco com multa de 2% + permanência diária de 0,033%<BR><BR><b>ATEN&Ccedil;&Atilde;O!</b><BR>PAGAMENTO após 30 dias do vencimento SOMENTE NA ESCOLA" 
var_instrucoes=msg01&"<BR>"&msg02&"<BR>Após o vencimento de "&var_datavencimento&", pagar somente no Bradesco com multa de 2% + permanência diária de 0,033%<BR>" 
...
<TABLE WIDTH="660" CELLSPACING=0 CELLPADDING=0 BORDER=0>
  	<TR>
		...
		<TD ALIGN=RIGHT VALIGN=BOTTOM><FONT class=ld><B>RECIBO DO PAGADOR</B></FONT></TD>
	</TR>
</TABLE>
<TABLE WIDTH="660" CELLSPACING=0 CELLPADDING=0 BORDER=0>
	<TR>
...
<img src="../../../../img/boleto_bradesco/corte.gif" border=0 width="660"><br><br>

<TABLE WIDTH="660" BORDER=0 CELLSPACING=0 CELLPADDING=0>
  <tr>
		<td class=cp width=150><div align="left" class="ld"><img src="../../../../img/boleto_bradesco/logobanco.gif" width="91" height="26"></div></td>
  		<td width=3 valign="bottom"><img height=22 src="../../../../img/boleto_bradesco/barra.gif" width=2 border=0></td>
	  	<td class=cpt  width=58 valign="bottom"><div align="center"><font class="bc"><%=cons_banco%>-<%=cons_dvbanco%></font></div></td>
  		<td width=3 valign="bottom"><img height=22 src="../../../../img/boleto_bradesco/barra.gif" width=2 border=0></td>
	  	<td class=ld align=right width=455 valign="bottom"><span class='ld'><p align="right">&nbsp;<%=var_linhadigitavel%></span></td>
  </tr>
</TABLE>
<TABLE WIDTH="660" BORDER=1 CELLSPACING=0 CELLPADDING=1>
  <TR>
			<TD COLSPAN=5 WIDTH=500>
					...
					<!--<FONT class=cp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ATÉ O VENCIMENTO PAGÁVEL EM QUALQUER BANCO</FONT>--><FONT class=cp>Pagável Preferencialmente nas agências do Bradesco</FONT>
			</TD>
	...
	<TR>
			<TD COLSPAN=5 WIDTH=500><%=cons_cedente%></TD>
			<TD width=170>
			   <TABLE WIDTH=100% BORDER=0 CELLSPACING=0 CELLPADDING=0>
				     <TR><TD align=left><FONT class=ct>Ag&ecirc;ncia / C&oacute;digo Benefici&aacute;rio</FONT></TD></TR>
	...
	<TR>
			...
			<TD valign=top><table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td align="center"><font class="cn"><!--DP-->OU</font></td>
				</tr>
			</table></TD>
			<TD valign=top>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<TR>
			<TH COLSPAN=5 ROWSPAN=5 valign=top align=LEFT ><FONT class=ct>Instru&ccedil;&otilde;es (Todas as informa&ccedil;&otilde;es deste bloqueto s&atilde;o de exclusiva responsabilidade do benefici&aacute;rio) </FONT><BR>
 				<TABLE WIDTH="475" ALIGN=RIGHT CELLSPACING=0 CELLPADDING=0 BORDER=0>
					<TR>
						<TD valign=top align=left>
							<FONT class=cn>
								<%=var_instrucoes%><BR><BR>O imposto sobre Serviços já incluído no preço, foi calculado pela alíquota de 5% de acordo com a lei<BR> Serviços Adicionais poderão ser cobrados a parte conforme prevista cláusula V parágrafo primeiro do contrato.
							</FONT>
						</TD>
					</TR>
				</TABLE>
...
<TABLE WIDTH="660" CELLSPACING=0 CELLPADDING=0 BORDER=0>
	...
	<TR>
		<TD height="25" align=left valign="bottom"><img src="../../../../img/boleto_bradesco/corte.gif" width="660" height="16" border="0" /></TD>
	</TR>
	<TR>

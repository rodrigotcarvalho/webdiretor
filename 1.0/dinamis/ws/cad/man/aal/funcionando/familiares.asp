				...
				if tp_vinc_familiar_aux=foco and co_vinc_familiar_aux=cod_consulta then
					...
					if cod_familiar=foco then
						...
						if RSCONTATO_aux.EOF then
								...
								sql_atualiza= "UPDATE TBI_Contatos SET CO_Matricula_Vinc="&co_vinc_familiar_aux&", NO_Contato='', TP_Contato_Vinc ='"& tp_vinc_familiar_aux&"' WHERE CO_Matricula = "& cod_consulta &" AND TP_Contato = '"& cod_familiar &"'"
...
sit_vinculado="n"
	...
	javascript_recupera="recuperarFamiliares('"&Server.URLEncode(ordem_familiares)&"','"&qtd_tipo_familiares&"','"&Server.URLEncode(cod_familiar)&"','"&cod_consulta&"','"&cod&"')"
	javascript_inclui ="criaFamiliar('"&Server.URLEncode(ordem_familiares)&"','"&qtd_tipo_familiares&"',this.value,'"&cod_consulta&"','"&cod&"')"
				  
'Lê os familiares do Aluno e vê se este familiar é vinculado a outro aluno por isso é cod e não cod_consulta

			'response.Write (foco&" SELECT * FROM TBI_Contatos WHERE TP_Contato='"&cod_familiar&"' and CO_Matricula "&opt&" <BR>")
...
if cod_familiar="ALUNO" then
	...
	if RSCONTATO.EOF and opt<>"i"then 
						...
						mes_end = RSCONTATO_vinc("ID_Res_Aluno")
							...
							RSCONTATO_aux.Open SQLAA_aux, CONCONT_aux
								...
								if RSCONTATO_aux.EOF then
									...
									RSCONTATO_aux_bd("NO_Contato")=nome_contato
									RSCONTATO_aux_bd("DA_Nascimento_Contato")=nasce_familiar_aux
									RSCONTATO_aux_bd("CO_CPF_PFisica")=cpf_familiar_aux
									RSCONTATO_aux_bd("CO_RG_PFisica")=rg_familiar_aux
									RSCONTATO_aux_bd("CO_OERG_PFisica")=emitido_familiar_aux
		...
		codigo_familiar_vinculado=RSCONTATO("CO_Matricula_Vinc")
		tipo_familiar_vinculado=RSCONTATO("TP_Contato_Vinc")
			if (isnull(tipo_familiar_vinculado) or tipo_familiar_vinculado="") and(isnull(codigo_familiar_vinculado) or codigo_familiar_vinculado="") then
			sit_vinculado="n"
			else
			sit_vinculado="s"
			end if
		...
		%>		          <td width="55"><div align="right">
			...
			<%else%>
						  ...
						  <input name="botao" class="aba_exclui" type="button" id="botao" value="X" onClick="<%response.Write("ConfirmaExcluirFamiliares('"&Server.URLEncode(ordem_familiares)&"','"&qtd_tipo_familiares&"','"&Server.URLEncode(cod_familiar)&"','"&cod&"')")%>">			  
						</div></td>
			<%
			end if
		end if
...
%>  				
  ...
  <tr>
                <td height="150" class="tabela_aba"> 
                  <div id="conteudo">
<%
'foco é definido como nulo em executa.asp
if foco<>"nulo" then%>	
...
<%end if%>							  
                <tr> 
                  <td colspan="9" class="tb_tit">Dados Pessoais <%'response.Write(">>"&dados)%></td>
                </tr>
                <tr> 
                  ...
                  <td width="144" height="26"> <input name="nasce_fam" type="text" class="borda" id="nasce_fam" onKeyup="formatar(this,'##/##/####')" value="<%response.write(nasce)%>" size="12" maxlength="10" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'DA_Nascimento_Contato')"></td>
                  ...
                  <td width="149" height="26"> <div align="left"><font class="form_corpo"> 
					  ...
					  <input name="cod_consulta" type="hidden" value="<%response.Write(cod)%>"><%'response.Write("TADA2"&cod)%>
                      <input type="hidden" name="tp_vinc_familiar_aux" value="">
                      <input type="hidden" name="co_vinc_familiar_aux" value="">
					   <%else%>					  
					  <input name="cod_consulta" type="hidden" value="<%response.Write(cod_consulta)%>"><%'response.Write("TADA - "&cod_consulta)%>
                      <input type="hidden" name="tp_vinc_familiar_aux" value="<%response.Write(tp_vinc_familiar_aux)%>"><%'response.Write(Server.URLEncode(">>"&tp_vinc_familiar_aux))%>
                      <input type="hidden" name="co_vinc_familiar_aux" value="<%response.Write(co_vinc_familiar_aux)%>"><%'response.Write("TADA"&co_vinc_familiar_aux)%>
					  <%end if%>					  
                      </font></div></td>
                </tr>
                <tr> 
                  ...
                  <td width="17"> <div align="center"><font class="form_dado_texto">:</font></div></td>
                  <td width="186" height="26"><font class="form_corpo"> 
                    <select name="ocupacao_fam" class="borda" id="ocupacao_fam" onChange="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'CO_Ocupacao')">
...
%>
                  ...
                  <input name="trabalho_fam" type="text" class="borda" id="trabalho_fam" size="24" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'NO_Empresa')">
                    <%else%>
                    <input name="trabalho_fam" type="text" class="borda" id="trabalho_fam" value="<%response.write(Server.URLEncode(empresa))%>" size="24" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'NO_Empresa')">
                    <%end if%>
                    </font></td>
                  <td width="147" height="26"> <div align="left"><font class="form_dado_texto">E-mail 
                      </font></div></td>
                  <td width="17"> <div align="center"><font class="form_dado_texto">:</font></div></td>
                  <td width="149" height="26"> <input name="email_fam" type="text" class="borda" id="email_fam" value="<%response.write(mail)%>" size="20" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'TX_EMail')"></td>
                </tr>
                <tr> 
				  ...
				  <%'response.Write("ValidaCPFFamiliar(this.value,"&Server.URLEncode(ordem_familiares)&"','"&Server.URLEncode(qtd_tipo_familiares)&"','"&foco&"','"&cod&"')")%>
                    <input name="cpf_fam" type="text" class="borda" id="cpf_fam" onBlur="ValidaCPFFamiliar(this.value,ordem_familiares.value,qtd_tipo_familiares.value,cod_familiar.value,cod_consulta.value)"  onKeyup="formatar(this,'#########-##')" value="<%response.write(cpf)%>" size="15">
                    </font></td>
                  <td width="175" height="10"> <div align="left"><font class="form_dado_texto">Identidade 
                      </font></div></td>
                  <td width="18"> <div align="center"><font class="form_dado_texto">:</font></div></td>
                  <td width="144" height="10"><font class="form_corpo"> 
                    <input name="id_fam" type="text" class="borda" id="id_fam" value="<%response.write(rg)%>" size="15" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'CO_RG_PFisica')">
                    </font> </td>
                  ...
                  <td width="149" height="10"><font class="form_corpo"> 
                    <input name="tipo_id_fam" type="text" class="borda" id="tipo_id_fam" value="<%response.write(emitido)%>" size="10" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'CO_OERG_PFisica')">
                    - 
                    <input name="nasce2_fam" type="text" class="borda" id="nasce2_fam" onKeyUp="formatar(this, '##/##/####')" value="<%response.write(emissao)%>" size="11" maxlength="10" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'CO_DERG_PFisica')">
                    </font></td>
                </tr>
                <tr> 
                  ...
                  <td width="186" height="10"><font class="form_corpo"> 
                    <input name="tel_fam" type="text" class="borda" id="tel" value="<%response.write(tel)%>" size="42" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'NU_Telefones')">
                    </font> </td>
...
><font class="form_corpo"> 
                                              ...
                                              <input name="num_res_fam" type="hidden" class="borda" id="num_res"  value="<%response.write(num_res)%>" size="12" maxlength="10">
                                              </font></td>
...
%>
                                              <input name="estadores_fam" type="hidden" class="borda" id="estadores_fam" value="<%response.write(Server.URLEncode(NO_UF))%>" size="12" maxlength="10">
                                              <%
END IF
%>
                                              </font></td>
...
response.Write(Server.URLEncode(NO_UF))
%>
                                              <input name="cidres_fam" type="hidden" class="borda" id="cidres_fam" value="<%response.write(Server.URLEncode(NO_UF))%>" size="12" maxlength="10">
                                              <%
END IF
%>
                                              </font></td>
...
response.Write(Server.URLEncode(NO_UF))
%>
                                              <input name="bairrores_fam" type="hidden" class="borda" id="bairrores_fam" value="<%response.write(Server.URLEncode(NO_UF))%>" size="12" maxlength="10">
                                              <%
END IF
%>
                                              </font></td>
...
><font class="form_corpo"> 
                             ...
                             <input name="rua_res_fam" type="text" class="borda" id="rua_res_fam" size="30" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'NO_Logradouro_Res')"> 
                                  <%else%>
                                  <input name="rua_res_fam" type="text" class="borda" id="rua_res_fam" value="<%response.write(Server.URLEncode(rua_res))%>" size="30" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'NO_Logradouro_Res')">
                                  <%end if%>
                                  </font></td>
                                <td width="140" height="10" class="tb_corpo"
> <div align="left"><font class="form_dado_texto"> N&uacute;mero</font></div></td>
...
><font class="form_corpo"> 
                                  <input name="num_res_fam" type="text" class="borda" id="num_res_fam"  value="<%response.write(num_res)%>" size="12" maxlength="10" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'NU_Logradouro_Res')">
                                  </font></td>
                                <td width="90" class="tb_corpo"
><font class="form_dado_texto">Complemento</font></td>
                                <td width="15" class="tb_corpo"
...
> <div align="left"><font class="form_corpo"> </font> <font class="form_corpo"> 
                                   ...
                                   <input name="comp_res_fam" type="text" class="borda" id="comp_res_fam" size="20" maxlength="15" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'TX_Complemento_Logradouro_Res')">
                                    <%else%>
                                    <input name="comp_res_fam" type="text" class="borda" id="comp_res_fam" value="<%response.write(Server.URLEncode(comp_res))%>" size="20" maxlength="15" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'TX_Complemento_Logradouro_Res')">
                                    <%end if%>
                                    </font></div></td>
                              </tr>
                              <tr> 
...
><font class="form_corpo"> <font class="form_corpo"> 
                                  <select name="estadores_fam" class="borda" id="estadores_fam" onChange="recuperarCidResFam(this.value);BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'SG_UF_Res')">
                                    <option value="0" > </option>
                                    <%				
		Set RS2 = Server.CreateObject("ADODB.Recordset")
...
><font class="form_corpo"> 
                                  <div id="cid_res_fam"> 
                                    <select name="cidres_fam" class="borda" id="cidres_fam" onChange="recuperarBairroResFam(this.value);BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'CO_Municipio_Res')">
...
> <div id="bairro_res_fam"><font class="form_corpo"> 
                                    <select name="bairrores_fam" class="borda" id="bairrores_fam" onChange="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'CO_Bairro_Res')">
                                      <%
...
> <div align="center"><font class="form_dado_texto">:</font></div></td>
                                <td width="217" height="10" class="tb_corpo"
><font class="form_dado_texto"> 
                                  <input name="cep_fam" type="text" class="borda" id="cep_fam" onKeyup="formatar(this, '#####-###')" value="<%response.write(cep)%>" size="11" maxlength="9" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'CO_CEP_Res')">
                                  </font></td>
                                <td width="140" height="10" class="tb_corpo"
>&nbsp;</td>
                                <td width="19" class="tb_corpo"
...
> <div align="center"><font class="form_dado_texto">:</font></div></td>
                                <td height="10" colspan="2" class="tb_corpo"
><font class="form_corpo"> 
                                  <input name="tel_res_fam" type="text" class="borda" id="tel_res_fam" value="<%response.write(tel_res)%>" size="42" maxlength="50" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'NU_Telefones_Res')">
                                  </font> </td>
                                <td width="19" class="tb_corpo"
> <div align="center"></div></td>
                                <td width="196" class="tb_corpo"
...
> 
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr> 
                                      <td width="9%"><input type="radio" name="mes_end" value="s"  onClick="recuperarEnd('<%response.Write(cod_consulta)%>','<%response.Write(foco)%>');BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'ID_Res_Aluno')"></td>
                                      <td width="25%"><font class="form_corpo">Sim</font></td>
                                      <td width="5%"><input name="mes_end" type="radio"  onClick="recuperarOrigemEnd('<%response.Write(cod_consulta)%>','<%response.Write(foco)%>');BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'ID_Res_Aluno')" value="n" checked></td>
                                      <td width="61%"><font class="form_corpo">N&atilde;o 
...
><font class="form_corpo">
                          ...
                          <input name="rua_com_fam" type="text" class="borda" id="rua_com_fam" size="30" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'NO_Logradouro_Com')">
                                  <%else%>
                          <input name="rua_com_fam" type="text" class="borda" id="rua_com_fam" value="<%response.write(Server.URLEncode(rua_com))%>" size="30" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'NO_Logradouro_Com')">
                                  <%end if%>
...
> <div align="center"><font class="form_dado_texto">:</font></div></td>
                        <td width="196" class="tb_corpo"
><font class="form_corpo"> 
                          <input name="num_com_fam" type="text" class="borda" id="num_com_fam" value="<%response.write(num_com)%>" size="12" maxlength="10" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'NU_Logradouro_Com')">
                          </font></td>
                        <td width="90" class="tb_corpo"
><font class="form_dado_texto">Complemento</font></td>
...
> <div align="left"><font class="form_corpo"> </font> <font class="form_corpo"> 
							...
							<input name="comp_com_fam" type="text" class="borda" id="comp_com" size="20" maxlength="15" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'TX_Complemento_Logradouro_Com')">
							<%else%>
							<input name="comp_com_fam" type="text" class="borda" id="comp_com" value="<%response.write(Server.URLEncode(comp_com))%>" size="20" maxlength="15" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'TX_Complemento_Logradouro_Com')">
							<%end if%>
                            </font></div></td>
                      </tr>
                      <tr class="tb_corpo"
> 
                        ...
                        <td width="217" height="26"><font class="form_corpo"> 
                          <select name="estadocom_fam" class="borda" id="estadocom_fam" onChange="recuperarCidComFam(this.value);BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'SG_UF_Com')">
                                    <option value="0" > </option>
                            <%				
		Set RS2 = Server.CreateObject("ADODB.Recordset")
		SQL2 = "SELECT * FROM TB_UF order by NO_UF"
...
%>
                        ...
                        <td width="196"> <div id="cid_com_fam"> 
                            <select name="cidcom_fam" class="borda" id="cidcom_fam" onChange="recuperarBairroComFam(this.value);BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'CO_Municipio_Com')">
                              <%
...
%>
                        ...
                        <td width="149" height="26"> <div id="bairro_com_fam"><font class="form_corpo"> 
                            <select name="bairrocom_fam" class="borda" id="bairrocom_fam" onChange="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'CO_Bairro_Com')">
                              <%
...
> 
                        ...
                        <td width="217" height="26"><font class="form_dado_texto"> 
                          <input name="cepcom_fam" type="text" class="borda" id="cepcom_fam" onKeyup="formatar(this, '#####-###')" value="<%response.write(cepcom)%>" size="11" maxlength="9"  onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'CO_CEP_Com')">                          </font></td>
...
> 
                        ...
                        <td height="28" colspan="2"><font class="form_corpo"> 
                          <input name="tel_com_fam" type="text" class="borda" id="tel_com_fam" value="<%response.write(tel_com)%>" size="42" maxlength="50" onBlur="BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'NU_Telefones_Com')">
                          </font> </td>
                        <td width="19">&nbsp; </td>
                        <td width="196">&nbsp;</td>
                        <td width="90">&nbsp;</td>
...
<% if aluno_vinculado="s" then%>
    ...
    <tr> 
      ...
      <td width="217" height="10"> <div align="left"><font class="form_dado_texto"> 
		...
		SQLs = "SELECT * FROM TBI_Alunos WHERE CO_Matricula ="&cod_consulta
...
if RSRESPs.EOF then
		...
		SQLRESP_PED_vinc= "SELECT * FROM TBI_Contatos WHERE TP_Contato='"&resp_fin&"' and CO_Matricula ="&co_vinc_familiar_aux
...
if RSRESPs.EOF then
		...
		'response.Write("<br>SELECT * FROM TBI_Contatos WHERE TP_Contato='"&tp_familiar_vinc&"' and CO_Matricula ="&cod_vinc)
		Set RSRESP_PED_vinc = Server.CreateObject("ADODB.Recordset")
		SQLRESP_PED_vinc= "SELECT * FROM TBI_Contatos WHERE TP_Contato='"&resp_ped&"' and CO_Matricula ="&co_vinc_familiar_aux
		RSRESP_PED_vinc.Open SQLRESP_PED_vinc, CONCONT_aux
...
cod_familiar = RSCONTPR("TP_Contato")
		...
		SQLRESP_PED= "SELECT * FROM TBI_Contatos WHERE TP_Contato='"&cod_familiar&"' and CO_Matricula ="&cod_consulta
...
%>
      ...
      <td width="140" height="10"><font class="form_dado_texto">Fam&iacute;lia</font></td>
      <td width="19" height="10"><div align="center"><font class="form_dado_texto">:</font></div></td>
      <td width="196" height="10"><input name="id_familia" type="text" class="borda" value="<%response.Write(id_familia)%>" id="rg2" size="30" onBlur="GravaResponsaveis(this.value,'ID_Familia',rf.value,'TP_Resp_Fin','<%response.write(cod_consulta)%>')"> 
      </td>
      <td width="90"><font class="form_dado_texto">End. Bloqueto </font></td>
      <td width="11"><div align="center"><font class="form_dado_texto">?</font></div></td>
...
%>
    ...
    <tr> 
      <td height="10"><font class="form_dado_texto">Pedag&oacute;gico</font></td>
      <td height="10"><div align="center"><font class="form_dado_texto">:</font></div></td>
      <td height="10"> 	  <select name="rp" class="borda" onChange="GravaResponsaveis(this.value,'TP_Resp_Ped',0,'TP_Resp_Ped','<%response.write(cod_consulta)%>')">
          <option value="0" ></option>
<%
...
%>
      ...
      <td width="90" height="10"><font class="form_dado_texto">End. Circular</font></td>
      <td width="11" height="10"><div align="center"><font class="form_dado_texto">?</font></div></td>
      <td width="149" height="10"><select name="circ" class="borda" id="circ" onChange="GravaResponsaveis(this.value,'ID_End_Bloqueto',rp.value,'TP_Resp_Ped','<%response.write(cod_consulta)%>')">
          <%if id_end_bloq="R" then
						  %>
          <option value="R" selected> Residencial </option>
          <option value="C"> Comercial </option>

...
if opt="i" or opt="a" then
	...
	if curso_grava="999990" or curso_grava="nulo" or curso_grava="" or isnull(curso_grava) then
	sql_cu="Curso = NULL,"
	curso_grava=NULL
	else
	...
	if etapa_grava="999990" or etapa_grava="nulo" or etapa_grava="" or isnull(etapa_grava) then
	sql_et="Etapa = NULL, "
	etapa_grava=NULL
	else
	...
	if turma_grava="999990" or turma_grava="nulo" or  turma_grava="" or isnull(turma_grava) then
	sql_tu="Turma = NULL , "
	turma_grava=NULL
	else
	...
	if curso_grava1="999990" or curso_grava1="" or curso_grava1="nulo" or  isnull(curso_grava1) then
	'sql_cu="Curso = NULL,"
	curso_grava1=NULL
	'else
	...
	if etapa_grava1="999990" or etapa_grava1="" or etapa_grava1="nulo" or isnull(etapa_grava1) then
	'sql_et="Etapa = NULL, "
	etapa_grava1=NULL
	'else
	...
	if turma_grava1="999990" or turma_grava1="" or turma_grava1="nulo" or  isnull(turma_grava1) then
	'sql_tu="Turma = NULL , "
	turma_grava1=NULL
	'else
	...
	if unidade_grava2="999990" or unidade_grava2="" or unidade_grava2="nulo" or isnull(unidade_grava2) then
	'sql_un="Unidade = NULL, "
	unidade_grava2= NULL
	'else
	...
	if curso_grava2="999990" or curso_grava2="" or curso_grava2="nulo" or isnull(curso_grava2) then
	'sql_cu="Curso = NULL,"
	curso_grava2=NULL
	'else
	...
	if etapa_grava2="999990" or etapa_grava2="" or etapa_grava2="nulo" or isnull(etapa_grava2) then
	'sql_et="Etapa = NULL, "
	etapa_grava2=NULL
	'else
	...
	if turma_grava2="999990" or turma_grava2="" or turma_grava2="nulo" or isnull(turma_grava2) then
	'sql_tu="Turma = NULL , "
	turma_grava2=NULL
	'else
	...
	if unidade_grava3="999990" or unidade_grava3="" or unidade_grava3="nulo" or isnull(unidade_grava3) then
	'sql_un="Unidade = NULL, "
	unidade_grava3= NULL
	'else
	...
	if curso_grava3="999990" or curso_grava3="" or curso_grava3="nulo" or isnull(curso_grava3) then
	'sql_cu="Curso = NULL,"
	curso_grava3=NULL
	'else
	...
	if etapa_grava3="999990" or etapa_grava3="" or etapa_grava3="nulo" or isnull(etapa_grava3) then
	'sql_et="Etapa = NULL, "
	etapa_grava3=NULL
	'else
	...
	if turma_grava3="999990" or turma_grava3="" or turma_grava3="nulo" or isnull(turma_grava3) then
	'sql_tu="Turma = NULL , "
	turma_grava3=NULL
	'else
	...
	if curso_grava4="999990" or curso_grava4="" or curso_grava4="nulo" or isnull(curso_grava4) then
	'sql_cu="Curso = NULL,"
	curso_grava4=NULL
	else
	...
	if etapa_grava4="999990" or etapa_grava4="" or etapa_grava4="nulo" or isnull(etapa_grava4) then
	'sql_et="Etapa = NULL, "
	etapa_grava4=NULL
	else
	...
	if turma_grava4="999990" or turma_grava4="" or turma_grava4="nulo" or isnull(turma_grava4) then
	'sql_tu="Turma = NULL , "
	turma_grava4=NULL
	else

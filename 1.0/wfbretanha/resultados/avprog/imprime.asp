...
%>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="140" rowspan="2" class="tabela"> 
            <div align="left">Disciplina</div></td>
          <td width="33" rowspan="2" align="center"  class="tabela"><div align="center">F</div></td>
          ...
          <td width="150" rowspan="2" class="tabela"> 
            <div align="center">Alterado 
              por</div></td>
          <td width="110" rowspan="2" class="tabela"> <div align="center">Data/Hora</div></td>
        </tr>
        <tr>
          <td width="33"  class="tabela"> 
...
%>
        <tr class="<%response.Write(cor)%>"> 
          <td class="tabela" width="140"> 
            <%response.Write("&nbsp;"&no_materia)%>
          </td>
          <td width="33" class="tabela" align="center">
			 <%
            if showapr="s" then							
...
%>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="140" rowspan="2" class="tabela"> 
            <div align="left">Disciplina</div></td>
          <td width="37" rowspan="2" align="center"  class="tabela"><div align="center">F</div></td>
 ...
 if check mod 2 =0 then
  cor = "tabela" 
						...
						%>
        <tr class="<%response.Write(cor)%>"> 
          <td width="140" class="tabela" > 
            <%response.Write("&nbsp;"&no_materia)%>
          </td>
          <td class="tabela" width="37" align="center">			 <%
            if showapr="s" then							
            response.Write(va_fal)
            End IF							
            %> </td>
 ...
 if check mod 2 =0 then
  cor = "tabela" 
        ...
        <tr class="<%response.Write(cor)%>"> 
          ...
          <td width="37" class="tabela" align="center">			 <%
            if showapr="s" then							
            response.Write(va_fal)
            End IF							
            %> </td>
...
<!--               <%
        ...
        <%
				...
				%>
        <tr class="tabela"> 
          <td class="tabela" width="140">&nbsp;&nbsp;&nbsp; M&eacute;dia</td>
          <td width="37" class="tabela" align="center">                              <%
							if showapr="s" then							

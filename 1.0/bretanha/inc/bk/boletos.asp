...
if nivel= 4 then
	...
	Set Itau = Doc.OpenImage( Server.MapPath( pastas&"img/boleto_bradesco/logobanco.gif") )	
...
cod_cons = vetorMatriculas(l)
	...
	'================================================================================================================					
		...
		'Cria tabelas com informações de cobrança---------------------------------------------------------------------	
					...
					var_instrucoes="<font style=""font-size:6pt;"">IInstru&ccedil;&otilde;es (Todas as informa&ccedil;&otilde;es deste bloqueto s&atilde;o de exclusiva responsabilidade do benefici&aacute;rio)</font><font style=""font-size:3pt;""><BR>&nbsp;<br></FONT><font style=""font-size:7pt;"">"&msg01&"<BR>&nbsp;<BR>"&msg02

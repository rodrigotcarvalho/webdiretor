...
<%end if%>							  
                ...
                <tr> 
                  ...
                  <td width="186" height="26"><font class="form_corpo"> 
                    ...
                    <%else%>
                          <input name="nome_familiar" type="text" class="borda" id="nome_familiar" onBlur="ValidaNomeFamiliar(this.value)" value="<%response.Write(Server.URLEncode(nome_contato))%>" size="30" maxlength="50">
                    <%
					end if%>
                    </font></td>
...
%>
                ...
                <tr> 
				  ...
				  <%'response.Write("ValidaCPFFamiliar(this.value,"&Server.URLEncode(ordem_familiares)&"','"&Server.URLEncode(qtd_tipo_familiares)&"','"&foco&"','"&cod&"')")%>
                          <input name="cpf_fam" type="text" class="borda" id="cpf_fam" onBlur="ValidaCPFFamiliar(this.value,ordem_familiares.value,qtd_tipo_familiares.value,cod_familiar.value,cod_consulta.value)"  onKeyup="formatar(this,'#########-##')" value="<%response.write(cpf)%>" size="15" maxlength="15">
                    </font></td>
...
> 
                        ...
                        <td width="217" height="26"><font class="form_dado_texto"> 
                          <input name="cepcom_fam" type="text" class="borda" id="cepcom_fam" onKeyup="formatar(this, '#####-###')" value="<%response.write(cepcom)%>" size="11" maxlength="9" onBlur="ValidaCepComFam(this.value)"></font></td>

...
opcao_contrato = request.querystring("contrato")

	boletoGerado = GeraBoletosPorContrato(1, dados, cod_matric, mes_solici, ucet, de, ate, tipo, restricao, opcao_contrato)

...
<!--#include file="../inc/banner_novo.asp"-->
<%
...
call banner_novo(nivel,this_file,sistema_local,nome,permissao,ano_letivo)
end function
...
case 303
if not isnull(dados) or dados<>"" then
	wrt = "A matrícula "&dados&" não existe no cadastro."
else
...
case 304
if not isnull(dados) or dados<>"" then
	wrt = "O nome "&dados&" não existe no cadastro de alunos."
else
...
case 9714
wrt = "Para imprimir clique <a class='avisos' href='redireciona.asp' onClick='return checkTheBoxRedireciona()')>aqui</a>."

case 9715
wrt = "ERRO! Valor digitado n&atilde;o &eacute; num&eacute;rico"

case 9716
wrt = "ERRO! Valor digitado n&atilde;o &eacute; inteiro"

case 9717
wrt = "ERRO! Valor digitado deve nulo ou ser entre zero e 100 "

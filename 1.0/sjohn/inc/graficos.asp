...
Dim categories(20), Vals(20), Vals2(20)
...
.Charts(0).SeriesCollection(0).DataLabelsCollection(0).Font.Color = "#333366"
.Charts(0).SeriesCollection(0).DataLabelsCollection(0).Interior.Color = RGB(255, 255, 255)
...
Dim categories(20), Vals(21), nome_turma(10)
...
'===========================================================================================================
function Barra(faixas,categorias)
response.Charset="ISO-8859-1"
Set oChart = CreateObject("OWC10.ChartSpace")
Set c = oChart.Constants
oChart.Border.Color = c.chColorNone
 
Dim categories(50), Vals(51), nome_turma(10)
...
.Charts(0).HasTitle = False
.Charts(0).Axes(c.chAxisPositionValue).HasMajorGridlines = True
.Charts(0).Axes(c.chAxisPositionValue).HasMinorGridlines = True
...
'===========================================================================================================
function ColunaEmpilhada(faixas,categorias,legenda,series,outro)
response.Charset="ISO-8859-1"
Set oChart = CreateObject("OWC10.ChartSpace")
Set c = oChart.Constants
oChart.Border.Color = c.chColorNone
...
End With
maximo_escala=maximo_escala*1
maximo_escala=maximo_escala+1000
With oChart
.Charts(0).Axes(1).Scaling.Minimum = 0
.Charts(0).Axes(1).Scaling.Maximum = maximo_escala
.Charts(0).HasLegend = True
...
'===========================================================================================================
function ColunaAgrupada_s3D(faixas,categorias)
response.Charset="ISO-8859-1"
Set oChart = CreateObject("OWC10.ChartSpace")
Set c = oChart.Constants
oChart.Border.Color = c.chColorNone
...
Dim categories(50), Vals(51), nome_turma(50)

'response.Write(faixas&"<BR>")
...
.Charts(0).Axes(1).Font.Name = "Tahoma"
.Charts(0).Axes(1).Scaling.Minimum = 0
.Charts(0).Axes(1).Scaling.Maximum = maximo_valor
.Charts(0).Axes(1).HasTickLabels = True
End With
...
'===========================================================================================================
function ColunaAgrupadaParam(faixas,categorias,TresD,legenda,cor,FontSize,outro)
response.Charset="ISO-8859-1"
Set oChart = CreateObject("OWC10.ChartSpace")
Set c = oChart.Constants
oChart.Border.Color = c.chColorNone
...
legendas = split(legenda,"#!#")
'for lg=0 to ubound(legendas)
'		.Charts(0).SeriesCollection(lg).Caption = legendas(lg)	 
'next
maximo_valor=0
quantidade_de_turmas=ubound(valores)
 For k=0 to quantidade_de_turmas
	...
	next
		...
		'ajustando o subtítulo da série (o texto da legenda).
		.Charts(0).SeriesCollection(k).Caption = legendas(k)	 
	
		'adicionando as categorias e os valores da primeira série.
		.Charts(0).SeriesCollection(k).SetData c.chDimCategories, c.chDataLiteral, categories
		.Charts(0).SeriesCollection(k).SetData c.chDimValues, c.chDataLiteral, Vals
	next 
		.Charts(0).SeriesCollection(0).Interior.Color = "#0000FF"
		.Charts(0).SeriesCollection(1).Interior.Color = "#00FF00"
		.Charts(0).SeriesCollection(2).Interior.Color = "#FF0000"	
End With
maximo_valor=maximo_valor+1000
With oChart
...
'ajustando o tamanho do gráfico (figura).
Response.BinaryWrite oChart.GetPicture("gif",970, 320) 
...
'===========================================================================================================
function ColunaAgrupada_2D_ou_3D(faixas,categorias,tp_grafico)
response.Charset="ISO-8859-1"
Set oChart = CreateObject("OWC10.ChartSpace")
Set c = oChart.Constants
oChart.Border.Color = c.chColorNone
...
.Charts(0).Axes(1).Font.Name = "Tahoma"
.Charts(0).Axes(1).Scaling.Minimum = 0
.Charts(0).Axes(1).Scaling.Maximum = 100
.Charts(0).Axes(1).HasTickLabels = True
End With
...
'===========================================================================================================
function StackedColuna_2D_ou_3D(faixas,categorias,tp_grafico)
response.Charset="ISO-8859-1"
Set oChart = CreateObject("OWC10.ChartSpace")
Set c = oChart.Constants
oChart.Border.Color = c.chColorNone
...
'adicionando o tipo do gráfico.
if tp_grafico = "2d" then
	 .Charts(0).Type = oChart.Constants.chChartTypeColumnStacked
else
	.Charts(0).Type = oChart.Constants.chChartTypeColumnStacked3D
end if

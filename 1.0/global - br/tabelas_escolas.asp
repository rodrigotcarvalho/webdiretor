...
elseif escola="bretanha" or escola="testebretanha" then
	...
	elseif opcao="S" then
			tb="TB_NOTA_S"
			dados_tb_nota_s = split(outro,"#!#")
			ln_pesos_cols="&nbsp;#!#Pesos"
			ln_pesos_vars="&nbsp;#!#&nbsp;"			
			nm_pesos_vars="&nbsp;#!#&nbsp;"
			ln_nom_cols="N&ordm;#!#Nome"
			nm_vars=""
			nm_bd=""
			vars_calc=""
			notas_a_lancar=0
	
			if dados_tb_nota_s(0) then
				ln_pesos_cols=ln_pesos_cols&"#!#&nbsp;"
				ln_pesos_vars=ln_pesos_vars&"#!#&nbsp;"			
				nm_pesos_vars=nm_pesos_vars&"#!#&nbsp;"
				ln_nom_cols=ln_nom_cols&"#!#F"
				nm_vars=nm_vars&"faltas#!#"
				nm_bd=nm_bd&"NU_Faltas#!#"
				vars_calc=vars_calc&"0#!#"
				notas_a_lancar=notas_a_lancar+1	
			end if
'			ln_pesos_cols=ln_pesos_cols&"#!#&nbsp;#!#&nbsp;#!#&nbsp;#!#PESO#!#&nbsp;#!#&nbsp;#!#&nbsp;#!#PESO#!#&nbsp;"
'			ln_pesos_vars=ln_pesos_vars&"#!#&nbsp;#!#&nbsp;#!#&nbsp;#!#PE_Teste#!#&nbsp;#!#&nbsp;#!#&nbsp;#!#PE_Prova#!#&nbsp;"			
'			nm_pesos_vars=nm_pesos_vars&"#!#&nbsp;#!#&nbsp;#!#&nbsp;#!#pt#!#&nbsp;#!#&nbsp;#!#&nbsp;#!#pp#!#&nbsp;"
'			ln_nom_cols=ln_nom_cols&"#!#T1#!#T2#!#T3#!#MT#!#P1#!#P2#!#P3#!#MP#!#M1"
'			nm_vars=nm_vars&"t1#!#t2#!#t3#!#media_teste#!#p1#!#p2#!#p3#!#media_prova#!#media1"
'			nm_bd=nm_bd&"VA_Teste1#!#VA_Teste2#!#VA_Teste3#!#MD_Teste#!#VA_Prova1#!#VA_Prova2#!#VA_Prova3#!#MD_Prova#!#VA_Media1"
'			vars_calc=vars_calc&"0#!#0#!#0#!#0#!#0#!#0#!#0#!#0#!#0"	
'			notas_a_lancar=notas_a_lancar+6	
			ln_pesos_cols=ln_pesos_cols&"#!#&nbsp;#!#&nbsp;#!#&nbsp;#!#PESO#!#&nbsp;#!#&nbsp;#!#&nbsp;#!#PESO"
			ln_pesos_vars=ln_pesos_vars&"#!#&nbsp;#!#&nbsp;#!#&nbsp;#!#PE_Teste#!#&nbsp;#!#&nbsp;#!#&nbsp;#!#PE_Prova"			
			nm_pesos_vars=nm_pesos_vars&"#!#&nbsp;#!#&nbsp;#!#&nbsp;#!#pt#!#&nbsp;#!#&nbsp;#!#&nbsp;#!#pp"
			ln_nom_cols=ln_nom_cols&"#!#T1#!#T2#!#T3#!#MT#!#P1#!#P2#!#P3#!#MP"
			nm_vars=nm_vars&"t1#!#t2#!#t3#!#media_teste#!#p1#!#p2#!#p3#!#media_prova"
			nm_bd=nm_bd&"VA_Teste1#!#VA_Teste2#!#VA_Teste3#!#MD_Teste#!#VA_Prova1#!#VA_Prova2#!#VA_Prova3#!#MD_Prova"
			vars_calc=vars_calc&"0#!#0#!#0#!#0#!#0#!#0#!#0#!#0"	
			notas_a_lancar=notas_a_lancar+5					
			if dados_tb_nota_s(1) then
				ln_pesos_cols=ln_pesos_cols&"#!#&nbsp;"
				ln_pesos_vars=ln_pesos_vars&"#!#&nbsp;"			
				nm_pesos_vars=nm_pesos_vars&"#!#&nbsp;"
				ln_nom_cols=ln_nom_cols&"#!#Bon"
				nm_vars=nm_vars&"#!#bon"
				nm_bd=nm_bd&"#!#VA_Bonus"
				vars_calc=vars_calc&"#!#0"
				notas_a_lancar=notas_a_lancar+1					
			end if				
'			ln_pesos_cols=ln_pesos_cols&"#!#&nbsp;"
'			ln_pesos_vars=ln_pesos_vars&"#!#&nbsp;"			
'			nm_pesos_vars=nm_pesos_vars&"#!#&nbsp;"
'			ln_nom_cols=ln_nom_cols&"#!#M2"
'			nm_vars=nm_vars&"#!#media2"
'			nm_bd=nm_bd&"#!#VA_Media2"
'			vars_calc=vars_calc&"#!#0"
'			notas_a_lancar=notas_a_lancar+1	
			
			if dados_tb_nota_s(2) then
				ln_pesos_cols=ln_pesos_cols&"#!#&nbsp;"
				ln_pesos_vars=ln_pesos_vars&"#!#&nbsp;"			
				nm_pesos_vars=nm_pesos_vars&"#!#&nbsp;"
				ln_nom_cols=ln_nom_cols&"#!#Rec"
				nm_vars=nm_vars&"#!#rec"
				nm_bd=nm_bd&"#!#VA_Rec"
				vars_calc=vars_calc&"#!#0"
				notas_a_lancar=notas_a_lancar+1					
...
'			ln_pesos_vars=ln_pesos_vars&"#!#&nbsp;"			
'			nm_pesos_vars=nm_pesos_vars&"#!#&nbsp;"
'			ln_nom_cols=ln_nom_cols&"#!#M3"
'			nm_vars=nm_vars&"#!#media3"
'			nm_bd=nm_bd&"#!#VA_Media3"
'			vars_calc=vars_calc&"#!#0"
'			notas_a_lancar=notas_a_lancar+1													

...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td colspan="3" rowspan="2" valign="top"><textarea name="concordo" cols="27" rows="4" readonly="readonly" id="concordo">Autorizo o Web Família a enviar para o email informado o usuário e a senha, caso tenha esquecido.</textarea></td>
    <td></td>
  </tr>
  <tr> 
    <td height="21">&nbsp;</td>

...
'					Page.Canvas.DrawTable Data_Impresso, "x=405, y="&y_data_impresso&"" 
	...
	'INÍCIO DO RECIBO==================================================================================
			...
			'===========================================================================
				...
				largura_logo_pqno=formatnumber(Logo.Width*0.4,0)
				altura_logo_pqno=formatnumber(Logo.Height*0.4,0)
				...
				Text_recibo = "<p><center><i><b>Escola Bretanha</b></i></center></p>"

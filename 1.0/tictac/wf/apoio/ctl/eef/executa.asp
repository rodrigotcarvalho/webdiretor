...
//-->
                      ...
                      <select name="curso" id="curso" class="borda" onchange="recuperarEtapa(this.value)">
...
%>
                      <select name="etapa" id="etapa" class="borda" onchange="recuperarTurma(this.value)">
                        <option value="nulo" selected></option>
                        <%		
...
%>
  <select name="turma" id="turma" class="borda">
                        <option value="nulo" selected></option>
    <%

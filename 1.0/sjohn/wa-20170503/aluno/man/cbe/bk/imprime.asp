...
response.Write(no_curso)%>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td colspan="2"><div align="right">  <%		Set RS_tb = Server.CreateObject("ADODB.Recordset")
		SQL_tb = "SELECT * FROM TB_Da_Aula WHERE NU_Unidade="& unidade &" AND CO_Curso ='"& curso&"' AND CO_Etapa ='"& etapa&"' AND CO_Turma ='"& turma&"'"
		RS_tb.Open SQL_tb, CON2
if RS_tb.eof then
%>
...
'						end if						
			...
			%>
                    ...
                    <td class="tabela" width="348">&nbsp; </td>
						...
						<%
	elseif notaFIL="TB_NOTA_B" or notaFIL="TB_NOTA_E" or notaFIL="TB_NOTA_F" or notaFIL="TB_NOTA_K" then
%>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td width="252" rowspan="2" class="tabela"> 

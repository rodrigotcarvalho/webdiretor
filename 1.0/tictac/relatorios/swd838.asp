...
'CABEÇALHO==========================================================================================		
   ...
   Page.Canvas.DrawImage Logo, Param_Logo_Gde
	...
	Text = "<center><i><b><font style=""font-size:18pt;"">Rela&ccedil;&atilde;o de Itens</font></b></i></center>"
...
'================================================================================================================			
	...
	Set param_table2 = Pdf.CreateParam("width=547; height="&altura_medias&"; rows=1; cols=8; border=0; cellborder=0.5; cellspacing=0; x="&margem&"; y="&y_segunda_tabela&"; MaxHeight=670")

	Set Notas_Tit = Doc.CreateTable(param_table2)
	Notas_Tit.Font = Font				
	largura_colunas=(547-35-40-40-40-90)/colunas_de_notas		
	...
	With Notas_Tit.Rows(1)
	   ...
	   .Cells(5).Width = 40
	   .Cells(6).Width = 40	
	   .Cells(7).Width = largura_colunas
	   .Cells(8).Width = 90	   	   	   
	End With
	Notas_Tit(1, 1).AddText "<div align=""center""><b>C&oacute;digo</b></div>", "size=9;indenty=2; html=true", Font 
	Notas_Tit(1, 2).AddText "<div align=""center""><b>Nome do Item</b></div>", "size=9;alignment=center; indenty=2;html=true", Font 
	Notas_Tit(1, 3).AddText "<div align=""center""><b>Apelido</b></div>", "size=9;alignment=center; indenty=2;html=true", Font 
	Notas_Tit(1, 4).AddText "<div align=""center""><b>Unidade </b></div>", "size=9;alignment=center; indenty=2;html=true", Font 
	Notas_Tit(1, 5).AddText "<div align=""center""><b>M&iacute;nimo</b></div>", "size=9;alignment=center; indenty=2;html=true", Font 
	Notas_Tit(1, 6).AddText "<div align=""center""><b>Saldo</b></div>", "size=9;alignment=center; indenty=2;html=true", Font 
	Notas_Tit(1, 7).AddText "<div align=""center""><b>Grupo</b></div>", "size=9;alignment=center; indenty=2;html=true", Font 
	Notas_Tit(1, 8).AddText "<div align=""center""><b>Observa&ccedil;&otilde;es</b></div>", "size=9;alignment=center; indenty=2;html=true", Font 					
...
''response.Flush()										
	...
	while not RS.EOF
		...
		SQL2m = "SELECT * FROM TB_Grupo Where CO_Grupo = "&grupo_form
		...
		Notas_Tit(linha, 3).AddText "<div align=""center"">"&apelido&"</div>", param_materias
		Notas_Tit(linha, 4).AddText "<div align=""center"">"&tipo_peso&"</div>", param_materias
		Notas_Tit(linha, 5).AddText "<div align=""center"">"&minimo&"</div>", param_materias
		Notas_Tit(linha, 6).AddText "<div align=""center"">"&alerta&"</div>", param_materias
		Notas_Tit(linha, 7).AddText "<div align=""center"">"&no_grupo&"</div>", param_materias
		Notas_Tit(linha, 8).AddText "<div align=""center"">"&observacoes&"</div>", param_materias										

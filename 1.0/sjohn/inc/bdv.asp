...
i=1
		...
		Set CON_TBK = Server.CreateObject("ADODB.Connection") 
		ABRIR_TBK = "DBQ="& CAMINHO_nk & ";Driver={Microsoft Access Driver (*.mdb)}"
		CON_TBK.Open ABRIR_TBK
		
		Set CON_TBM= Server.CreateObject("ADODB.Connection") 
		ABRIR_TBM = "DBQ="& CAMINHO_nm & ";Driver={Microsoft Access Driver (*.mdb)}"
		CON_TBM.Open ABRIR_TBM								
...
if grava = "ok" then
	if periodo>4 and p1_lancada="ok" then
		m1=soma_prova1	
		va_p2=NULL	
		va_p3=NULL	
		va_p4=NULL	
...
'			Alterado por conta de e-mail de 11/05/2012
	...
	Elseif ano_letivo<2017 then
		...
		response.Write(CONEXAO0&"<BR>")
		Set RS0 = CON_TBK.Execute(CONEXAO0)
		...
		If RS0.EOF THEN	
			...
			RS.open "TB_Nota_K", CON_TBK, 2, 2 'which table do you want open
			RS.addnew
'		response.Write(nu_matricula&"-"&co_materia_pr&"-"&co_materia&"-"&periodo&"<BR>")		
		...
		'response.Write(CONEXAO0&"<BR>")
		Set RS0 = CON_TBM.Execute(CONEXAO0)
		...
		If RS0.EOF THEN	
			...
			RS.open "TB_Nota_M", CON_TBM, 2, 2 'which table do you want open
			RS.addnew
		'response.Write(nu_matricula&"-"&co_materia_pr&"-"&co_materia&"-"&periodo&"<BR>")		
				RS("CO_Matricula") = nu_matricula
				RS("CO_Materia_Principal") = co_materia_pr

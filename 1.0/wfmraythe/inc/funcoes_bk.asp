...
tp=session("tp")
aluno_escolhido=Session("aluno_selecionado")
co_user = session("co_user")
	...
	SQL = "select * from TB_RespxAluno where CO_Aluno = " & aluno_escolhido &" and CO_Usuario="&co_user
	RS.Open SQL, CONWF		

	IF RS.EOF then
		exibe_financeiro = "N"
	else	
		tipo_resp= RS("TP_Resp")
		if tipo_resp = "F" then
			exibe_financeiro = "S"		
		else
			exibe_financeiro = "N"		
...
<table width="170" style="BORDER-TOP: #a8adb0 1px solid; BORDER-RIGHT: #a8adb0 1px solid; BORDER-LEFT: #a8adb0 1px solid; BORDER-BOTTOM: #a8adb0 1px solid">
  ...
  <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#336699"><div align="center"><font class="menu_lista">Coordena&ccedil;&atilde;o 
  ...
  <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#336699"><div align="center"><font class="menu_lista">Aproveitamento 
        Escolar</font></div></td>
  </tr>
  <tr> 
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
  ...
  <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#336699"><div align="center"><font class="menu_lista"><a href="docs/index.asp" class="menu_lista">Correspond&ecirc;ncias</a></font></div></td>
  </tr>
<!--   <tr> 
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
  ...
  <tr> 
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
                onmouseout="this.className='menuc'"><img src="img/menu_seta.gif" width="19" height="15" /><a href="docs/provgab/index.asp" class="menu_sublista">Gabaritos 
      </a></td>
  </tr>
  <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#336699"><div align="center"><font class="menu_lista">Agenda 
...
<!--   <tr> 
 ...
 <%IF exibe_financeiro = "S" THEN%>
  <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#336699"><div align="center"><font class="menu_lista">Posi&ccedil;&atilde;o 
  ...
  <tr> 
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
                onmouseout="this.className='menuc'"><img src="img/menu_seta.gif" width="19" height="15" /><a href="posfin/segvia/index.asp" class="menu_sublista">Emitir Boleto</a></td>
  </tr>
  <%END IF%>  
  <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#336699"><div align="center"><font class="menu_lista">Seguran&ccedil;a</font></div></td>
  </tr>
  <tr> 

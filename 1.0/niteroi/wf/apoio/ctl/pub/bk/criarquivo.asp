...
if opt="i" then
url="http://www.simplynet.com.br/bretanha/wf/apoio/ctl/pub/upload.asp?opt=f&arq="&Session("arquivos")&"&upl="&Session("upl_total")					
else opt="e" then
url="http://www.simplynet.com.br/bretanha/wf/apoio/ctl/pub/docs.asp?opt=ok1&pagina=1&v=s")
else
response.Write("ERRO!")
response.end()					
end if

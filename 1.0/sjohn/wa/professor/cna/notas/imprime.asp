...
elseif nota = "TB_NOTA_L" Then
	CAMINHOn = CAMINHO_nl
	Call notas(CAMINHO_al,CAMINHOn,unidade,curso,co_etapa,turma,co_materia,periodo,ano_letivo,co_usr,"L","imp",0)		
	'response.Redirect("imprime_c.asp?p="&p&"&obr="&obr)
elseif nota = "TB_NOTA_M" Then
	CAMINHOn = CAMINHO_nm
	Call notas(CAMINHO_al,CAMINHOn,unidade,curso,co_etapa,turma,co_materia,periodo,ano_letivo,co_usr,"M","imp",0)		
	'response.Redirect("imprime_c.asp?p="&p&"&obr="&obr)			
else

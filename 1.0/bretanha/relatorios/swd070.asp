...
'================================================================================================================			
	...
	CONEXAONN = "Select * from TB_Programa_Aula WHERE CO_Curso = '"& ucet(1) &"' AND CO_Etapa = '"& ucet(2)&"' order by NU_Ordem_Boletim"
...
'response.Write(tipo_calculo)
'response.End()	
			if tipo_calculo = "MA" then		
				resultado=Calc_Med_An_Fin(ucet(0), ucet(1), ucet(2), ucet(3), nu_matricula, disciplina, caminho_n, tb_notas, 5, 4, 5,"anual", 0)	
...
'response.End()										
				...
				if tp_disc="msf" then
					media_aluno=Calcula_Media_T_F_F_N(ucet(0), ucet(1), ucet(2), ucet(3), nu_matricula, disciplina, caminho_n , tb_notas, periodo)				
					if media_aluno="&nbsp;" then
						pula_aluno="S"				
					else
						media_denominador=media_denominador+1
				...
				elseif	tp_disc="mcf" then
					...
					media_aluno=Calcula_Media_T_T_F_N(ucet(0), ucet(1), ucet(2), ucet(3),nu_matricula, disciplina, vetor_filhas, caminho_n, tb_notas, periodo)				
					if media_aluno="&nbsp;" then
						pula_aluno="S"				
					else
						media_denominador=media_denominador+1
			...
			'response.Write(disciplina&" "&media_aluno&"<BR>")	

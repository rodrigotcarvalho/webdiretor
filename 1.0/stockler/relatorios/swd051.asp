...
'================================================================================================================			
	...
	Set param_table2 = Pdf.CreateParam("width=547; height="&altura_medias&"; rows=1; cols=5; border=0; cellborder=0.7; cellspacing=0; x="&margem&"; y="&y_segunda_tabela&"; MaxHeight=670")

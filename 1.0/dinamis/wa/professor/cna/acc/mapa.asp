...
function mudar_cor_blur_impar(<%response.Write(parametros_funcao_jscript)%>){
   celula.style.backgroundColor="#FFFFC1";
<%
for pr=1 to maior_periodo
	if pr=2 then
   		response.Write("celulap2.style.backgroundColor=""#FFFFC1"";")
	elseif pr=3 then
   		response.Write("celulap3.style.backgroundColor=""#FFFFC1"";")
	elseif pr=4 then
   		response.Write("celulap4.style.backgroundColor=""#FFFFC1"";")
	elseif pr=5 then
   		response.Write("celulap5.style.backgroundColor=""#FFFFC1"";")	
	elseif pr=6 then
   		response.Write("celulap6.style.backgroundColor=""#FFFFC1"";")	
	elseif pr=7 then
   		response.Write("celulap7.style.backgroundColor=""#FFFFC1"";")	
	elseif pr=8 then
   		response.Write("celulap8.style.backgroundColor=""#FFFFC1"";")	
	elseif pr=9 then
   		response.Write("celulap9.style.backgroundColor=""#FFFFC1"";")	
	elseif pr=10 then
   		response.Write("celulap10.style.backgroundColor=""#FFFFC1"";")	
	elseif pr=11 then
   		response.Write("celulap11.style.backgroundColor=""#FFFFC1"";")	
	elseif pr=12 then
   		response.Write("celulap12.style.backgroundColor=""#FFFFC1"";")	
	elseif pr=13 then
   		response.Write("celulap13.style.backgroundColor=""#FFFFC1"";")	
	elseif pr=14 then
   		response.Write("celulap14.style.backgroundColor=""#FFFFC1"";")	
	elseif pr=15 then
   		response.Write("celulap15.style.backgroundColor=""#FFFFC1"";")
	elseif pr=16 then
   		response.Write("celulap16.style.backgroundColor=""#FFFFC1"";")	
	elseif pr=17 then
   		response.Write("celulap17.style.backgroundColor=""#FFFFC1"";")	
	elseif pr=18 then
   		response.Write("celulap18.style.backgroundColor=""#FFFFC1"";")	
	elseif pr=19 then
   		response.Write("celulap19.style.backgroundColor=""#FFFFC1"";")	
	elseif pr=20 then
   		response.Write("celulap20.style.backgroundColor=""#FFFFC1"";")																						
	end if
next	
%>      
} 
...
<td width="<%response.Write(width_nu_chamada)%>" <%response.Write(rowspan)%> onFocus="mudar_cor_focus(<%response.Write(parametros_chamada_jscript)%>);chamajavascript(<%response.Write(num_cham)%>,<%response.Write(cod_cons)%>,'<%response.Write(no_exibe_per)%>','<%response.Write(vet_co_materia(0))%>',<% response.Write(periodo_real)%>)" onBlur="<%response.Write(onblur)%>(<%response.Write(parametros_chamada_jscript)%>)"><div align="center"><%response.Write(num_cham)%></div></td>
                    ...
                    <td width="<%response.Write(width_else)%>" onFocus="mudar_cor_focus(<%response.Write(parametros_chamada_jscript)%>);chamajavascript(<%response.Write(num_cham)%>,<%response.Write(cod_cons)%>,'<%response.Write(no_exibe_per)%>','<%response.Write(vet_co_materia(dsc))%>',<% response.Write(periodo_real)%>)" onBlur="<%response.Write(onblur)%>(<%response.Write(parametros_chamada_jscript)%>)"><div align="center">
                      <%
						...
						if teste=false and media<>"A" and media<>"B" and media<>"C" and media<>"D" and media<>"E" then
							response.Write("&nbsp;")
						else
						
							if media="A" or media="B" then 
									response.Write("<font color="&cor_nota_azl&">"&media&"</font>")	
							elseif  media="C" then
									response.Write("<font color="&cor_nota_prt&">"&media&"</font>")									
							elseif media="D" or media="E" then
									response.Write("<font color="&cor_nota_vml&">"&media&"</font>")										
							else
								media=media*1	
								ntazl=ntazl*1
								ntvml=ntvml*1							
...
'						end if				
  ...
  <tr>
    <td width="<%response.Write(width_tb_dados_turma)%>" height="56" valign="bottom"><table width="<%response.Write(width_tb_dados_turma)%>" border="1" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0">
  <tr>

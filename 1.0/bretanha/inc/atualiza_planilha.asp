...
horario = hora & ":"& min				
				...
				if tb_nota="TB_NOTA_A" then
					...
					va_pt = RS3("PE_Teste")	
					va_pp = RS3("PE_Prova")	
					va_bon = valor_gravacao
					va_rec = RS3("VA_Rec")	
														
				
					Gravou = Grava_BDA(nu_matricula, mat_princ, co_materia, periodo, va_faltas, va_pt, va_pp, va_t1, va_t2, va_t3, va_p1, va_p2, va_p3, va_bon, va_rec, data, horario, co_usr, "S", "S")
				else
					...
					Gravou = Grava_BDS(nu_matricula, mat_princ, co_materia, periodo, in_bonus, rec_semestral, va_faltas, va_faltas, va_pt, va_pp, va_t1, va_t2, va_t3, va_p1, va_p2, va_p3, va_bon, va_rec, data, horario, co_usr, "S", "S")
				end if				
			'response.Write(Gravou)
			if  Gravou<>"S" then
...
param_BAT = parametros_gerais(NULL,curso,etapa,NULL,co_materia_pr,"default_lbg",outro)

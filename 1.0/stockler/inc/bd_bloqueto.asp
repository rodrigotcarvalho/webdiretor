...
'Cria tabelas com informações de cobrança---------------------------------------------------------------------	
			...
			var_instrucoes="<font style=""font-size:6pt;"">Instru&ccedil;&otilde;es (Todas as informa&ccedil;&otilde;es deste bloqueto s&atilde;o de exclusiva responsabilidade do benefici&aacute;rio)</font><font style=""font-size:3pt;""><BR>&nbsp;<br></FONT><font style=""font-size:7pt;"">"&msg01
			
			var_instrucoes=	var_instrucoes&"</FONT><font style=""font-size:6pt;""><BR>&nbsp;<BR>&nbsp;"				
			
			var_instrucoes=	var_instrucoes&msg03&"<BR>Ap&oacute;s o vencimento cobrar MULTA de R$"&multa&" mais mora di&aacute;ria de R$"&juros&"<BR>&nbsp;<BR>Ap&oacute;s o vencimento pagar somente nas ag&ecirc;ncias do Banco do Ita&uacute; ou na secretaria da escola<BR>&nbsp;<BR>&nbsp;<BR>"&TEXTO_UCASE&"</font>" 	
				...
				End With
				width_stb_1 = formatnumber(width_tabela_2/7,0) -5 + ((formatnumber(width_tabela_2/7,0)-30)*2)+formatnumber(width_tabela_2/7,0)-5 +formatnumber(width_tabela_2/7,0)-20+formatnumber(width_tabela_2/7,0)+10 
				...
				Set SmallTable = Doc.CreateTable("Height=17; Width="&width_stb_1&"; cols=1; rows=2; border=0; cellborder=0; cellspacing=0;")
				SmallTable.At(1, 1).Canvas.DrawText "<font style=""font-size:5pt;"">Local de Pagamento:</font>", "x=1; y=8, size=5; html=true", Font
				SmallTable.At(2, 1).AddText "<CENTER><b>AT&Eacute; O VENCIMENTO PAG&Aacute;VEL EM QUALQUER BANCO</b></CENTER>", "size=7; html=true", Font
				...
				SmallTable15.At(2, 1).AddText "<CENTER>175</CENTER>", " html=true; size=7;", Font			

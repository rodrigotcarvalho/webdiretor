...
> <div align="right"><font class="tabela_rodape"> T-Teste, MT?M?dia dos Testes, 
              PR-Prova, MP?M?dia das Provas, N-Nota e M-M&eacute;dia</font></div></td>
        </tr>-->
      </table>
      <%
...
<!--                          <td width="37" class="tabela">&nbsp;</td>-->
                          ...
                          <td  class="tabela"><div align="center">P1</div></td>
                          <td  class="tabela"><div align="center">P2</div></td>
                          <td width="31" align="center" class="tabela">MP</td>
                          <td width="31" align="center" class="tabela">SIM</td>
                          <td width="31" class="tabela"><div align="center">M1</div></td>
                          <td width="31" align="center" class="tabela">BAT</td>
                          <!--                          <td width="37" class="tabela">&nbsp;</td>-->
                          <td width="31"  class="tabela"> 
                            <div align="center">Bon</div></td>
...
<!--												  <td width="37"
						...
						> 
												  ...
												  <td class="tabela" width="31"><div align="center">
												    <%
													if showprova="s" then							
													response.Write(va_p1)
													End IF							
			...
			m3_exibe=0
				...
				RS1a.movenext
				wend
						if	sem_media1="s" or (showprova="n" or showapr="n") then
							m1_exibe="&nbsp;"
						else
							m1_exibe=m1_ac/peso_acumula
							decimo = m1_exibe - Int(m1_exibe)
						...
						if	sem_media2="s" or (showprova="n" or showapr="n") then	
							m2_exibe="&nbsp;"
						else												
							m2_exibe=m2_ac/peso_acumula
							decimo = m2_exibe - Int(m2_exibe)
						...
						if	sem_media3="s" or (showprova="n" or showapr="n") then
							m3_exibe="&nbsp;"
						else							
							m3_exibe=m3_ac/peso_acumula
								decimo = m3_exibe - Int(m3_exibe)
...
<!--										  <td class="tabela" width="37"
		...
		%>
<!--								<tr valign="bottom"> 
								  <td class="tabela" height="20" colspan="24" 
		> <div align="right">

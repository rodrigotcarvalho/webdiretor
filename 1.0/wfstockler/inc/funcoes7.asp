			...
			'response.Write(co_materia_consulta&"   "&medias_materia(k)&" - "&k&"<BR>")			
				...
				RS4.addnew	
					...
					for tn=0 to ubound(grava_notas)			
						...
						if n_campo<12 and ((curso=1 and co_etapa<6 and (co_materia_consulta="ART" or co_materia_consulta="ESP" or co_materia_consulta="ING")) or co_materia_consulta="EFI") then									

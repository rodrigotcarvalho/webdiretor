...
elseif opt="02" then
	...
	tipo_resultado=dados_informados(4)	
...
'					Notas_Tit(linha, coluna).AddText "<div align=""center"">"&resultados_materia(1)&"</DIV>", param_materias	
					if (resultados_materia(1)="APR" or resultados_materia(1)="Apr" or resultados_materia(1)="APC" or resultados_materia(1)="Apc") and tipo_resultado = "S" then
						...
						Notas_Tit(linha, coluna).AddText "<div align=""center"">"&resultados_materia(0)&"</DIV>", param_materias	
						coluna=coluna+1	
						if resultados_materia(1)<>"&nbsp;" then
							tipo_media = "MF"
							modifica_result = Verifica_Conselho_Classe(dados_alunos(0), co_materia_exibe(n), tipo_media, outro)
							if modifica_result <> "N" then
								result = modifica_result
							else
								result =resultados_materia(1)	
							end if		
						end if							
						Notas_Tit(linha, coluna).AddText "<div align=""center"">"&result&"</DIV>", param_materias	
					end if							
				next
			next

...
host= "https://app.clicksign.com"
key = "b133cfc0-f93c-4c1e-9aef-df1488901a67"
'para acesso ao clicksign.com
'usuário contrato@dinamis.com.br
'senha d1n4m1scontrato


'Sandbox
'host= "https://sandbox.clicksign.com"
'key = "ad294264-36dc-451b-a551-b129b4e8dbc4"
'para acesso ao sandbox.clicksign.com.br
'usuário webdiretor@gmail.com
'senha Darkaxe0
...
Function EnviaContratoClickSign(nomeApi, nomeDoc, documentB64, nomeRespFin, cpfRespFin, emailRespFin, tp_cont)
	...
	'osmarpio@simplynet.com.br webdiretor@gmail.com
	keySignatario2 = CriaSignatario("contrato@dinamis.com.br","","email","Escola Dinamis", "", "", false, "email")
...
'P_DOC corresponde ao caminho a ser criado na Click Sign para mandar os arquivos
	...
	if P_API = "postPDF" then
		...
		'response.write(P_DOC&"<BR>"&B64&"<BR>"&dataExpiracao&"<BR>"&hora&"<BR>"&min&"<BR>"&seg)

...
unidade=unidade*1
if unidade=1 then
	logo_unidade = "logo_niteroi_preto.gif"
else
	logo_unidade = "logo_arariboia_preto.gif"
end if	
	...
	if un_cidade="" or isnull(un_cidade) then
	un_cidade=6001
	end if	
...
>
  <tr> 
      <td width="203" height="15" bgcolor="#FFFFFF"><div align="center"><img src="../../../../img/<%response.Write(logo_unidade)%>"> 
        </div></td>

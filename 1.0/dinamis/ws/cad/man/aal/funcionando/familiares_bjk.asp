...
'response.Write(cod_consulta&"="&cod)
...
sit_vinculado="n"
	...
	javascript_exclui="ConfirmaExcluirFamiliares('"&Server.URLEncode(ordem_familiares)&"','"&qtd_tipo_familiares&"','"&Server.URLEncode(cod_familiar)&"','"&cod_consulta&"')"
...
<%end if%>							  
                ...
                <tr> 
                  ...
                  <td width="186" height="26"><font class="form_corpo"> 
                    ...
                    <div id="<%response.Write(foco)%>"> <%response.Write(dados)%>
...
> 
                                  ...
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr> 
                                      <td width="9%"><input type="radio" name="mes_end" value="s"  onClick="recuperarEnd('<%response.Write(cod_consulta)%>','<%response.Write(foco)%>');BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'ID_Res_Aluno')" checked></td>
                                      <td width="25%"><font class="form_corpo">Sim</font></td>
                                      <td width="5%"><input name="mes_end" type="radio"  onClick="recuperarOrigemEnd('<%response.Write(cod_consulta)%>','<%response.Write(foco)%>');BD_aux(this.value,cod_consulta.value,cod_familiar.value,tp_vinc_familiar_aux.value,co_vinc_familiar_aux.value,'ID_Res_Aluno')" value="n"></td>

...
elseif tipo_boletim="WF" then
	...
	SQL_WF = "SELECT * FROM TB_Autoriza_WF WHERE NU_Unidade="&unidade&" AND CO_Curso='"&curso&"' and CO_Etapa='"&co_etapa&"'"
response.Write(SQL_WF)
...
'					teste19 = isnumeric(notas_disciplinas(19))							
			...
			if teste11=false then
				...
				if showt4="s" then
					...
					ntvml=ntvml*1
					if notas_disciplinas(11)>=ntvml then	
						response.Write(formatnumber(notas_disciplinas(11),1))
					else	
						response.Write("<font color="&cor_nota&">"&formatnumber(notas_disciplinas(11),1)&"</font>")	
					end if	
				end if	
			end if		
			...
			if teste8=false then
				...
				if showt4="s" then
					...
					ntvml=ntvml*1
					if notas_disciplinas(8)>=ntvml then	
						response.Write(formatnumber(notas_disciplinas(8),1))
					else	
						response.Write("<font color="&cor_nota&">"&formatnumber(notas_disciplinas(8),1)&"</font>")	
					end if	
				end if	
			end if		
			...
			if teste9=false then
				...
				if showt3="s" and showt4="s" then
					...
					ntvml=ntvml*1
					if notas_disciplinas(9)>=ntvml then	
						response.Write(formatnumber(notas_disciplinas(9),1))
					else	
						response.Write("<font color="&cor_nota&">"&formatnumber(notas_disciplinas(9),1)&"</font>")	
					end if	
				end if	
			end if		
			...
			if teste10=false then
				...
				if showt3="s" then
					...
					ntvml=ntvml*1
					if notas_disciplinas(10)>=ntvml then	
						response.Write(formatnumber(notas_disciplinas(10),1))
					else	
						response.Write("<font color="&cor_nota&">"&formatnumber(notas_disciplinas(10),1)&"</font>")	
					end if	
				end if	
			end if		

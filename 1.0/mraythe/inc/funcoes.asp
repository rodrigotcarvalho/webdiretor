...
case 623
if dados = "I" then
	wrt = "Importando dados de Freqüência Aguarde!"
else
...
case 636
wrt = "Para imprimir clique <a class='avisos' href='../../../../relatorios/swd110.asp?obr="&obr&"'>aqui</a>."
...
obr_mapa=dados
wrt = "Clique <a class='avisos' href='#' onClick=MM_openBrWindow('mapa.asp?obr="&obr_mapa&"','')>aqui</a> para abrir a janela"
...
case 714
wrt = "Históricos importados com sucesso!"
...
case 9702
wrt = "Para imprimir clique <a class='avisos' href='#' onClick=MM_openBrWindow('imprime.asp?obr="&obr&"&p=p','','status=yes,menubar=yes,scrollbars=yes,resizable=yes,width=1030,height=500,top=50,left=50')>aqui</a>."
...
case 9714
dados_msg = split(dados,"$$$")
wrt = "Deseja informar os responsáveis via e-mail? <a class='avisos' href='email_responsaveis.asp?opt=sim&ori="&dados_msg(0)&"&obr="&dados_msg(1)&"&opt_a="&dados_msg(2)&"'>sim</a> / <a class='avisos' href='email_responsaveis.asp?opt=nao&ori="&dados_msg(0)&"&obr="&dados_msg(1)&"&opt_a="&dados_msg(2)&"'>não</a>"

case 9715
wrt = "Confirma a exlus&atilde;o dos dados abaixo?"

...
nu_matricula=nu_matricula*1	
	...
	%>
			<tr>
					...
					<td width="<%response.Write(width_nom_aluno)%>" class="<%response.Write(classe)%>">Matr�cula <%response.Write(nu_matricula)%> cadastrada em TB_Matriculas sem correspond�ncia em TB_Alunos</td>               
...
While Not RS.EOF
	...
	%>
			<tr>
					<td width="<%response.Write(width_nom_disc)%>" class="<%response.Write(classe)%>">Matr�cula <%response.Write(nu_matricula)%> cadastrada em TB_Matriculas sem correspond�ncia em TB_Alunos</td>               
...
'Esse trecho n�o � utilizado pois essa escola n�o usa peso no lan�amento de notas

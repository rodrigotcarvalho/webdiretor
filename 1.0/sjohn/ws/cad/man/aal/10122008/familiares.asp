...
if conta_familiares_aluno=1 and aluno_vinculado<>"s" then
foco="nulo"
end if
                    ...
                    <table width="100%" border="0" cellspacing="0" dwcopytype="CopyTableRow">
                      ...
                      <tr> 
                        <td colspan="9" class="tb_tit">Dados Pessoais 
                          <%'response.Write(">>"&conta_familiares_aluno)%>
                        </td>
                      </tr>
                      <tr> 
                        ...
                        <td width="149" height="26"> <div align="left"><font class="form_corpo"> 
                            ...
                            <%else%>
                            <input name="cod_consulta" type="hidden" value="<%response.Write(cod_consulta)%>">
...
%>
                      ...
                      <tr> 
                        ...
                        <td width="140" height="10"> 
                          <%if foco="PAI" or foco="MAE" then%>
                          <%else%>
                          <marquee id="mqLooper1" loop="1" onStart="document.inclusao.nome_familiar.focus()">
                          </marquee> 
                          <%
					end if%>
                        </td>
...
%>
          ...
          <tr> 
            ...
            <td width="13" height="10"> <div align="left"><font class="form_dado_texto">:</font></div></td>
            <td width="217" height="10"> 
              <select name="rp" class="borda" onChange="GravaResponsaveis(this.value,'TP_Resp_Ped',0,'TP_Resp_Ped','<%response.write(cod_consulta)%>')">
                <option value="0" ></option>
                <%

...
obr=unidade&"_"&curso&"_"&co_etapa&"_"&turma&"_"&ano_letivo
...
<div align="center"><img src="../../img/logo_preto.gif" width="100" height="101"> 
    ...
    <td width="828" bgcolor="#FFFFFF"><table width="100%" border="0" align="right" cellspacing="0">
        <tr> 
          <td width="43%" rowspan="2"><font size="3" face="Verdana, Arial, Helvetica, sans-serif"><strong>
          	<%
			no_unidade= ucase(no_unidade)
			response.Write(no_unidade)
			%>
            </strong></font></td>
          <td width="57%" height="8" class="linhaBaixo">&nbsp; </td>
        </tr>
        <tr> 
          <td height="5" ></td>
        </tr>
...
response.Write(no_curso)%>
  ...
  <tr> 
    <td colspan="2"> <table width="100%" border="0" cellspacing="0" cellpadding="5">
        <tr> 
          <td width="124" class="tabela" 
><div align="center">VENCIMENTO</div></td>
          <td width="124" class="tabela" 
> 
            <div align="center">SERVI&Ccedil;O</div></td>
          <td width="126" class="tabela" 
> 
            <div align="center">LINHA 1</div></td>
          <td width="125" class="tabela" 
> 
            <div align="center">LINHA 2</div></td>
			          <td width="125" class="tabela" 
> 
            <div align="center">LINHA 3</div></td>
   <!--       <td width="124" class="tabela" 
> 
            <div align="right">VALOR A PAGAR&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>-->
          <td width="124" class="tabela" 
> 
            <div align="right">VALOR PAGO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
          <td width="124" class="tabela" 
> 
...
%>		
        <tr> 
          <td width="124" class="<%response.Write(cor)%>" 
>             <div align="center"> 
            <% 
...
> 
         ...
         <!--  <td width="124" align="right" class="<%response.Write(cor)%>" 
> 
            <% 
         ...
         <td width="126" class="<%response.Write(cor)%>" 
> 
            <div align="center"> 
            <% 
			if nome_lanc="" or isnull(nome_lanc) then

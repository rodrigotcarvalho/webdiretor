...
IF NOT RS3.EOF then
	...
	tit = "<font style=""font-size:12pt;""><b>"&cabec_1&"</b></font><br><font style=""font-size:8pt;"">	"&cabec_2&"<br>"&cabec_3&"<br>"&cabec_4&"<br>"&cabec_5&"<br>"&cabec_6&"<br>"&cabec_7&"<br>"&cabec_8&"<br>"																				
end if
...
SET Param = Pdf.CreateParam("x="&x_texto&";y="&y_texto&"; height="&altura&"; width="&width_texto&"; alignment=center; size=14; color=#000000; html=true")
Text = "<p><center><font style=""font-size:18pt;"">Hist&oacute;rico Escolar - Ensino M&eacute;dio</font></center></font></p>"
...
cargaAno = totaisHistorico (cod_cons, "EM", "N")

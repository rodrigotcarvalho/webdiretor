...
if opt="d" then
		...
		SQLAC_delete= "DELETE * FROM TBI_Contatos WHERE CO_Matricula ="&aluno&" and TP_Contato<>'ALUNO' and CO_Matricula_Vinc="&vinculado
		RSCONTATO_aux_delete.Open SQLAC_delete, CONCONT_aux

		Set RSALUNO_aux_bd3 = server.createobject("adodb.recordset")
		sql_atualiza_aluno= "UPDATE TBI_Contatos SET CO_Matricula_Vinc=NULL, TP_Contato_Vinc=NULL WHERE CO_Matricula = "& aluno&" and TP_Contato='ALUNO'"
		Set RSALUNO_aux_bd3 = CONCONT_aux.Execute(sql_atualiza_aluno)
...
foco=foco
	...
	tipo_contato=RSCONTACONT("TP_Contato")
		if familiares=0 and tipo_contato<>"ALUNO" then
		foco=tipo_contato
		elseif familiares=1 and tipo_contato<>"ALUNO" then
		foco=tipo_contato
		else
		foco=foco
		end if
  ...
  <tr> 
    <td><table width="100%" border="0" cellspacing="0">
        <tr> 
          ...
          <td width="2%"><div align="center"><font class="form_dado_texto">?</font>:</div></td>
          ...
          <td width="15%" height="26"> <div align="left"><font class="form_dado_texto">M&atilde;e 
  ...
  <tr> 
    <td><table width="100%" border="0" cellspacing="0">
        <tr> 
          ...
          <td width="2%"><div align="center"><font class="form_dado_texto">?</font></div></td>
          <td width="22%" height="26"><font class="form_corpo">
            <select name="select2" class="borda">
          ...
          <td width="1%"><div align="center"><font class="form_dado_texto">?</font></div></td>
          <td width="15%" height="26"><font class="form_corpo">
<select name="select3" class="borda">

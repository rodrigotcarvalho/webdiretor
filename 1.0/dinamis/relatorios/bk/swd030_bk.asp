...
if unidade_form="nulo" then
	...
	unidade_form=""
		...
		While not RS0.EOF	
			...
			if unidade_bd = 1 then
				unidade_padrao=unidade_bd
				unidade_form = unidade_padrao
			else
...
'	
	...
	'================================================================================================================	
		...
		While not RS0.EOF	
			...
			Set param_table2 = Pdf.CreateParam("width="&area_utilizavel&"; height=30; rows=2; cols=12; border=0; cellborder=0.1; cellspacing=0; x="&margem&"; y="&y_segunda_tabela&"; MaxHeight=450")
			...
			RSA.MoveNext
			Wend 
			Rs_ordena.Sort = "unidade ASC, nome_aluno ASC, vencimento ASC, tipo_lancamento ASC"		
...
'			
		...
		Table(1, 8).AddText "<div align=""right"">"&geral_acumulado_corrigido&"&nbsp</div>", "size=8; indenty=4;html=true",  Font			

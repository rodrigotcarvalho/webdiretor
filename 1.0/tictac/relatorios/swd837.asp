...
'CABEÇALHO==========================================================================================		
   ...
   Page.Canvas.DrawImage Logo, Param_Logo_Gde
	...
	Text = "<center><i><b><font style=""font-size:18pt;"">Rela&ccedil;&atilde;o de Grupos</font></b></i></center>"
...
'================================================================================================================			
	...
	Set param_table2 = Pdf.CreateParam("width=547; height="&altura_medias&"; rows=1; cols=2; border=0; cellborder=0.5; cellspacing=0; x="&margem&"; y="&y_segunda_tabela&"; MaxHeight=670")
...
'	   .Cells(3).Width = largura_colunas
	...
	Notas_Tit(1, 2).AddText "<div align=""center""><b>Nome do Grupo</b></div>", "size=9;alignment=center; indenty=2;html=true", Font 
	'Notas_Tit(1, 3).AddText "<div align=""center""><b>Status</b></div>", "size=9;alignment=center; indenty=2;html=true", Font 

	Set param_materias = PDF.CreateParam	
	param_materias.Set "size=7;expand=false" 			
''response.Flush()										
	Set RS = Server.CreateObject("ADODB.Recordset")
	SQL = "SELECT * FROM TB_Grupo order by NO_Grupo"
	RS.Open SQL, CON9
	...
	while not RS.EOF
		...
		'Notas_Tit(linha, 3).AddText "<div align=""center"">"&nom_ativo&"</div>", param_materias

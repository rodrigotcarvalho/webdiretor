...
email_suporte="adm@dinamis.com.br"
	...
	if tb_nota="TB_NOTA_A" then
		if periodo <4 then
			if tp_dados="BDM" or tp_dados="CMT" then
				var_bd_periodo="VA_MC"&periodo		
			elseif tp_dados="BDF" then
				var_bd_periodo="NU_Faltas_P"&periodo	
			end if
		else
			if tp_dados="BDM" or tp_dados="CMT" then
				var_bd_periodo="VA_Mfinal"	
			elseif tp_dados="BDF" then
				var_bd_periodo="NU_Faltas_EC"	
			end if		
		end if	
						
'			if tp_dados="BDM" or tp_dados="CMT" then
'				var_bd_periodo="VA_M3"

...
'		response.Write("A+"&acumula&"<BR>")				
	next	
'response.End()
	tipo_arred = parametros_gerais(unidade, curso, co_etapa, turma, codigo_materia_pr,"arred_media",0)	
	val_arred = parametros_gerais(unidade, curso, co_etapa, turma, codigo_materia_pr,"decimais_media",0)	
	if valor="nulo" then
		Calcula_Soma="&nbsp;"
	else

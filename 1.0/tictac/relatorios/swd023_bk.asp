...
'CABEÇALHO==========================================================================================		
   ...
   Page.Canvas.DrawImage Logo, Param_Logo_Gde
	...
	Text = "<center><i><b><font style=""font-size:18pt;"">Movimentar Almoxarifado</font></b></i></center>"
...
'================================================================================================================			
	...
	Set param_table2 = Pdf.CreateParam("width=547; height="&altura_medias&"; rows=1; cols=10; border=0; cellborder=0.5; cellspacing=0; x="&margem&"; y="&y_segunda_tabela&"; MaxHeight=670")

...
'	else
	...
	'				m3 = formatNumber(m3_arred,1)	
			...
			if co_materia = "ARTE" then
				if s_va_t1 = 1 and s_va_t2 = 1 and s_va_p1 = 1 and s_va_p2 = 1 then		
					m1=(soma_va_t1+soma_va_t2+(soma_va_p1*3)+(soma_va_p2*2))/7
				else
					m1=NULL		
				end if		  
			    ...
			    if va_rec<soma_va_p1 then
                    ...
                    if ano_letivo>= 2021 then	
						...
						'response.Write("("&soma_va_t1&"+"&soma_va_t2&"+"&soma_va_t3&"+("&va_rec&"*3)+("&soma_va_p2&"*2))/8) =  ")
								m3=(soma_va_t1+soma_va_t2+(va_rec*3)+(soma_va_p2*2))/7
							'response.Write(m3)	
											'response.End() 
						elseif co_materia = "EDUR" then
						...
						elseif co_materia = "EDUF" then		
							...
							m3=(soma_va_t1+soma_va_t2+(va_rec*3))/5												
						end if				
					else
                        if co_materia = "ART" or co_materia = "ARTE" then
					'response.Write("("&soma_va_t1&"+"&soma_va_t2&"+"&soma_va_t3&"+("&va_rec&"*3)+("&soma_va_p2&"*2))/8) =  ")

...
%>		
        <tr> 
          <td width="110" class="<%response.Write(cor)%>" 
>             <div align="center"> 
            <% 
          ...
          <td width="310" class="<%response.Write(cor)%>" 
> 
            <div align="center"> 
            <% 
          ...
          <td width="110" align="right" class="<%response.Write(cor)%>" 
> 
            <% 
...
> 
          ...
          <td width="200" class="<%response.Write(cor)%>" 
> 
            <div align="center"> 
            <% 

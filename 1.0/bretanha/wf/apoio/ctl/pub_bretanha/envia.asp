<%ano_letivo_wf=request.QueryString("opt")
...
<table width="1000" height="170" border="0" align="center" cellpadding="0" cellspacing="0" background="../../../../img/fundo_interno.gif" bgcolor="#FFFFFF">
  <tr> 
    <td width="1000" valign="top"> <table width="1000" border="0" align="right" cellpadding="0" cellspacing="0" class="tb_corpo">
        <tr> 
          <td width="1000"><FORM METHOD="POST" ENCTYPE="multipart/form-data" ACTION="grava_arquivo.asp?opt=f&al=<%=ano_letivo_wf%>" target="_parent">
                  ...
                  <td colspan="2"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td width="33%"> <div align="center"> 
                            <input name="SUBMIT5" type=button class="borda_bot3" onClick="MM_goToURL('parent','http://www.simplynet.com.br/bretanha/wf/apoio/ctl/pub/docs.asp?opt=f&pagina=1&v=s');return document.MM_returnValue" value="Voltar">
                          </div></td>

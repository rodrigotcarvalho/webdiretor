...
sit_vinculado="n"
	...
	javascript_recupera="BdFamiliar(cod_consulta.value,nome_familiar.value,nasce_fam.value,ocupacao_fam.value,trabalho_fam.value,email_fam.value,cpf_fam.value,id_fam.value,tipo_id_fam.value,nasce2_fam.value,tel_fam.value,rua_res_fam.value,num_res_fam.value,comp_res_fam.value,estadores_fam.value,cidres_fam.value,bairrores_fam.value,cep_fam.value,tel_res_fam.value,rua_com_fam.value,num_com_fam.value,comp_com_fam.value,estadocom_fam.value,cidcom_fam.value,bairrocom_fam.value,cepcom_fam.value,tel_com_fam.value,cod_familiar.value,id_res_fam_aux.value,aluno_vinculado.value,co_vinc_familiar_aux.value,tp_vinc_familiar_aux.value);recuperarFamiliares('"&Server.URLEncode(ordem_familiares)&"','"&qtd_tipo_familiares&"','"&Server.URLEncode(cod_familiar)&"','"&cod_consulta&"','"&cod&"')"
	javascript_inclui ="BdFamiliar(cod_consulta.value,nome_familiar.value,nasce_fam.value,ocupacao_fam.value,trabalho_fam.value,email_fam.value,cpf_fam.value,id_fam.value,tipo_id_fam.value,nasce2_fam.value,tel_fam.value,rua_res_fam.value,num_res_fam.value,comp_res_fam.value,estadores_fam.value,cidres_fam.value,bairrores_fam.value,cep_fam.value,tel_res_fam.value,rua_com_fam.value,num_com_fam.value,comp_com_fam.value,estadocom_fam.value,cidcom_fam.value,bairrocom_fam.value,cepcom_fam.value,tel_com_fam.value,cod_familiar.value,id_res_fam_aux.value,aluno_vinculado.value,co_vinc_familiar_aux.value,tp_vinc_familiar_aux.value);criaFamiliar('"&Server.URLEncode(ordem_familiares)&"','"&qtd_tipo_familiares&"',this.value,'"&cod_consulta&"','"&cod&"')"
	...
	if RSCONTATO.EOF and opt<>"i"then 
		...
		%>		          <td width="55"><div align="right">
			...
			<%else%>
						  ...
						  <input name="botao" class="aba_exclui" type="button" id="botao" value="X" onClick="<%response.Write("BdFamiliar(cod_consulta.value,nome_familiar.value,nasce_fam.value,ocupacao_fam.value,trabalho_fam.value,email_fam.value,cpf_fam.value,id_fam.value,tipo_id_fam.value,nasce2_fam.value,tel_fam.value,rua_res_fam.value,num_res_fam.value,comp_res_fam.value,estadores_fam.value,cidres_fam.value,bairrores_fam.value,cep_fam.value,tel_res_fam.value,rua_com_fam.value,num_com_fam.value,comp_com_fam.value,estadocom_fam.value,cidcom_fam.value,bairrocom_fam.value,cepcom_fam.value,tel_com_fam.value,cod_familiar.value,id_res_fam_aux.value,aluno_vinculado.value,co_vinc_familiar_aux.value,tp_vinc_familiar_aux.value);ConfirmaExcluirFamiliares('"&Server.URLEncode(ordem_familiares)&"','"&qtd_tipo_familiares&"','"&Server.URLEncode(cod_familiar)&"','"&cod&"')")%>">			  
						</div></td>
			<%
			end if
		end if
...
<%end if%>							  
                ...
                <tr> 
                  ...
                  <td width="144" height="26"> <input name="nasce_fam" type="text" class="borda" id="nasce_fam" onKeyup="formatar(this,'##/##/####')" value="<%response.write(nasce)%>" size="12" maxlength="10" onBlur="ValidaDataNasce(this.value)"></td>
...
%>
                  ...
                  <input name="trabalho_fam" type="text" class="borda" id="trabalho_fam" size="24" >
                    <%else%>
                    <input name="trabalho_fam" type="text" class="borda" id="trabalho_fam" value="<%response.write(Server.URLEncode(empresa))%>" size="24">
                    <%end if%>
                    </font></td>
                  <td width="147" height="26"> <div align="left"><font class="form_dado_texto">E-mail 
                      </font></div></td>
                  <td width="17"> <div align="center"><font class="form_dado_texto">:</font></div></td>
                  <td width="149" height="26"> <input name="email_fam" type="text" class="borda" id="email_fam" value="<%response.write(mail)%>" size="20" ></td>
                </tr>
                <tr> 
                  ...
                  <td width="144" height="10"><font class="form_corpo"> 
                    <input name="id_fam" type="text" class="borda" id="id_fam" value="<%response.write(rg)%>" size="15">
                    </font> </td>
                  ...
                  <td width="149" height="10"><font class="form_corpo"> 
                    <input name="tipo_id_fam" type="text" class="borda" id="tipo_id_fam" value="<%response.write(emitido)%>" size="10" >
                    - 
                    <input name="nasce2_fam" type="text" class="borda" id="nasce2_fam" onKeyUp="formatar(this, '##/##/####')" value="<%response.write(emissao)%>" size="11" maxlength="10" >
                    </font></td>
                </tr>
                <tr> 
                  ...
                  <td width="186" height="10"><font class="form_corpo"> 
                    <input name="tel_fam" type="text" class="borda" id="tel" value="<%response.write(tel)%>" size="42">
                    </font> </td>
...
><font class="form_corpo"> 
                             ...
                             <input name="rua_res_fam" type="text" class="borda" id="rua_res_fam" size="30"> 
                                  <%else%>
                                  <input name="rua_res_fam" type="text" class="borda" id="rua_res_fam" value="<%response.write(Server.URLEncode(rua_res))%>" size="30">
                                  <%end if%>
                                  </font></td>
                                <td width="140" height="10" class="tb_corpo"
> <div align="left"><font class="form_dado_texto"> N&uacute;mero</font></div></td>
...
><font class="form_corpo"> 
                                  <input name="num_res_fam" type="text" class="borda" id="num_res_fam"  value="<%response.write(num_res)%>" size="12" maxlength="10">
                                  </font></td>
                                <td width="90" class="tb_corpo"
><font class="form_dado_texto">Complemento</font></td>
                                <td width="15" class="tb_corpo"
...
> <div align="left"><font class="form_corpo"> </font> <font class="form_corpo"> 
                                   ...
                                   <input name="comp_res_fam" type="text" class="borda" id="comp_res_fam" size="20" maxlength="15">
                                    <%else%>
                                    <input name="comp_res_fam" type="text" class="borda" id="comp_res_fam" value="<%response.write(Server.URLEncode(comp_res))%>" size="20" maxlength="15">
                                    <%end if%>
                                    </font></div></td>
                              </tr>
                              <tr> 
...
> <div align="center"><font class="form_dado_texto">:</font></div></td>
                                <td width="217" height="10" class="tb_corpo"
><font class="form_dado_texto"> 
                                  <input name="cep_fam" type="text" class="borda" id="cep_fam" onKeyup="formatar(this, '#####-###')" value="<%response.write(cep)%>" size="11" maxlength="9" >
                                  </font></td>
                                <td width="140" height="10" class="tb_corpo"
>&nbsp;</td>
                                <td width="19" class="tb_corpo"
...
> <div align="center"><font class="form_dado_texto">:</font></div></td>
                                <td height="10" colspan="2" class="tb_corpo"
><font class="form_corpo"> 
                                  <input name="tel_res_fam" type="text" class="borda" id="tel_res_fam" value="<%response.write(tel_res)%>" size="42" maxlength="50">
                                  </font> </td>
                                <td width="19" class="tb_corpo"
> <div align="center"></div></td>
                                <td width="196" class="tb_corpo"
...
><font class="form_corpo">
                          ...
                          <input name="rua_com_fam" type="text" class="borda" id="rua_com_fam" size="30">
                                  <%else%>
                          <input name="rua_com_fam" type="text" class="borda" id="rua_com_fam" value="<%response.write(Server.URLEncode(rua_com))%>" size="30">
                                  <%end if%>
...
> <div align="center"><font class="form_dado_texto">:</font></div></td>
                        <td width="196" class="tb_corpo"
><font class="form_corpo"> 
                          <input name="num_com_fam" type="text" class="borda" id="num_com_fam" value="<%response.write(num_com)%>" size="12" maxlength="10">
                          </font></td>
                        <td width="90" class="tb_corpo"
><font class="form_dado_texto">Complemento</font></td>
...
> <div align="left"><font class="form_corpo"> </font> <font class="form_corpo"> 
							...
							<input name="comp_com_fam" type="text" class="borda" id="comp_com" size="20" maxlength="15">
							<%else%>
							<input name="comp_com_fam" type="text" class="borda" id="comp_com" value="<%response.write(Server.URLEncode(comp_com))%>" size="20" maxlength="15">
							<%end if%>
                            </font></div></td>
                      </tr>
                      <tr class="tb_corpo"
...
> 
                        ...
                        <td width="217" height="26"><font class="form_dado_texto"> 
                          <input name="cepcom_fam" type="text" class="borda" id="cepcom_fam" onKeyup="formatar(this, '#####-###')" value="<%response.write(cepcom)%>" size="11" maxlength="9"></font></td>
...
> 
                        ...
                        <td height="28" colspan="2"><font class="form_corpo"> 
                          <input name="tel_com_fam" type="text" class="borda" id="tel_com_fam" value="<%response.write(tel_com)%>" size="42" maxlength="50">
                          </font> </td>
                        <td width="19">&nbsp; </td>
                        <td width="196">&nbsp;</td>
                        <td width="90">&nbsp;</td>

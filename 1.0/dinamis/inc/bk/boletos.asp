...
cod_cons = vetorMatriculas(l)
	...
	'================================================================================================================					
		...
		'Cria tabelas com informações de cobrança---------------------------------------------------------------------	
					...
					if isnull(tipo) or tipo = "" then						
						'if isnumeric(val_multa) then
						'	var_instrucoes=	var_instrucoes&msg03&"<BR>Cobrar MULTA de "&formatcurrency(val_multa)&" mais mora de "&formatcurrency(val_mora)&"<BR>&nbsp;<BR>"							
						'else
							var_instrucoes=	var_instrucoes&msg03&"<BR>Ap&oacute;s o vencimento cobrar MULTA de "&formatcurrency(multa)&" mais mora di&aacute;ria de "&formatcurrency(juros)&"<BR>&nbsp;<BR>"						
						'end if

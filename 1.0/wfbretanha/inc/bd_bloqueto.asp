...
'Cria tabelas com informações de cobrança---------------------------------------------------------------------	
			...
			var_instrucoes=	var_instrucoes&"</FONT><font style=""font-size:6pt;""><BR>"				
						...
						var_instrucoes=	var_instrucoes&"Este boleto perder&aacute; a validade ap&oacute;s 59 dias do vencimento. O pagador dever&aacute; procurar o col&eacute;gio.<BR>"
				...
				Table(10, 1).RowSpan = 2				
				        ...
				        local_de_pagamento = "AT&Eacute; O VENCIMENTO, PAGUE EM QUALQUER BANCO OU CORRESPONDENTE N&Atilde;O BANC&Aacute;RIO."			

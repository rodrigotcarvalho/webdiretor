...
co_assunto	= request.form("tipo_email")
	...
	for e = 0 to ubound(dados_form)
		...
		mensagem = "Prezado(a) Senhor(a) "&resp_fin&Chr(13)&" Responsável "
	    if in_sexo = "F" then
			mensagem=mensagem&"pela nossa aluna "
		else
			mensagem=mensagem&"pelo nosso aluno "	
		end if	
		
		mensagem=mensagem&"matrícula "&co_matricula&" - "&nome_aluno&Chr(13)&Chr(13)	
		
		If meses = 1 then
			mensagem=mensagem&"Parcela em aberto do mês: "&desc_meses&Chr(13)&Chr(13)			
		else
			mensagem=mensagem&"Parcelas em aberto dos meses: "&desc_meses&Chr(13)&Chr(13)		
		end if		

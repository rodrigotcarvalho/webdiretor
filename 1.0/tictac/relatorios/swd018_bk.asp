...
CONEXAOA = "Select TB_Matriculas.CO_Matricula, TB_Matriculas.NU_Chamada, TB_Alunos.NO_Aluno, TB_Matriculas.CO_Situacao, TB_Matriculas.NU_Unidade, TB_Matriculas.CO_Curso, TB_Matriculas.CO_Etapa, TB_Matriculas.CO_Turma from TB_Matriculas, TB_Alunos WHERE TB_Matriculas.NU_Ano="& ano_letivo &" AND TB_Matriculas.CO_Matricula=TB_Alunos.CO_Matricula AND TB_Matriculas.CO_Matricula = "& co_matric
...
'================================================================================================================			
		...
		tabela_col=1
		for e=0 to 7
			Notas_Tit(linha, tabela_col).AddText "<div align=""center""><b></b></div>", "size=8; indenty=2; alignment=center; html=true", Font				
...
'Se os números de chamada estiverem completos. Se não faltar aluno na turma.
				...
				param_materias.Add "indentx=0"
			RESPONSE.Write("-------------------<br>")				
			RESPONSE.Write(dados_alunos(1)&"<br>")										
				for c=0 to ubound(nome_variaveis)	
			RESPONSE.Write(variaveis_bd(c)&"<br>")	

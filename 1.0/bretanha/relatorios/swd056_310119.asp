...
Param_Logo_Gde("ScaleY") = 0.6
		   Page.Canvas.DrawImage Logo, Param_Logo_Gde
			...
			End With
			Table(1, 1).ColSpan = 3			
			Table(1, 1).AddText "Aos 22 de dezembro de "&ano_letivo&" terminou-se o processo de apura&ccedil;&atilde;o de notas finais e nota global dos alunos deste estabelecimento com os seguintes resultados:", "size=8;html=true", Font	

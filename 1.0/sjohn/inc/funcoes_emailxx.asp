	...
	for e = 0 to ubound(dados_form)
		...
		if InStr(end_email,"@")=0 then
			...
			if eh_segunda_via = "S" then
				mensagem=mensagem&"Segue anexo a 2&ordf; Via do Bloqueto banc&aacute;rio da parcela referente ao m&ecirc;s de "&desc_meses&" do ano letivo de "&ano_letivo&Chr(13)&Chr(13)	
			else
				mensagem=mensagem&"Segue anexo o Bloqueto banc&aacute;rio da parcela referente ao m&ecirc;s de "&desc_meses&" do ano letivo de "&ano_letivo&Chr(13)&Chr(13)	
			end if

...
'Planilha de Avaliações Qualitativas
%>
...
'CABEÇALHO==========================================================================================		
		...
		Text = "<center><i><b><font style=""font-size:18pt;"">PLANILHA DE AVALIA&Ccedil;&Otilde;ES QUALITATIVAS</font></b></i></center>"
...
'================================================================================================================			
		...
		Notas_Tit.Font = Font				
		largura_colunas=(area_utilizavel-20-220)/(colunas_de_notas+1)
		...
		tabela_col=1
		Notas_Tit(linha, tabela_col).AddText "<div align=""center""><b>N&&ordm;</b></div>", "size=8; indenty=2; alignment=center; html=true", Font	
		tabela_col=2
		Notas_Tit(linha, tabela_col).AddText "<div align=""center""><b>Nome</b></div>", "size=8; indenty=2; alignment=center; html=true", Font	
		tabela_col=3						

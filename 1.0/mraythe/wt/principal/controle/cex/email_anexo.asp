...
e_nosso_numero = request.QueryString("nn")


post_mensagem = request.form("mensagem")

gerado =  GeraBloquetoNN(dados, e_cod, e_vencimento, "S", "T", e_nosso_numero) 
...
'			mensagem=mensagem&"Segue em anexo a 2&ordf; Via do Bloqueto banc&aacute;rio da parcela referente ao m&ecirc;s de "&desc_meses&" do ano letivo de "&ano_letivo&Chr(13)&Chr(13)	 
			...
			mensagem=Replace(post_mensagem,Chr(13),"<BR>")
			...
			'objCDOSYSMail.ReplyTo = email_financeiro
			objCDOSYSMail.To = end_email

'response.write(from&"-"&end_email&"-"&assunto)			
			'objCDOSYSMail.Cc = "osmarpio@openlink.com.br"
...
response.redirect("altera.asp?opt=ok&cod_cons="&co_matricula)
%>
...
<%
	...
	if RS.eof then
		...
		elseif ano_liberado="B" then
			...
			response.Redirect("index.asp?nvg=WS-DO-DPA-EFI&opt=err707&obr="&obr_err)		
		else
			response.Redirect("index.asp?nvg=WS-DO-DPA-EFI&opt=err9713&obr="&obr_err)
		end if		
	else
		msg="cons"
		...
		if ano_liberado="L" then
			response.Redirect("index.asp?nvg=WS-DO-DPA-EFI&opt=ask&obr="&obr_ask)		
		elseif ano_liberado="B" then
			response.Redirect("index.asp?nvg=WS-DO-DPA-EFI&opt=acc&res=blq&obr="&obr_ask&"$!$"&ano_letivo)
		else
			response.Redirect("index.asp?nvg=WS-DO-DPA-EFI&opt=err9713&obr="&obr_err)
		end if				
	end if	

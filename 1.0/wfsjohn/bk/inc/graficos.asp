...
Dim categories(5), Vals(5), Vals2(3)
...
.Charts(0).SeriesCollection(0).DataLabelsCollection(0).HasValue = FALSE
...
.Charts(0).SeriesCollection(0).DataLabelsCollection(0).Font.Color = "white"
...
'ajustando o tamanho do gráfico (figura).
Response.BinaryWrite oChart.GetPicture("gif",800, 320) 

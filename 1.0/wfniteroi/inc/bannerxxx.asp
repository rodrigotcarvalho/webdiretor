...
<table id="Table_01" width="1000" height="135" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td>
			<img src="<%response.write(parent_folder)%>img/banner_webfamilia_03.gif" width="248" height="68" border="0" alt="" usemap="#banner_webfamilia_03_Map"></td>
		<td>
...
<map name="banner_webfamilia_03_Map">
<area shape="rect" alt="Fale Conosco" coords="193,11,248,24" href="<%response.write(parent_folder&"faleconosco.asp")%>">
<area shape="rect" alt="Home" coords="97,11,176,25" href="<%response.write(parent_folder&inicio)%>">
</map>
<map name="banner_webfamilia_04_Map">
<area shape="rect" alt="Sair" coords="215,11,242,24"  href="<%response.write(parent_folder&"default.asp")%>" onclick = "if (! confirm('Voc&ecirc; deseja encerrar sua conex&atilde;o com o Web Fam&iacute;lia?')) { return false; }">
<area shape="rect" alt="Novo Login" coords="136,11,196,24"  href="<%response.write(parent_folder&"default.asp")%>" onclick = "if (! confirm('Voc&ecirc; deseja encerrar sua conex&atilde;o com o Web Fam&iacute;lia?')) { return false; }">
<area shape="rect" alt="Alterar Senha" coords="39,11,125,23" href="<%response.write(parent_folder&"seguranca/senha_mail/index.asp")%>">

...
for i=0 to ubound(conjunto_dados)	
	...
	While Not RSA.EOF
		...
		if nu_chamada_check = 1 and nu_chamada=nu_chamada_check then
			vetor_matriculas=nu_matricula&"#!#"&nu_chamada&"#!#"&nome_aluno
		elseif nu_chamada_check = 1 then
			...
			vetor_matriculas=vetor_matriculas&"#$#"&nu_matricula&"#!#"&nu_chamada&"#!#"&nome_aluno
		end if
	nu_chamada_check=nu_chamada_check+1		
	RSA.MoveNext
	Wend 
	...
	'CABEÇALHO==========================================================================================		
		   ...
		   Page.Canvas.DrawImage Logo, Param_Logo_Gde
			...
			With Page.Canvas
			   .MoveTo x_texto, altura_primeiro_separador
...
'response.end()
			...
			Set param_table2 = Pdf.CreateParam("width="&area_utilizavel&"; height="&altura_medias&"; rows=1; cols="&total_de_colunas&"; border=1; cellborder=0.1; cellspacing=0; x="&margem&"; y="&y_segunda_tabela&"; MaxHeight=350")
			...
			Notas_Tit(1, 1).AddText "<div align=""center""><b>Matr&iacute;cula</b></div>", "size=8;indenty=2; html=true", Font 
			Notas_Tit(1, 2).AddText "<div align=""center""><b>Nome</b></div>", "size=8;alignment=center; indenty=2;html=true", Font 
			Notas_Tit(1, 22).AddText "<div align=""center""><b>FRQ.</b></div>", "size=8;alignment=center; indenty=2;html=true", Font
			Notas_Tit(1, 23).AddText "<div align=""center""><b>RF.</b></div>", "size=8;alignment=center; indenty=2;html=true", Font 
			...
			linha=1
			resultados=Calc_Med_An_Fin(unidade, curso, co_etapa, turma, vetor_matriculas, vetor_materia, caminho_nota, tb_nota, 6, 5, 6, "final", 0)		
...
'response.Write(dados_alunos(0)&"-"&resultado_final_aluno&"=<BR><BR>")
				...
				if calcula_frequencia="s" then
					...
					SQL_N = "Select SUM(NU_Faltas) as Sum_Faltas from "&tb_nota&" WHERE CO_Matricula = "& dados_alunos(0)
...
'						end if									
				...
				Notas_Tit(linha, 22).AddText "<div align=""center"">"&frequencia&"</DIV>", param_materias	
				Notas_Tit(linha, 23).AddText "<div align=""center"">"&resultado_final_aluno&"</DIV>", param_materias															
			next

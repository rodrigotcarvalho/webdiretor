...
'Matricula,Nome, Idade,N�mero de chamada, Status
...
%> 
      <tr class="<%response.Write(cor)%>">         
        ...
        <td width="<%response.Write(width_else)%>" class="zoom_texto" onClick="recuperarNotaZoom(<% response.Write(width_tabela)%>,<% response.Write(cod_cons)%>,<% response.Write(ano_letivo)%>,<% response.Write(curso)%>,<% response.Write(co_etapa)%>,'<%response.Write(vet_co_materia(dsc))%>','<% response.Write(caminho_ajax)%>','<% response.Write(opcao)%>',<% response.Write(periodo_real)%>)"><div align="center">
          <%
...
%>
                  ...
                  <tr class="<%response.write(cor)%>"> 
                    <td colspan="6" bgcolor="#FFFFFF"><div align="center"><font class="zoom_texto">N&atilde;o 
...
%>
                ...
                <tr class="zoom_tit"> 
                  <td width="180" bgcolor="#FFFFFF"> <div align="left">Data / Hora</div></td>
                  <td width="490" bgcolor="#FFFFFF"> <div align="left">Ocorr&ecirc;ncia</div></td>
                  <td bgcolor="#FFFFFF"> <div align="left">Professor</div></td>
                  <td bgcolor="#FFFFFF"> <div align="left">Disciplina</div></td>
                  <td bgcolor="#FFFFFF"><div align="center">Aula</div></td>
                  <td bgcolor="#FFFFFF"> <div align="center">Atendido por</div></td>
                </tr>
...
%>
                  <tr class="<%response.write(cor)%>">
                    ...
                    <td width="490" class="zoom_texto"><div align="left">

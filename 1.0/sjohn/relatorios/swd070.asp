	...
	for aln=0 to ubound(aluno)
		...
		for q=0 to ubound(co_mat_cons)
			...
			if tipo_calculo = "MA" then		
				resultado=Calc_Med_An_Fin(ucet(0), ucet(1), ucet(2), ucet(3), nu_matricula, disciplina, caminho_n, tabela, 6, 5, 6,"anual", 0)	
				...
				elseif tp_disc="mcd" then
							...
							media_aluno=Calcula_Media_T_F_T_N(ucet(0), ucet(1), ucet(2), ucet(3), tp_modelo, tp_freq, nu_matricula, disciplina, vetor_filhas, CON_N, tabela, periodo, "VA_Media2", outro)

...
resultado_form=dados_informados(5)
...
'================================================================================================================			
			...
			Notas_Tit(1, 1).AddText "<div align=""center""><b>Disciplinas</b></div>", "size=9;indenty=13; html=true", Font 
			Notas_Tit(1, 2).AddText "<div align=""center""><b>Aproveitamento</b></div>", "size=8;alignment=center; indenty=1;html=true", Font  
			Notas_Tit(1, 12).AddText "<div align=""center""><b>Faltas</b></div>", "size=8;alignment=center; indenty=1;html=true", Font  
			Notas_Tit(2, 2).AddText "<div align=""center"">M&eacute;dia<BR>1&ordm; Tri</div>", "size=7;alignment=center;indenty=3;html=true", Font 
			Notas_Tit(2, 3).AddText "<div align=""center"">M&eacute;dia<BR>Acum.</div>", "size=7;alignment=center;indenty=3;html=true", Font 
			Notas_Tit(2, 4).AddText "<div align=""center"">M&eacute;dia<BR>2&ordm; Tri</div>", "size=7;alignment=center;indenty=3;html=true", Font 
			Notas_Tit(2, 5).AddText "<div align=""center"">M&eacute;dia<BR>Acum.</div>", "size=7 ;alignment=center;indenty=3;html=true", Font 
			Notas_Tit(2, 6).AddText "<div align=""center"">M&eacute;dia<BR>3&ordm; Tri</div>", "size=7;alignment=center;indenty=3;html=true", Font 
			Notas_Tit(2, 7).AddText "<div align=""center"">M&eacute;dia<BR>Acum.</div>", "size=7 ;alignment=center;indenty=3;html=true", Font 			
			Notas_Tit(2, 8).AddText "<div align=""center"">Result.</div>", "size=7;alignment=center;indenty=7;html=true", Font 
			Notas_Tit(2, 9).AddText "<div align=""center"">ECE</div>", "size=7;alignment=center;indenty=7;html=true", Font 
			Notas_Tit(2, 10).AddText "<div align=""center"">M&eacute;dia<br>Final</div>", "size=7;alignment=center;indenty=3;html=true", Font 
			Notas_Tit(2, 11).AddText "<div align=""center"">Result.<BR>Final</div>", "size=7;alignment=center;indenty=3;html=true", Font 
			Notas_Tit(2, 12).AddText "<div align=""center"">1&ordm; Tri</div>", "size=7;alignment=center;indenty=7;html=true", Font 
			Notas_Tit(2, 13).AddText "<div align=""center"">2&ordm; Tri</div>", "size=7;alignment=center;indenty=7;html=true", Font 
			Notas_Tit(2, 14).AddText "<div align=""center"">3&ordm; Tri</div>", "size=7;alignment=center;indenty=7;html=true;", Font 
			Notas_Tit(2, 15).AddText "<div align=""center"">Total</div>", "size=7;alignment=center;indenty=7;html=true", Font 
...
'					Row.Cells(1).AddText no_materia_exibe, param_materias
			...
			Page.Canvas.DrawTable Notas_Tit, "x="&margem&", y="&y_medias&"" 	
				...
				if periodo_form>2 and resultado_form = "s" then
					...
					resultados=Calc_Med_An_Fin(unidade, curso, etapa, turma, cod_cons, vetor_materia, caminho_nota, tb_nota, 4, 4, 0, "final", "boletim")		
					...
					if ubound(resultados_apurados)=-1 then
						...
						resultado_final_aluno=apura_resultado_geral_aluno(curso, etapa, resultados, "A")
					end if
...
'					response.End()									
					if (resultado_final_aluno="Apr" or resultado_final_aluno="APR") then
						...
						legenda_resultado=""						
						resultado_exibe="O aluno foi aprovado para o pr&oacute;ximo ano letivo"
					elseif (resultado_final_aluno="Rep" or resultado_final_aluno="REP") then	
						'legenda_resultado="<b>Resultado:</b>"
						legenda_resultado=""				
						resultado_exibe="O aluno foi reprovado"	
					elseif (resultado_final_aluno="Ece" or resultado_final_aluno="ECE") then	
						'legenda_resultado="<b>Resultado:</b>"		
						legenda_resultado=""									
						resultado_exibe="O aluno est&aacute; em etapa complementar de estudos nas mat&eacute;rias indicadas"	
					else
						'legenda_resultado="<b>Resultado:</b>"					
						'resultado_exibe=resultado_final_aluno
						legenda_resultado=""											
						resultado_exibe=""											
					end if					
				else
...
'	if cod_cons=2372 then
'		response.Write(resultados&"-"&resultado_final_aluno)
'		response.End()
'	end if

				y_impresso=y_medias-altura_medias-15
				
				Set param_table4 = Pdf.CreateParam("width=350; height=15; rows=1; cols=1; border=0; cellborder=0; cellspacing=0;indenty=2;")
				Set Impresso = Doc.CreateTable(param_table4)
				Impresso.Font = Font

				
				Impresso(1, 1).AddText legenda_resultado&" "&resultado_exibe, "size=8;html=true", Font 
				Page.Canvas.DrawTable Impresso, "x=30, y="&y_impresso&""
'	

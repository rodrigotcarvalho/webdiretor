...
'					temp_num_periodo=temp_num_periodo&"#!#2#!#0#!#0#!#0#!#0"
'					periodo_exibe=periodo_exibe&"#!#"&vetor_periodo(v)&"#!#MS#!#RECP#!#BIM1*#!#BIM2*"
...
'				elseif vetor_periodo(v)="RECUP" then	
'					temp_num_periodo=temp_num_periodo&"#!#5#!#0"
'					periodo_exibe=periodo_exibe&"#!#RECF#!#MF"						
'				end if	
'			next										
'		else
'			vetor_periodo=split(temp_nomes_periodos,"#!#")
...
'	nom_periodo=split(periodo_exibe,"#!#")
	...
	num_periodo_detalhe=periodos_ACC(periodo,acumulado,qto_falta,"num",0)
	vetor_num_periodo=num_periodo_detalhe
	num_periodo=split(num_periodo_detalhe,"#!#")	

	vetor_nom_periodo=periodos_ACC(periodo,acumulado,qto_falta,"nom",0)
...
'				if prd=0 then
			...
			for dsc=0 to ubound(vet_co_materia)	
				...
				elseif media="A" or media="B" or media="C" or media="D" or media="E" then	
					Notas_Tit(linha, coluna).AddText "<div align=""center"">"&media&"</div>", "size=8;indenty=1; html=true", Font 
				else					
		'			media=media*1	
		'			ntazl=ntazl*1
		'			ntvml=ntvml*1
		...
		'			end if	
					Notas_Tit(linha, coluna).AddText "<div align=""center"">"&formatnumber(media,1)&"</div>", "size=8;indenty=1; html=true", Font 		
				end if	
			next
'		next
		RS1.MOVENEXT

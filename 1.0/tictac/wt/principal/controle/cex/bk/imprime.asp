...
if mes_parcela = "nulo" or mes_parcela = "p" then
...
>MORA&nbsp;&nbsp;&nbsp;</td>
          <td width="94" align="right" class="tabela" 
>VALOR CORRIGIDO&nbsp;&nbsp;&nbsp;</td>
...
%>
                <tr> 
                  <td colspan="9" class="tabela"> <div align="center"><br>
                      <br>
                      <br>
                      <br>
                      <br>
...
da_realizado_show=""		
		%>
		                      <tr> 
                        <td colspan="9" class="tabela" > <div align="center">

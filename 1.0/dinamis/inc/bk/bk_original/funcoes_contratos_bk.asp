...
elseif left(p_tp_contrato_adendo,6) = "ADENDO" then
    ...
    resultado = resultado&"respons&aacute;vel pelo aluno "&no_aluno&" matriculado no "&Server.HTMLEncode(lcase(no_prox_etapa))&" "&geraPreposicaoEtapa(p_tp_contrato_adendo, prox_curso)&" "&Server.HTMLEncode(geraNomeEtapa(p_tp_contrato_adendo, prox_curso))&", " 
...
if tp_contrato_adendo = "ADENDOESC2" then
...
if left(p_tp_contrato_adendo,8) = "CONTRATO" then
	...
	if p_tp_contrato_adendo = "CONTRATO_1A" or p_tp_contrato_adendo = "CONTRATO_1B" or p_tp_contrato_adendo = "CONTRATO_2A" or p_tp_contrato_adendo = "CONTRATO_2B" or p_tp_contrato_adendo = "CONTRATO_3" or p_tp_contrato_adendo = "CONTRATO_5" or p_tp_contrato_adendo = "CONTRATO_8" or p_tp_contrato_adendo = "CONTRATO_G1" or p_tp_contrato_adendo = "CONTRATO_G2" or p_tp_contrato_adendo = "CONTRATO_G3" or p_tp_contrato_adendo = "CONTRATO_G4" or p_tp_contrato_adendo = "CONTRATO1A" or p_tp_contrato_adendo = "CONTRATO1B" or p_tp_contrato_adendo = "CONTRATO2A" or p_tp_contrato_adendo = "CONTRATO2B" or p_tp_contrato_adendo = "CONTRATO3" or p_tp_contrato_adendo = "CONTRATO8" or p_tp_contrato_adendo = "CONTRATOG1" then
		...
		resultado = resultado&SpacePad(buscaTestemunha(1,"I"),"&nbsp;",59,"L")&SpacePad(buscaTestemunha(3,"I"),"&nbsp;",60,"L")&"<BR>"					
	else	
...
function buscaTestemunha(p_num_testemunha, p_tipo)
	...
	elseif p_num_testemunha = 3 then
		...
		elseif p_tipo = "I" then				
			resultado = "IDENTIDADE: 1933310-3 - DETRAN"	
		end if							
	end if

...
if (co_materia_pr="ACO" and co_materia="ACO") or (co_materia_pr="ATUAL" and co_materia="ATUAL") or (co_materia_pr="ART1" and co_materia="ART1") or (co_materia_pr="CINE" and co_materia="CINE") or (co_materia_pr="EAM" and co_materia="EAM") or (co_materia_pr="EF" and co_materia="EF") or (co_materia_pr="EFIS" and co_materia="EFIS") or (co_materia_pr="HAR" and co_materia="HAR") or (co_materia_pr="MUS" and co_materia="MUS") or (co_materia_pr="NMID" and co_materia="NMID") or (co_materia_pr="PRE" and co_materia="PRE") or (co_materia_pr="PREA" and co_materia="PREA") or (co_materia_pr="PREC" and co_materia="PREC") or (co_materia_pr="PRS" and co_materia="PRS") or (co_materia_pr="ROBO" and co_materia="ROBO") or (co_materia_pr="SAD" and co_materia="SAD")  then	
	limite_sim = 100
	libera_limites = "S"
else
	limite_sim = 20
...
s_va_p=0
	if s_lancada="ok" and libera_limites = "N" then
		limite_p1=80
		tipo_erro="p1b"
	else
		limite_p1=100	
...
if grava = "ok" then
	...
	if (co_materia_pr="ACO" and co_materia="ACO") or (co_materia_pr="ATUAL" and co_materia="ATUAL") or (co_materia_pr="ART1" and co_materia="ART1") or (co_materia_pr="CINE" and co_materia="CINE") or (co_materia_pr="EAM" and co_materia="EAM") or (co_materia_pr="EF" and co_materia="EF") or (co_materia_pr="EFIS" and co_materia="EFIS") or (co_materia_pr="HAR" and co_materia="HAR") or (co_materia_pr="MUS" and co_materia="MUS") or (co_materia_pr="NMID" and co_materia="NMID") or (co_materia_pr="PRE" and co_materia="PRE") or (co_materia_pr="PREA" and co_materia="PREA") or (co_materia_pr="PREC" and co_materia="PREC") or (co_materia_pr="PRS" and co_materia="PRS") or (co_materia_pr="ROBO" and co_materia="ROBO") or (co_materia_pr="SAD" and co_materia="SAD")  then
		...
		if teste_1_lancado="no" and teste_2_lancado="no" and teste_3_lancado="no" and teste_4_lancado="no" THEN
			...
			media_t="ok"		
			mt=(soma_teste1+soma_teste2+soma_teste3+soma_teste4)/s_va_t
	...
	if session("ano_letivo")>=2017 then
		...
		if (co_materia_pr="ACO" and co_materia="ACO") or (co_materia_pr="ATUAL" and co_materia="ATUAL") or (co_materia_pr="ART1" and co_materia="ART1") or (co_materia_pr="CINE" and co_materia="CINE") or (co_materia_pr="EAM" and co_materia="EAM") or (co_materia_pr="EF" and co_materia="EF") or (co_materia_pr="EFIS" and co_materia="EFIS") or (co_materia_pr="HAR" and co_materia="HAR") or (co_materia_pr="MUS" and co_materia="MUS") or (co_materia_pr="NMID" and co_materia="NMID") or (co_materia_pr="PRE" and co_materia="PRE") or (co_materia_pr="PREA" and co_materia="PREA") or (co_materia_pr="PREC" and co_materia="PREC") or (co_materia_pr="PRS" and co_materia="PRS") or (co_materia_pr="ROBO" and co_materia="ROBO") or (co_materia_pr="SAD" and co_materia="SAD")  then
			if p1_lancada="n" and s_lancada="n" and p2_lancada="n" then
				media_p="no"
				mp=NULL	
			else
	'			mp = (soma_prova1+soma_prova2+soma_simul)/(s_va_p1+s_va_p2+s_va_simul)
	'			mp = formatNumber(mp,0)	
				media_p="no"			
				mp=NULL				
			end if		
	...
	elseif (co_materia_pr="ACO" and co_materia="ACO") or (co_materia_pr="ATUAL" and co_materia="ATUAL") or (co_materia_pr="ART1" and co_materia="ART1") or (co_materia_pr="CINE" and co_materia="CINE") or (co_materia_pr="EAM" and co_materia="EAM") or (co_materia_pr="EF" and co_materia="EF") or (co_materia_pr="EFIS" and co_materia="EFIS") or (co_materia_pr="HAR" and co_materia="HAR") or (co_materia_pr="MUS" and co_materia="MUS") or (co_materia_pr="NMID" and co_materia="NMID") or (co_materia_pr="PRE" and co_materia="PRE") or (co_materia_pr="PREA" and co_materia="PREA") or (co_materia_pr="PREC" and co_materia="PREC") or (co_materia_pr="PRS" and co_materia="PRS") or (co_materia_pr="ROBO" and co_materia="ROBO") or (co_materia_pr="SAD" and co_materia="SAD")  then	
'Alterado conforme e-mail de 17/07/2013	
...
'Alterado conforme e-mail de 09/05/2013
'	if(co_materia_pr="ART1" and co_materia="ART1") or (co_materia_pr="EF" and co_materia="EF") or (co_materia_pr="EFIS" and co_materia="EFIS") or (co_materia_pr="PRE" and co_materia="PRE") or (co_materia_pr="PREA" and co_materia="PREA")  or (co_materia_pr="PREC" and co_materia="PREC") or (co_materia_pr="PRS" and co_materia="PRS") or periodo>4 then
'Alterado conforme e-mail de 02/05/2012 para retirar  (co_materia_pr="DGEO" and co_materia="DGEO") or 
'	if(co_materia_pr="PREA" and co_materia="PREA") or (co_materia_pr="PRE" and co_materia="PRE") or (co_materia_pr="PRS" and co_materia="PRS") or (co_materia_pr="PREC" and co_materia="PREC") or (co_materia_pr="DGEO" and co_materia="DGEO") or (co_materia_pr="ART1" and co_materia="ART1") or (co_materia_pr="EFIS" and co_materia="EFIS") or (co_materia_pr="EF" and co_materia="EF") or periodo>4 then
		...
		if p1_lancada="n" and s_lancada="n" and p2_lancada="n" then
			...
			m1 = (soma_prova1+soma_prova2+soma_simul)/(s_va_p1+s_va_p2+s_va_simul)
			m1 = formatNumber(m1,0)		
		end if	
	else
		...
		va_pp=va_pp*1
			if co_materia_pr="LP" and co_materia="LP" then
				...
				if media_t="ok" and p1_lancada="ok" then
				soma_prova1=soma_prova1*1
				soma_simul=soma_simul*1
				soma_prova2=soma_prova2*1
	'if i=2 then			
...
'Alterado por conta de e-mail de 13/04/2012		
'			curso=curso*1	
'			etapa=etapa*1

...
><font class="form_corpo"> 
                            <input name="rua_res" type="text" class="borda" id="rua_res" value="" size="30">
                            </font></td>
...
><font class="form_corpo"> <font class="form_corpo"> <font class="form_corpo"> 
                            <input name="num_res" type="text" class="borda" id="num_res" value="" size="12" maxlength="10">
                            </font></font></font></td>
...
> <div align="left"><font class="form_corpo"> </font> <font class="form_corpo"> 
                              <input name="comp_res" type="text" class="borda" id="comp_res" value="" size="20" maxlength="15">
                              </font></div></td>
                        </tr>
                        <tr> 
...
><font class="form_dado_texto"> 
                            <input name="cep" type="text" class="borda" id="cep" onKeyup="formatar(this, '#####-###')" value="" size="11" maxlength="9">
                            </font></td>
                          <td width="140" height="10" class="tb_corpo"
>&nbsp;</td>
                          <td width="19" class="tb_corpo"
...
><font class="form_corpo"> 
                            <input name="tel_res" type="text" class="borda" id="tel_res" value="" size="42" maxlength="50">
...
> <div align="left">:</div></td>
                          <td width="217" height="10" class="tb_corpo"
><font class="form_corpo"> 
                            <input name="rua_com" type="text" class="borda" id="rua_com" value="" size="30">
                            </font></td>
                          <td width="140" height="10" class="tb_corpo"
> <div align="left"><font class="form_dado_texto"> N&uacute;mero</font></div></td>
                          <td width="19" class="tb_corpo"
> <div align="center">:</div></td>
                          <td width="196" class="tb_corpo"
><font class="form_corpo"> 
                            <input name="num_com" type="text" class="borda" id="num_com" value="" size="12" maxlength="10">
                            </font></td>
                          <td width="90" class="tb_corpo"
><font class="form_dado_texto">Complemento</font></td>
                          <td class="tb_corpo"
><div align="center">:</div></td>
                          <td width="149" height="10" class="tb_corpo"
> <div align="left"><font class="form_corpo"> </font> <font class="form_corpo"> 
                              <input name="comp_com" type="text" class="borda" id="comp_com"  value="" size="20" maxlength="15">
                              </font></div></td>
                        </tr>
                        <tr class="tb_corpo"
> 
...
> 
                          ...
                          <td width="217" height="26"><font class="form_dado_texto"> 
                            <input name="cep_com" type="text" class="borda" id="cepcom" onKeyup="formatar(this, '#####-###')" value="" size="11" maxlength="9">
                            </font></td>
...
> 
                          ...
                          <td height="28" colspan="2"><font class="form_corpo"> 
                            <input name="tel_com" type="text" class="borda" id="tel_com" value="" size="42" maxlength="50">
                            </font> <div align="left"></div></td>
                          <td width="19"> <div align="center"></div></td>
...
ocupacao= RS9("NO_Ocupacao")
		...
		Set RSCONTACONT = Server.CreateObject("ADODB.Recordset")
		SQLAC = "SELECT * FROM TBI_Contatos WHERE CO_Matricula ="& aluno&" order by NU_Prioridade_Combo"
		RSCONTACONT.Open SQLAC, CONCONT_aux
familiares=0
if RSCONTACONT.EOF then
foco=foco_default
...
><font class="form_corpo"> 
                            <div id="cid_res"> 
                              <select name="cid_res" class="borda" id="select10" onChange="recuperarBairroRes(this.value)">
                                <%
Set RS2m = Server.CreateObject("ADODB.Recordset")
		SQL2m = "SELECT * FROM TB_Municipios WHERE SG_UF='"&uf_res&"' order by NO_Municipio"
		RS2m.Open SQL2m, CON0
...
%>
                          ...
                          <td width="19"> <div align="center">:</div></td>
                          <td width="196"> <div id="cid_com"> 
                              <select name="cid_com" class="borda" id="select10" onChange="recuperarBairroCom(this.value)">
                                <%
Set RS2m = Server.CreateObject("ADODB.Recordset")
		SQL2m = "SELECT * FROM TB_Municipios WHERE SG_UF='"&uf_com&"' order by NO_Municipio"
		RS2m.Open SQL2m, CON0
...
> 
                          ...
                          <td width="13"> <div align="left">:</div></td>
                          <td width="217" height="26"><font class="form_dado_texto"> 
                            <input name="cep_com" type="text" class="borda" id="cepcom" onKeyup="formatar(this, '#####-###')" value="<%response.Write(cep_com)%>" size="11" maxlength="9">
                            </font></td>
                          <td width="140" height="26">&nbsp;</td>
                          <td width="19">&nbsp;</td>
                          <td width="196">&nbsp;</td>

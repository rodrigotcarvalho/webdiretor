...
dados_tabela=dados_planilha_notas(ano_letivo,unidade,curso,etapa,turma,co_materia,0,periodo,"A",outro)
...
va_apr8=va_apr8*1
va_v_apr8=va_v_apr8*1			
response.Write(va_apr8 &"=<"& va_v_apr8&"<BR>")
...
pr1pr2=va_pr+va_te
	...
	if va_bon="" or isnull(va_bon) then
		...
		if teste_va_bon = true then
			if va_bon>=0 and va_bon<=100 then
				s_va_bon=va_bon
			else
				fail = 1 
				erro = "bon"
...
if grava = "ok" then
		...
		CONEXAO0 = "Select * from TB_Nota_A WHERE CO_Matricula = "& nu_matricula &" AND CO_Materia_Principal = '"& co_materia_pr &"' AND CO_Materia = '"& co_materia &"'"
...
'if periodo=1 then
'teste= "UPDATE TB_Nota_A SET "&no_apr1&" ='"&va_apr1&"', "&no_apr2&" ='"&va_apr2&"', "&no_apr3&" ='"&va_apr3&"', "&no_apr4&" ='"&va_apr4&"', "&no_apr5&" ='"&va_apr5&"', "
...
if periodo=1 then
	sql_atualiza= "UPDATE TB_Nota_A SET "&variaveis_bd(0)&" ='"&va_apr1&"', "&variaveis_bd(1)&" ='"&va_apr2&"', "&variaveis_bd(2)&" ='"&va_apr3&"', "&variaveis_bd(3)&" ='"
	...
	sql_atualiza=sql_atualiza&variaveis_bd(12)&" ='"&va_mc&"', "&variaveis_bd(13)&" ='"&va_me&"', "&variaveis_bd(14)&" = '"&faltas&"', VA_Mc2='"&va_mc2&"', VA_Mc3='"&va_mc3
...
elseif periodo=2 then
	...
	sql_atualiza=sql_atualiza&linha_pesos_variaveis(7)&" ='"&va_v_apr6&"', "&linha_pesos_variaveis(8)&" ='"&va_v_apr7&"', "&linha_pesos_variaveis(9)&" ='"&va_v_apr8&"', "
	sql_atualiza=sql_atualiza&variaveis_bd(8)&" ='"&va_sapr&"', "&variaveis_bd(9)&" ='"&va_pr&"', "&variaveis_bd(10)&" ='"&va_te&"', "&variaveis_bd(11)&" ='"&va_bon&"',"
	sql_atualiza=sql_atualiza&variaveis_bd(12)&" ='"&va_mc&"', "&variaveis_bd(13)&" ='"&va_me&"', "&variaveis_bd(14)&" = '"&faltas&"', VA_Mc3='"&va_mc3
	sql_atualiza=sql_atualiza&"', VA_Mfinal='"&va_mc4&"', DA_Ult_Acesso ='"& data &"', HO_ult_Acesso ='"& horario &"', CO_Usuario="& co_usr &"  WHERE CO_Matricula = "
	sql_atualiza=sql_atualiza& nu_matricula &" AND CO_Materia_Principal = '"& co_materia_pr &"' AND CO_Materia = '"& co_materia &"'"
elseif periodo=3 then
	sql_atualiza= "UPDATE TB_Nota_A SET "&variaveis_bd(0)&" ='"&va_apr1&"', "&variaveis_bd(1)&" ='"&va_apr2&"', "&variaveis_bd(2)&" ='"&va_apr3&"', "&variaveis_bd(3)&" ='"
	...
	sql_atualiza=sql_atualiza&linha_pesos_variaveis(7)&" ='"&va_v_apr6&"', "&linha_pesos_variaveis(8)&" ='"&va_v_apr7&"', "&linha_pesos_variaveis(9)&" ='"&va_v_apr8&"', "
	sql_atualiza=sql_atualiza&variaveis_bd(8)&" ='"&va_sapr&"', "&variaveis_bd(9)&" ='"&va_pr&"', "&variaveis_bd(10)&" ='"&va_te&"', "&variaveis_bd(11)&" ='"&va_bon&"',"
	sql_atualiza=sql_atualiza&variaveis_bd(12)&" ='"&va_mc&"', "&variaveis_bd(13)&" ='"&va_me&"', "&variaveis_bd(14)&" = '"&faltas
	sql_atualiza=sql_atualiza&"', VA_Mfinal='"&va_mc4&"', DA_Ult_Acesso ='"& data &"', HO_ult_Acesso ='"& horario &"', CO_Usuario="& co_usr &"  WHERE CO_Matricula = "
	sql_atualiza=sql_atualiza& nu_matricula &" AND CO_Materia_Principal = '"& co_materia_pr &"' AND CO_Materia = '"& co_materia &"'"	
	...
	sql_atualiza=sql_atualiza&va_v_apr3&"', "&linha_pesos_variaveis(5)&" ='"&va_v_apr4&"', "&linha_pesos_variaveis(6)&" ='"&va_v_apr5&"', "
	sql_atualiza=sql_atualiza&linha_pesos_variaveis(7)&" ='"&va_v_apr6&"', "&linha_pesos_variaveis(8)&" ='"&va_v_apr7&"', "&linha_pesos_variaveis(9)&" ='"&va_v_apr8&"', "
	sql_atualiza=sql_atualiza&variaveis_bd(8)&" ='"&va_sapr&"', "&variaveis_bd(9)&" ='"&va_pr&"',"&variaveis_bd(12)&" ='"&va_mc&"', "&variaveis_bd(13)&" ='"&va_me&"', "
...
'if periodo=1 then
'sql_atualiza= "UPDATE TB_Nota_A SET "&no_apr1&" ='"&va_apr1&"', "&no_apr2&" ='"&va_apr2&"', "&no_apr3&" ='"&va_apr3&"', "&no_apr4&" ='"&va_apr4&"', "&no_apr5&" ='"&va_apr5&"', "
'sql_atualiza=sql_atualiza&no_apr6&" ='"&va_apr6&"',"&no_apr7&" ='"&va_apr7&"', "&no_apr8&" ='"&va_apr8&"', "&no_v_apr1&" ='"&va_v_apr1&"', "&no_v_apr2&" ='"&va_v_apr2&"', "&no_v_apr3&" ='"&va_v_apr3&"', "&no_v_apr4&" ='"&va_v_apr4&"', "
'sql_atualiza=sql_atualiza&no_v_apr5&" ='"&va_v_apr5&"', "&no_v_apr6&" ='"&va_v_apr6&"', "&no_v_apr7&" ='"&va_v_apr7&"', "&no_v_apr8&" ='"&va_v_apr8&"', "&no_sapr&" ='"&va_sapr&"', "&no_pr&" ='"&va_pr&"', "&no_te&" ='"&va_te&"', "&no_bon&" ='"&va_bon&"',"&no_mc&" ='"&va_mc&"', "
'sql_atualiza=sql_atualiza&no_me&" ='"&va_me&"', "&no_faltas&" = '"&faltas&"', VA_Mc2='"&va_mc2&"', VA_Mc3='"&va_mc3&"', VA_Mfinal='"&va_mc4&"', DA_Ult_Acesso ='"& data &"', HO_ult_Acesso ='"& horario &"', CO_Usuario="& co_usr &"  WHERE CO_Matricula = "& nu_matricula &" AND CO_Materia_Principal = '"& co_materia_pr &"' AND CO_Materia = '"& co_materia &"'"
'
'elseif periodo=2 then
'sql_atualiza= "UPDATE TB_Nota_A SET "&no_apr1&" ='"&va_apr1&"', "&no_apr2&" ='"&va_apr2&"', "&no_apr3&" ='"&va_apr3&"', "&no_apr4&" ='"&va_apr4&"', "&no_apr5&" ='"&va_apr5&"', "
'sql_atualiza=sql_atualiza&no_apr6&" ='"&va_apr6&"', "&no_apr7&" ='"&va_apr7&"', "&no_apr8&" ='"&va_apr8&"', "&no_v_apr1&" ='"&va_v_apr1&"', "&no_v_apr2&" ='"&va_v_apr2&"', "&no_v_apr3&" ='"&va_v_apr3&"', "&no_v_apr4&" ='"&va_v_apr4&"', "
'sql_atualiza=sql_atualiza&no_v_apr5&" ='"&va_v_apr5&"', "&no_v_apr6&" ='"&va_v_apr6&"', "&no_v_apr7&" ='"&va_v_apr7&"', "&no_v_apr8&" ='"&va_v_apr8&"', "&no_sapr&" ='"&va_sapr&"', "&no_pr&" ='"&va_pr&"', "&no_te&" ='"&va_te&"', "&no_bon&" ='"&va_bon&"',"&no_mc&" ='"&va_mc&"', "
'sql_atualiza=sql_atualiza&no_me&" ='"&va_me&"', "&no_faltas&" = '"&faltas&"', VA_Mc3='"&va_mc3&"', VA_Mfinal='"&va_mc4&"', DA_Ult_Acesso ='"& data &"', HO_ult_Acesso ='"& horario &"', CO_Usuario="& co_usr &"  WHERE CO_Matricula = "& nu_matricula &" AND CO_Materia_Principal = '"& co_materia_pr &"' AND CO_Materia = '"& co_materia &"'"
'
'elseif periodo=3 then
'sql_atualiza= "UPDATE TB_Nota_A SET "&no_apr1&" ='"&va_apr1&"', "&no_apr2&" ='"&va_apr2&"', "&no_apr3&" ='"&va_apr3&"', "&no_apr4&" ='"&va_apr4&"', "&no_apr5&" ='"&va_apr5&"', "
'sql_atualiza=sql_atualiza&no_apr6&" ='"&va_apr6&"', "&no_apr7&" ='"&va_apr7&"', "&no_apr8&" ='"&va_apr8&"', "&no_v_apr1&" ='"&va_v_apr1&"', "&no_v_apr2&" ='"&va_v_apr2&"', "&no_v_apr3&" ='"&va_v_apr3&"', "&no_v_apr4&" ='"&va_v_apr4&"', "
'sql_atualiza=sql_atualiza&no_v_apr5&" ='"&va_v_apr5&"', "&no_v_apr6&" ='"&va_v_apr6&"', "&no_v_apr7&" ='"&va_v_apr7&"', "&no_v_apr8&" ='"&va_v_apr8&"', "&no_sapr&" ='"&va_sapr&"', "&no_pr&" ='"&va_pr&"', "&no_te&" ='"&va_te&"', "&no_bon&" ='"&va_bon&"',"&no_mc&" ='"&va_mc&"', "
'sql_atualiza=sql_atualiza&no_me&" ='"&va_me&"', "&no_faltas&" = '"&faltas&"', VA_Mfinal='"&va_mc4&"', DA_Ult_Acesso ='"& data &"', HO_ult_Acesso ='"& horario &"', CO_Usuario="& co_usr &"  WHERE CO_Matricula = "& nu_matricula &" AND CO_Materia_Principal = '"& co_materia_pr &"' AND CO_Materia = '"& co_materia &"'"
'
'elseif periodo=4 then
'sql_atualiza= "UPDATE TB_Nota_A SET "&no_apr1&" ='"&va_apr1&"', "&no_apr2&" ='"&va_apr2&"', "&no_apr3&" ='"&va_apr3&"', "&no_apr4&" ='"&va_apr4&"', "&no_apr5&" ='"&va_apr5&"', "
'sql_atualiza=sql_atualiza&no_apr6&" ='"&va_apr6&"', "&no_apr7&" ='"&va_apr7&"', "&no_apr8&" ='"&va_apr8&"', "&no_v_apr1&" ='"&va_v_apr1&"', "&no_v_apr2&" ='"&va_v_apr2&"', "&no_v_apr3&" ='"&va_v_apr3&"', "&no_v_apr4&" ='"&va_v_apr4&"', "
'sql_atualiza=sql_atualiza&no_v_apr5&" ='"&va_v_apr5&"', "&no_v_apr6&" ='"&va_v_apr6&"', "&no_v_apr7&" ='"&va_v_apr7&"', "&no_v_apr8&" ='"&va_v_apr8&"', "&no_sapr&" ='"&va_sapr&"', "&no_pr&" ='"&va_pr&"', "&no_mc&" ='"&va_mc&"', "
'sql_atualiza=sql_atualiza&no_me&" ='"&va_me&"', DA_Ult_Acesso ='"& data &"', HO_ult_Acesso ='"& horario &"', CO_Usuario="& co_usr &"  WHERE CO_Matricula = "& nu_matricula &" AND CO_Materia_Principal = '"& co_materia_pr &"' AND CO_Materia = '"& co_materia &"'"
'end if

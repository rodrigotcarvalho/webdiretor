...
ano_letivo = session("ano_letivo") 
		...
		session("dt_exibe_pos_fin")=RSal("DT_Incio_FI")
...
tp=session("tp")
		...
		Set RSal = Server.CreateObject("ADODB.Recordset")
		SQLal = "SELECT * FROM TB_Ano_Letivo where NU_Ano_Letivo='"&session("ano_letivo")&"'"
		RSal.Open SQLal, CON
...
<table width="170" style="BORDER-TOP: #a8adb0 1px solid; BORDER-RIGHT: #a8adb0 1px solid; BORDER-LEFT: #a8adb0 1px solid; BORDER-BOTTOM: #a8adb0 1px solid">
  <tr> 
   ...
   <!-- <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#990000"><div align="center"><font class="menu_lista">Coordena&ccedil;&atilde;o 
        de Ensino</font></div></td>
  </tr>
  <tr> 
  ...
  <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#990000"> 
...
<!--   <tr>
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
                onmouseout="this.className='menuc'"><img src="img/menu_seta.gif" width="19" height="15" /><a href="resultados/graficos/index.asp" class="menu_sublista">Gr&aacute;ficos 
      Comparativos </a></td>
  </tr> -->
  <tr> 
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
  ...
  <tr> 
  <!--   <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#990000"><div align="center"><font class="menu_lista">Documentos</font></div></td>
  </tr>
  <tr> 
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
                onmouseout="this.className='menuc'"><img src="img/menu_seta.gif" width="19" height="15" /><a href="docs/avcirc/index.asp" class="menu_sublista">Avisos 
      e Circulares</a></td>
  </tr>
  <tr> 
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
                onmouseout="this.className='menuc'"><img src="img/menu_seta.gif" width="19" height="15" /><a href="docs/provgab/index.asp" class="menu_sublista">Provas 
      e Gabaritos </a></td>
  </tr> 
  <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#990000"><div align="center"><font class="menu_lista">Agenda 
        do Ano Letivo</font></div></td>
  </tr>
  <tr> 
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
  ...
  <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#990000"><div align="center"><font class="menu_lista">Posi&ccedil;&atilde;o 
        Financeira</font></div></td>
  </tr>
  <tr> 
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
  ...
  <tr>  
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
                onmouseout="this.className='menuc'"><img src="img/menu_seta.gif" width="19" height="15" /><a href="relatorios/relatoriosIR.asp?ori=ede&opt=01&cod_cons=<%response.Write(Session("aluno_selecionado"))%>&dcl=EIR" class="menu_sublista">Informe para IR</a></td>
  </tr>
  <tr>  
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
                onmouseout="this.className='menuc'"><img src="img/menu_seta.gif" width="19" height="15" /><a href="relatorios/relatoriosIR.asp?ori=ede&opt=01&cod_cons=<%response.Write(Session("aluno_selecionado"))%>&dcl=EQA" class="menu_sublista">Quita&ccedil;&atilde;o Anual</a></td>
  </tr>    
  <%END IF%>
  <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#990000"><div align="center"><font class="menu_lista">Seguran&ccedil;a</font></div></td>
  </tr>
  <tr> 
...
<table width="170" style="BORDER-TOP: #a8adb0 1px solid; BORDER-RIGHT: #a8adb0 1px solid; BORDER-LEFT: #a8adb0 1px solid; BORDER-BOTTOM: #a8adb0 1px solid">
  ...
  <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#990000"><div align="center"><font class="menu_lista">Aproveitamento 
        Escolar</font></div></td>
  </tr>
  <!--  
  <tr> 
...
<!--   <tr>
 ...
 <tr> 
  ...
  <tr> 
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
                onmouseout="this.className='menuc'"><img src="../img/menu_seta.gif" width="19" height="15" /><a href="../agenda/provas/index.asp" class="menu_sublista">Reuni&otilde;es</a></td>
  </tr>
  <tr> 
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
                onmouseout="this.className='menuc'"><img src="../img/menu_seta.gif" width="19" height="15" /><a href="../agenda/eventos/index.asp" class="menu_sublista">Eventos 

...
case 08
	...
	ti = ""
case 09
	msg="Mensagem enviada para o e-mail cadastrado"
	tipo="o"
	lg = ""
	pas= ""
	ti = ""	
...
<form action="conecta.asp" method="post" name="login" id="login" autocomplete="OFF">
  ...
  <tr>
    <td><table width="801" height="535" border="0" align="center" cellpadding="0" cellspacing="0" background="img/login.png">
    <tr> 
            ...
            <tr> 
              ...
              <td width="392" height="298" valign="top"><table width="339" height="244" border="0" align="left" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td height="25"><table width="81%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="59%" align="right"><%if opt=999999 then%>
                            <input name="login" type="text" class="textbox" id="login" size="25" onKeyUp="GuardaLogin(this.value)">
                            <%else%>
                            <input name="login" type="text" class="textbox" id="login" value="<%=lg%>" size="25" onKeyUp="GuardaLogin(this.value)">
                            <%end if%></td>
                        </tr>
                      </table></td>
                      </tr>
                    <tr>
                      <td height="25"><div align="left">
                        <table width="81%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="39%" align="right"><img src="img/senha.png" width="39" height="15"></td>
                            <td width="61%" align="right"><input name="senha" type="password" class="textbox" id="senha" value="<%=pas%>" size="25" onKeyUp="GuardaSenha(this.value)"></td>
                          </tr>
                        </table>
                      </div></td>
                      </tr>
                    <tr>
                      <td height="15"><table width="81%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="51%" height="15" align="right" valign="top"><a href="envia_senha.asp"><img src="img/esqc_senha.png" width="102" height="15" border="0"></a></td>
                        </tr>
                      </table></td>
                      </tr>
                    <tr>
                      ...
                      <td height="25"><div align="left">
                        <table width="81%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td width="41%" align="right"><input name="texto_imagem" type="text" class="textbox" id="texto_imagem" value="<%=ti%>" size="15"></td>
                          </tr>
                        </table>
                      </div></td>
                      </tr>
                ...
                <tr>
                  <td height="82"><table width="205" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                  ...
                  <td height="18" valign="top"><div align="center">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="46%" height="15"><a href="default.asp?opt=999998"><img src="img/nv_cod.png" alt="" width="102" height="15" border="0"></a></td>
                        </tr>
                    </table>
                  </div></td>
                </tr>
                <tr>
                  <td height="29"><div align="center">
                    <input name="escola" type="hidden" id="escola" value="10">

<% matricula = request.querystring("opt") %>
<html>
<head>
...
<table width="776" border="0" height="100" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="131" height="394" valign="top" bgcolor="#6699CC"> 
...
%>
    ...
    <td width="643" rowspan="2" valign="top"> 
      <table width="635" border="0" cellspacing="8" cellpadding="0" height="101">
        <tr> 
          <td height="23"> <div align="left"> 
              <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><img src="../images/posicao_fin.gif" width="606" height="25"></strong></font></p>
            </div></td>
        </tr>
        <tr> 
          <td><table width="100%" border="0" cellspacing="0">
              <tr bgcolor="#EEF3F9"> 
                <td width="58" height="22"> <div align="right"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>NOME:</strong></font></div></td>
                <td colspan="9"> <div align="left"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
                    <%


Set CON = Server.CreateObject("ADODB.Connection") 
CAMINHO = "e:\home\bretanha\dados\Alunos.mdb"
ABRIR = "DBQ="& CAMINHO & ";Driver={Microsoft Access Driver (*.mdb)}"
CON.Open ABRIR
Set RS = Server.CreateObject("ADODB.Recordset")
CONEXAO = "SELECT * FROM Alunos WHERE CO_Matricula_Escola = " & matricula
RS.Open CONEXAO, CON

Set CONa = Server.CreateObject("ADODB.Connection") 
CAMINHOa = "e:\home\bretanha\dados\Alunos.mdb"
ABRIRa = "DBQ="& CAMINHOa & ";Driver={Microsoft Access Driver (*.mdb)}"
CONa.Open ABRIRa
Set RSa = Server.CreateObject("ADODB.Recordset")
CONEXAOa = "SELECT * FROM TB_Ano_Letivo"
RSa.Open CONEXAOa, CONa
				
Set CON1 = Server.CreateObject("ADODB.Connection") 
CAMINHO1 = "e:\home\bretanha\dados\Posicao.mdb"
ABRIR1 = "DBQ="& CAMINHO1 & ";Driver={Microsoft Access Driver (*.mdb)}"
CON1.Open ABRIR1
Set RS1 = Server.CreateObject("ADODB.Recordset")
CONEXAO1 = "SELECT * FROM Posicao WHERE CO_Matricula_Escola = " & matricula
RS1.Open CONEXAO1, CON1



response.write (RS("NO_Aluno"))
%>
                    </font></div>
                  <div align="right"></div>
              ...
              <tr valign="bottom"> 
                <td height="22"> <div align="right"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">UNIDADE:</font></div></td>
                <td height="22" colspan="7"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                  <%response.write (RS("NO_Sede"))%>
                  </font><font size="1" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font><font size="1" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font><font size="1" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font><font size="1" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font><font size="1" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;</font></td>
                <td height="22"> <div align="right"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">MATR&Iacute;CULA:</font></div></td>
                <td height="22"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                  <%response.write (RS("CO_Matricula_Escola"))%>
                  </font></td>
              </tr>
              <tr valign="bottom"> 
                <td width="58" height="22"> <div align="right"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">CURSO:</font></div></td>
                <td width="116" height="22"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><font size="1"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                    <%response.write (RS("NO_Grau"))%>
                    </font><font face="Verdana, Arial, Helvetica, sans-serif"></font></font></font></div></td>
                <td width="50" height="22"> <div align="right"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">S&Eacute;RIE:</font></div></td>
                <td width="53" height="22"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                    <%response.write (RS("NO_Serie"))%>
                    </font></div></td>
                <td width="46" height="22"> <div align="right"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">TURMA:</font></div></td>
                <td width="23" height="22"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                    <%response.write (RS("CO_Turma"))%>
                    </font></div></td>
                <td width="81" height="22"> <div align="right"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">N&ordm; 
                    CHAMADA: </font></div></td>
                <td width="22" height="22"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
                    <%response.write (RS("NU_Chamada"))%>
                    </font></div></td>
                <td width="78" height="22"> <div align="right"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">ANO 
                    LETIVO:</font></div></td>
                <td width="72" height="22"> <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
                    <%response.write (RSa("NU_Ano_Letivo"))%>
                    </font><font size="1"></font></font></div></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
          <td height="23"><table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#6699CC">
              <tr> 
                <td><table width="100%" border="1" align="center" cellspacing="2" bordercolor="#EEF3F9">
                    <tr> 
                      <td width="14%" bgcolor="#EEF3F9"> 
                        <div align="center"><font color="#000066" size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                          <strong>VENCIMENTO</strong></font></div></td>
                      <td width="18%" bgcolor="#EEF3F9"><div align="center"><font color="#000066" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>PARCELA 
                          DE ANUIDADE</strong></font></div>
                      <td width="24%" bgcolor="#EEF3F9"><div align="center"><font color="#000066" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>PARCELA 
                          PROMOCIONAL</strong></font></div>
                      <td width="28%" bgcolor="#EEF3F9"> 
                        <div align="center"><font color="#000066" size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                          <strong>VALOR DO PAGAMENTO</strong></font></div></td>
                      <td width="16%" bgcolor="#EEF3F9"> 
                        <div align="center"><font color="#000066" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>DATA 
                          DO PAGAMENTO</strong></font></div></td>
                    </tr>
                    <%
if RS1.Eof then 
%>
                    <p><font size="2" face="Arial, Helvetica, sans-serif"><b>Não 
                      há mensalidades a vencer até o momento.</b></font> 
                      <%
...
While Not RS1.EOF
%><% IF RS1("VA_Realizado") >= RS1("VA_Compromisso") then%>
                    <tr> 
                      <td width="12%" > <div align="center"> <font size="2" face="Arial, Helvetica, sans-serif"> 
                          <%= RS1("DA_Vencimento") %> </font></div></td>
                      <td> <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><%= RS1("NO_Lancamento") %></font></div></td>
                      <td width="17%"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><%= FormatCurrency(RS1("VA_Compromisso")) %></font></div></td>
                      <td width="16%"> <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"> 
                          <% IF RS1("VA_Realizado") <> 0  then%>
                          <%= FormatCurrency(RS1("VA_Realizado")) %> 
                          <% ELSE %>
                          &nbsp; 
                          <% END IF %>
                          </font></div></td>
                      <td width="21%"> <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"> 
                          <% IF RS1("VA_Realizado") <> 0  then%>
                          <%= RS1("DA_Realizado") %> 
                          <% ELSE %>
                          &nbsp; 
...
<% Else%>
<%IF RS1("NO_Lancamento") = "Mensalidade" then%>
                    <tr bgcolor="#EEF3F9"> 
                      <td width="12%"> <div align="center"> 
                          <font size="2" face="Arial, Helvetica, sans-serif"> 
                      <a href="#" onClick="MM_openBrWindow('bloqueto.asp?codigo=<%=  RS ("CO_Matricula_Escola") %>&amp;opt=<%= RS1 ("Mes") %>','','status=yes,menubar=yes,scrollbars=yes,width=710,height=500,top=0,left=0')"><%= RS1 ("DA_Vencimento") %></a> </font></div></td>
                      <td width="34%"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><%= RS1("NO_Lancamento") %></font></div></td>
                      <td width="17%"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><%= FormatCurrency(RS1("VA_Compromisso")) %></font></div></td>
                      <td width="16%"> <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"> 
                          <% IF RS1("VA_Realizado") = RS1("VA_Compromisso") then%>
                          <%= FormatCurrency(RS1("VA_Realizado")) %> 
...
<table width="761" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td bgcolor="#CC0000"> <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF">Escola 
        ...
        Informa&ccedil;&atilde;o e Tecnologi</font><font size="1" face="Trebuchet MS" color="#FFFFFF">a</font></div></td>
  </tr>
</table>
</body>
</html>

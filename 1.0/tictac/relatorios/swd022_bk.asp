...
if co_usu_reg="" or isnull(co_usu_reg) then
	...
	Table(1, 7).AddText "<b>Valor:</b>", "size=9;html=true", Font 
...
'================================================================================================================			
	...
	Notas_Tit(1, 4).AddText "<div align=""center""><b>Valor Unit&aacute;rio</div>", "size=9;alignment=center; indenty=2;html=true", Font 
	...
	if RS.EOF	then
		...
		while not RS.EOF
			...
			Notas_Tit(linha, 4).AddText "<div align=""center"">"&formatcurrency(quantidade_item,2)&"</div>", param_materias																						

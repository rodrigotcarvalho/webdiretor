...
<%
	...
	CAMINHOn = CAMINHO_na
	Call boletim_avaliacao(CAMINHO_al,CAMINHOn,unidade,curso,etapa,turma,co_materia,periodo_check,ano_letivo,cod,co_usr,"A","WFI","n","n","n",0)
	else
		if nota="TB_NOTA_B" then
		CAMINHOn = CAMINHO_nb
		Call boletim_avaliacao(CAMINHO_al,CAMINHOn,unidade,curso,etapa,turma,co_materia,periodo_check,ano_letivo,cod,co_usr,"B","WFI","n","n","n",0)
		else
			if nota ="TB_NOTA_C" then
			CAMINHOn = CAMINHO_nc
			Call boletim_avaliacao(CAMINHO_al,CAMINHOn,unidade,curso,etapa,turma,co_materia,periodo_check,ano_letivo,cod,co_usr,"C","WFI","n","n","n",0)
			else
			response.Write("ERRO")
			End if
		end if

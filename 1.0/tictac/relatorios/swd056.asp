...
for i=0 to ubound(conjunto_dados)	
	...
	'CABEÇALHO==========================================================================================		
		   ...
		   Page.Canvas.DrawImage Logo, Param_Logo_Gde
			...
			Set param_table1 = Pdf.CreateParam("width="&area_utilizavel&"; height=40; rows=3; cols=3; border=0; cellborder=0; cellspacing=0;")
			...
			Table(3, 1).AddText "<div align=""right""><b>Legenda:</b> Freq(%) - Frequ&ecirc;ncia que o aluno obteve no ano   /     RF - Resultado Final    /     APR - Aprovado   /   REP - Reprovado   /  TRF  - Transferido   /  DES  -  Desistente</div>", "size=8;html=true", Font	
...
'					else
					if isnumeric(media) then
						conceito=formatnumber(media,parametros_gerais("decimais_media"))	
					else
						conceito=media
					end if				
'					end if						

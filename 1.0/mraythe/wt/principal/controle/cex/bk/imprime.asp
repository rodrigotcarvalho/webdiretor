...
> 
    ...
    <!--      <td width="125" align="right" class="tabela" 
> 
           VALOR A PAGAR&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>-->
		   
                  <td width="125" align="center" class="tabela"> LINHA 1</td>
                  <td width="125" align="center" class="tabela"> LINHA 2</td>	
				  <td width="125" align="center" class="tabela"> LINHA 3</td>
...
%>
                <tr> 
                  <td colspan="8" class="tabela"> <div align="center"><br>
                      <br>
                      <br>
                      <br>
                      <br>
...
> 
         ...
         <!--  <td width="125" align="right" class="<%response.Write(cor)%>" 
> 
            <% 
          ...
          <td width="167" align="right" class="<%response.Write(cor)%>" 
> 

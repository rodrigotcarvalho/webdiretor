...
'if notaFIL="TB_NOTA_A" or notaFIL="TB_NOTA_B" or notaFIL="TB_NOTA_C" then			
	%>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td width="320" rowspan="2" class="tabelaTit"> 
                        <div align="left"><strong>Disciplina</strong></div></td>
                      <td colspan="12" class="tabelaTit"> <div align="center">Aproveitamento</div></td>
                      <td colspan="4" class="tabelaTit"><div align="center">Freq&uuml;&ecirc;ncia 
                          (Faltas)</div></td>
                    </tr>
                    <tr> 
                      <td width="68" class="tabelaTit"> <div align="center">BIM 
                          1</div></td>
                      <td width="68" class="tabelaTit"> <div align="center">BIM 
                          2</div></td>
                      <td width="68" class="tabelaTit"><div align="center">M&eacute;dia 
                          Sem 1</div></td>
                      <td width="68" class="tabelaTit"><div align="center">Recup 
                          Sem</div></td>
                      <td width="68" class="tabelaTit"><div align="center">M&eacute;dia 
                          Sem 2</div></td>
                      <td width="68" class="tabelaTit"> <div align="center">BIM 

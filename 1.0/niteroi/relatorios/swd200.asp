...
if ubound(alunos_encontrados)=-1 then
	...
	For i=0 to ubound(alunos_encontrados)	
		...
		txt_curso= "do "&no_etapa&"&nbsp;"&co_concordancia_curso&"&nbsp;"&no_curso
...
'CABECALHO==========================================================================================		
		...
		unidade = unidade*1
		if unidade = 1 then
			largura_logo_gde=formatnumber(Logo1.Width*0.3,0)
			altura_logo_gde=formatnumber(Logo1.Height*0.3,0)
			...
			largura_logo_gde=formatnumber(Logo2.Width*0.3,0)
			altura_logo_gde=formatnumber(Logo2.Height*0.3,0)
			area_utilizavel=Page.Width-(margem*2)
			Param_Logo_Gde("x") = formatnumber(area_utilizavel/2,0)
			Param_Logo_Gde("y") = Page.Height - altura_logo_gde -margem
			Param_Logo_Gde("ScaleX") = 0.3

...
if tb_nota="TB_NOTA_A" then
	...
	<table width="<%response.Write(width_tabela)%>" border="0" align="center" cellpadding="0" cellspacing="0">
	  <tr>
		...
		<td colspan="4" class="<%response.Write(class_tit)%>"><div align="center">Aproveitamento</div></td>
	...
	if tipo_boletim="MRD" or tipo_boletim="MRDI" then
		...
		for na=0 to ubound(n_alunos)
			...
			For a=0 to ubound(co_materia)		
				...
				teste20 = isnumeric(notas_disciplinas(20))											
		%>
		  <tr>
			...
			if teste0=false then
				...
				if showt1="s" then
					...
					ntazl=ntazl*1
					ntvml=ntvml*1
					if notas_disciplinas(0)>ntazl then	
						response.Write(formatnumber(notas_disciplinas(0),1))
					elseif notas_disciplinas(0)>ntvml then	
						response.Write("<font color="&cor_nota_azl&">"&formatnumber(notas_disciplinas(0),1)&"</font>")					
					else
						response.Write("<font color="&cor_nota_vml&">"&formatnumber(notas_disciplinas(0),1)&"</font>")	
					end if	
				end if	
			end if	
			...
			if teste1=false then
				...
				if showt2="s" then
					...
					ntazl=ntazl*1
					ntvml=ntvml*1
					if notas_disciplinas(1)>ntazl then	
						response.Write(formatnumber(notas_disciplinas(1),1))
					elseif notas_disciplinas(1)>ntvml then	
						response.Write("<font color="&cor_nota_azl&">"&formatnumber(notas_disciplinas(1),1)&"</font>")					
					else
						response.Write("<font color="&cor_nota_vml&">"&formatnumber(notas_disciplinas(1),1)&"</font>")	
					end if	
				end if	
			end if		
			%></div></td>
			...
			if teste6=false then
				...
				if showt3="s" then
					...
					ntazl=ntazl*1
					ntvml=ntvml*1
					if notas_disciplinas(6)>ntazl then	
						response.Write(formatnumber(notas_disciplinas(6),1))
					elseif notas_disciplinas(6)>ntvml then	
						response.Write("<font color="&cor_nota_azl&">"&formatnumber(notas_disciplinas(6),1)&"</font>")					
					else
						response.Write("<font color="&cor_nota_vml&">"&formatnumber(notas_disciplinas(6),1)&"</font>")	
					end if	
				end if	
			end if		
			...
			if teste7=false then
				...
				if showt4="s" then
					...
					ntazl=ntazl*1
					ntvml=ntvml*1
					if notas_disciplinas(7)>ntazl then	
						response.Write(formatnumber(notas_disciplinas(7),1))
					elseif notas_disciplinas(7)>ntvml then	
						response.Write("<font color="&cor_nota_azl&">"&formatnumber(notas_disciplinas(7),1)&"</font>")					
					else
						response.Write("<font color="&cor_nota_vml&">"&formatnumber(notas_disciplinas(7),1)&"</font>")	
					end if	
				end if	
			end if		
			...
			if teste17=false then
				...
				if showt1="s" and showt2="s" and showt3="s" and showt4="s" then
					...
					ntazl=ntazl*1
					ntvml=ntvml*1
					if notas_disciplinas(17)>ntazl then	
						response.Write(formatnumber(notas_disciplinas(17),1))
					elseif notas_disciplinas(17)>ntvml then	
						response.Write("<font color="&cor_nota_azl&">"&formatnumber(notas_disciplinas(17),1)&"</font>")					
					else
						response.Write("<font color="&cor_nota_vml&">"&formatnumber(notas_disciplinas(17),1)&"</font>")	
					end if	
				end if	
			end if		
			...
			if teste18=false then
				...
				if showt5="s" then
					...
					ntazl=ntazl*1
					ntvml=ntvml*1
					if notas_disciplinas(18)>ntazl then	
						response.Write(formatnumber(notas_disciplinas(18),1))
					elseif notas_disciplinas(18)>ntvml then	
						response.Write("<font color="&cor_nota_azl&">"&formatnumber(notas_disciplinas(18),1)&"</font>")					
					else
						response.Write("<font color="&cor_nota_vml&">"&formatnumber(notas_disciplinas(18),1)&"</font>")	
					end if	
				end if	
			end if		
			...
			if teste19=false then
				...
				if showt1="s" and showt2="s" and showt3="s" and showt4="s" and showt5="s" then
					...
					ntazl=ntazl*1
					ntvml=ntvml*1
					if notas_disciplinas(19)>ntazl then	
						response.Write(formatnumber(notas_disciplinas(19),1))
					elseif notas_disciplinas(19)>ntvml then	
						response.Write("<font color="&cor_nota_azl&">"&formatnumber(notas_disciplinas(19),1)&"</font>")					
					else
						response.Write("<font color="&cor_nota_vml&">"&formatnumber(notas_disciplinas(19),1)&"</font>")	
					end if	
				end if	
			end if		
			...
			if teste20=false then
				...
				if showt3="s" and showt4="s" then
					notas_disciplinas(20)=notas_disciplinas(20)*1	
					ntazl=ntazl*1
					ntvml=ntvml*1
					if notas_disciplinas(20)>ntazl then	
						response.Write(formatnumber(notas_disciplinas(20),1))
					elseif notas_disciplinas(20)>ntvml then	
						response.Write("<font color="&cor_nota_azl&">"&formatnumber(notas_disciplinas(20),1)&"</font>")					
					else
						response.Write("<font color="&cor_nota_vml&">"&formatnumber(notas_disciplinas(20),1)&"</font>")	
					end if		
				end if	
			end if		
		...
		For a=0 to ubound(co_materia)
			...
			posicao_materia=posicao_materia_tabela(co_materia(a), unidade, curso, co_etapa, turma)	
	...
	<table width="<%response.Write(width_tabela)%>" border="0" align="center" cellpadding="0" cellspacing="0">
	  <tr>
      	<%if tipo_boletim="MRD" or tipo_boletim="MRDI" then%>
   		 ...
   		 <%end if%>
		<td width="<%response.Write(width_disciplina)%>" rowspan="3" class="<%response.Write(class_tit)%>"><%response.Write(nome_foco)%></td>
		<td colspan="12" class="<%response.Write(class_tit)%>"><div align="center">Aproveitamento</div></td>
		<td colspan="4" class="<%response.Write(class_tit)%>"><div align="center">Resultado</div></td>
		<td colspan="4" class="<%response.Write(class_tit)%>"><div align="center">Freq&uuml;&ecirc;ncia (faltas)</div></td>
	  </tr>
	  <tr>
	  ...
	  <tr>
	    ...
	    <td width="<%response.Write(width_else)%>" class="<%response.Write(class_subtit)%>"><div align="center">SEM2</div></td>
	    <td width="<%response.Write(width_else)%>" class="<%response.Write(class_subtit)%>"><div align="center">Par.</div></div></td>
		<td width="<%response.Write(width_else)%>" class="<%response.Write(class_subtit)%>"><div align="center">ANUAL</div></td>
		<td width="<%response.Write(width_else)%>" class="<%response.Write(class_subtit)%>"><div align="center">FINAL</div></td>
		<td width="<%response.Write(width_else)%>" class="<%response.Write(class_subtit)%>"><div align="center">FINAL</div></td>
	  </tr>
...
'					teste19 = isnumeric(notas_disciplinas(19))							
			...
			if teste2=false then
				...
				if showt1="s" and showt2="s" then
					...
					ntazl=ntazl*1
					ntvml=ntvml*1
					if notas_disciplinas(2)>ntazl then	
						response.Write(formatnumber(notas_disciplinas(2),1))
					elseif notas_disciplinas(2)>ntvml then	
						response.Write("<font color="&cor_nota_azl&">"&formatnumber(notas_disciplinas(2),1)&"</font>")					
					else
						response.Write("<font color="&cor_nota_vml&">"&formatnumber(notas_disciplinas(2),1)&"</font>")	
					end if
				end if	
			end if	
			...
			if teste3=false then
				...
				if showt1="s" and showt2="s" then
					...
					ntazl=ntazl*1
					ntvml=ntvml*1
					if notas_disciplinas(3)>ntazl then	
						response.Write(formatnumber(notas_disciplinas(3),1))
					elseif notas_disciplinas(3)>ntvml then	
						response.Write("<font color="&cor_nota_azl&">"&formatnumber(notas_disciplinas(3),1)&"</font>")					
					else
						response.Write("<font color="&cor_nota_vml&">"&formatnumber(notas_disciplinas(3),1)&"</font>")	
					end if
				end if	
			end if		
			...
			if teste4=false then
				...
				if showt1="s" then
					...
					ntazl=ntazl*1
					ntvml=ntvml*1
					if notas_disciplinas(4)>ntazl then	
						response.Write(formatnumber(notas_disciplinas(4),1))
					elseif notas_disciplinas(4)>ntvml then	
						response.Write("<font color="&cor_nota_azl&">"&formatnumber(notas_disciplinas(4),1)&"</font>")					
					else
						response.Write("<font color="&cor_nota_vml&">"&formatnumber(notas_disciplinas(4),1)&"</font>")	
					end if
				end if	
			end if		
			...
			if teste5=false then
				...
				if showt2="s" then
					...
					ntazl=ntazl*1
					ntvml=ntvml*1
					if notas_disciplinas(5)>ntazl then	
						response.Write(formatnumber(notas_disciplinas(5),1))
					elseif notas_disciplinas(5)>ntvml then	
						response.Write("<font color="&cor_nota_azl&">"&formatnumber(notas_disciplinas(5),1)&"</font>")					
					else
						response.Write("<font color="&cor_nota_vml&">"&formatnumber(notas_disciplinas(5),1)&"</font>")	
					end if
				end if	
			end if		
			...
			if teste11=false then
				if showt4="s" then
					response.Write(notas_disciplinas(11))
				else
					response.Write("&nbsp;")
				end if		
			else	
				if showt4="s" then
					notas_disciplinas(11)=notas_disciplinas(11)*1	
					ntazl=ntazl*1
					ntvml=ntvml*1
					if notas_disciplinas(11)>ntazl then	
						response.Write(formatnumber(notas_disciplinas(11),1))
					elseif notas_disciplinas(11)>ntvml then	
						response.Write("<font color="&cor_nota_azl&">"&formatnumber(notas_disciplinas(11),1)&"</font>")					
					else
						response.Write("<font color="&cor_nota_vml&">"&formatnumber(notas_disciplinas(11),1)&"</font>")	
					end if	
				end if	
			end if		
			...
			if teste8=false then
				if showt4="s" then
					response.Write(notas_disciplinas(8))
				else
					response.Write("&nbsp;")
				end if		
			else	
				if showt4="s" then
					notas_disciplinas(8)=notas_disciplinas(8)*1	
					ntazl=ntazl*1
					ntvml=ntvml*1
					if notas_disciplinas(8)>ntazl then	
						response.Write(formatnumber(notas_disciplinas(8),1))
					elseif notas_disciplinas(8)>ntvml then	
						response.Write("<font color="&cor_nota_azl&">"&formatnumber(notas_disciplinas(8),1)&"</font>")					
					else
						response.Write("<font color="&cor_nota_vml&">"&formatnumber(notas_disciplinas(8),1)&"</font>")	
					end if	
				end if	
			end if		
			...
			if teste9=false then
				if showt3="s" and showt4="s" then
					response.Write(notas_disciplinas(9))
				else
					response.Write("&nbsp;")
				end if		
			else	
				if showt3="s" and showt4="s" then
					notas_disciplinas(9)=notas_disciplinas(9)*1	
					ntazl=ntazl*1
					ntvml=ntvml*1
					if notas_disciplinas(9)>ntazl then	
						response.Write(formatnumber(notas_disciplinas(9),1))
					elseif notas_disciplinas(9)>ntvml then	
						response.Write("<font color="&cor_nota_azl&">"&formatnumber(notas_disciplinas(9),1)&"</font>")					
					else
						response.Write("<font color="&cor_nota_vml&">"&formatnumber(notas_disciplinas(9),1)&"</font>")	
					end if	
				end if	
			end if		
			...
			if teste10=false then
				if showt3="s" then
					response.Write(notas_disciplinas(10))
				else
					response.Write("&nbsp;")
				end if		
			else	
				if showt3="s" then
					notas_disciplinas(10)=notas_disciplinas(10)*1	
					ntazl=ntazl*1
					ntvml=ntvml*1
					if notas_disciplinas(10)>ntazl then	
						response.Write(formatnumber(notas_disciplinas(10),1))
					elseif notas_disciplinas(10)>ntvml then	
						response.Write("<font color="&cor_nota_azl&">"&formatnumber(notas_disciplinas(10),1)&"</font>")					
					else
						response.Write("<font color="&cor_nota_vml&">"&formatnumber(notas_disciplinas(10),1)&"</font>")	
					end if	
				end if	
			end if		

...
CAMINHOn = CAMINHO_na
Call imp_mapa_notas(CAMINHOa,CAMINHOn,unidade,curso,co_etapa,turma,co_materia,periodo,ano_letivo,co_usr,1,0,0)
elseif nota="TB_NOTA_B" then
	CAMINHOn = CAMINHO_nb
	Call imp_mapa_notas(CAMINHOa,CAMINHOn,unidade,curso,co_etapa,turma,co_materia,periodo,ano_letivo,co_usr,2,0,0)
elseif nota ="TB_NOTA_C" then
		CAMINHOn = CAMINHO_nc
		Call imp_mapa_notas(CAMINHOa,CAMINHOn,unidade,curso,co_etapa,turma,co_materia,periodo,ano_letivo,co_usr,3,0,0)
elseif nota ="TB_NOTA_E" then
		CAMINHOn = CAMINHO_ne
		Call imp_mapa_notas(CAMINHOa,CAMINHOn,unidade,curso,co_etapa,turma,co_materia,periodo,ano_letivo,co_usr,5,0,0)		
elseif nota ="TB_NOTA_F" then
		CAMINHOn = CAMINHO_nf
		Call imp_mapa_notas(CAMINHOa,CAMINHOn,unidade,curso,co_etapa,turma,co_materia,periodo,ano_letivo,co_usr,6,0,0)		
elseif nota ="TB_NOTA_K" then
		CAMINHOn = CAMINHO_nk
		Call imp_mapa_notas(CAMINHOa,CAMINHOn,unidade,curso,co_etapa,turma,co_materia,periodo,ano_letivo,co_usr,7,0,0)			
elseif nota ="TB_NOTA_L" then
		CAMINHOn = CAMINHO_nl
		Call imp_mapa_notas(CAMINHOa,CAMINHOn,unidade,curso,co_etapa,turma,co_materia,periodo,ano_letivo,co_usr,8,0,0)							
elseif nota ="TB_NOTA_M" then
		CAMINHOn = CAMINHO_nm
		Call imp_mapa_notas(CAMINHOa,CAMINHOn,unidade,curso,co_etapa,turma,co_materia,periodo,ano_letivo,co_usr,9,0,0)						
else
		response.Write("ERRO")
End if

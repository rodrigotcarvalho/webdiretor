				...
				coluna=0	 
				 for n= 0 to ubound(nome_variaveis)
					...
					if (valor="" or isnull(valor)) and subopcao="imp" then
						...
						if nome_variaveis(n)="VA_Sapr1" or nome_variaveis(n)="VA_Sapr2" or nome_variaveis(n)="VA_Sapr3" or nome_variaveis(n)="VA_Sapr_EC" or nome_variaveis(n)="media_teste" or nome_variaveis(n)="media_prova" or nome_variaveis(n)="media1" or nome_variaveis(n)="media2" or nome_variaveis(n)="media3" or situac<>"C" then
							coluna=coluna	
							conteudo=valor

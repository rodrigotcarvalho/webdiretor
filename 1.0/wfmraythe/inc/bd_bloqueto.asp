...
min = DatePart("n", now) 
    ...
    codigo_banco = "341-7"	
	nome_banco_msg = "Banco Ita&uacute;"
	nome_banco_tit = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
	...
	Set Itau = Doc.OpenImage( Server.MapPath( addPastas&"../img/logo_itau.png") )	
...
'			Table(2, 8).AddText ano_letivo, "size=9;alignment=right", Font 
			...
			Table(7, 1).AddText "", "size=5; expand=true", Font 						
...
'Cria tabelas com informações de cobrança---------------------------------------------------------------------	
			...
			var_instrucoes="<font style=""font-size:6pt;"">Instru&ccedil;&otilde;es (Todas as informa&ccedil;&otilde;es deste bloqueto s&atilde;o de exclusiva responsabilidade do benefici&aacute;rio)</font><font style=""font-size:3pt;""><BR>&nbsp;<br></FONT><font style=""font-size:7pt;"">"&msg01&"<BR>"&msg02
	...
	'			var_instrucoes=	var_instrucoes&"Servi&ccedil;os Adicionais poder&atilde;o ser cobrados a parte conforme prevista cláusula V par&aacute;grafo primeiro do contrato.<BR>"&TEXTO_UCASE&"</font>" 
				'var_instrucoes=	var_instrucoes&"<BR>&nbsp;<BR>Ap&oacute;s o vencimento emita a 2&ordf; via corrigida pelo site do Ita&uacute;.	<br>Este boleto perder&aacute; a validade ap&oacute;s 59 dias do vencimento. O pagador dever&aacute; procurar o col&eacute;gio.</font>"	
				var_instrucoes=	var_instrucoes&"<BR>&nbsp;<BR>Este boleto perder&aacute; a validade ap&oacute;s 59 dias do vencimento. O pagador dever&aacute; procurar o col&eacute;gio.</font>"	
				...
				Table(10, 1).RowSpan = 2				
				        ...
				        local_de_pagamento = "AT&Eacute; O VENCIMENTO, PAGUE EM QUALQUER BANCO OU CORRESPONDENTE N&Atilde;O BANC&Aacute;RIO. APÓS O VENCIMENTO, ACESSE ITAU.COM.BR/BOLETOS E PAGUE EM QUALQUER BANCO OU CORRESPONDENTE N&Atilde;O BANC&Aacute;RIO."			
...
'Fim da tabela de informações de cobrança--------------------------------------------------------------------		
			...
			Param_Itau("y") = y_texto_4-altura_Itau+4

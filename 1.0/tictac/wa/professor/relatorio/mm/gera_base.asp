...
<%
	...
	if RS.eof or opt="rgnrt" then
		...
		cria_dados=grava_ACC(unidade, curso, co_etapa, turma, periodo, acumulado, qto_falta, ntazl, ntvml, val_m3, peso_m2_m1, peso_m2_m2, peso_m3_m1, peso_m3_m2, peso_m3_m3)

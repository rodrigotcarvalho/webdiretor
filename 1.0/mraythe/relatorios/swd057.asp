...
'				end if 
			Loop
	y_texto = margem*6		
	SET Param = Pdf.CreateParam("x="&x_texto&";y="&y_texto&"; height=80; width="&width_texto&"; alignment=center; size=11; color=#000000; html=true")
						
Text = "E, para constar, eu ________________________________________________________ Secretario(a), lavrei o presente"
Text = Text&"<BR>Livro de Registro de Matr&iacute;culas que foi assinada pelo(a) Diretor(a) do Estabelecimento.<BR>&nbsp;<BR>&nbsp;<BR>&nbsp;-----------------------------------------------------------------------------<BR>Diretor(a)"

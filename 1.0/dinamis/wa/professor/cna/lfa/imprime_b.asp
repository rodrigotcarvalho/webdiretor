...
%> 
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td class="tabelaTit"><div align="center">TRI1</div></td>
    <td class="tabelaTit"><div align="center">TRI2</div></td>
    <td class="tabelaTit"><div align="center">&nbsp;TRI3</div></td>
    <td class="tabelaTit"> ECE</td>
    </tr>
  <%
check = 2
nu_chamada_ckq = 0
...
if (nu_chamada_ckq <>nu_chamada - 1) then
	...
	teste_nu_chamada=teste_nu_chamada-1
		...
		%>
  <tr> 
    <td width="20" height="40" class="tabela_fundo_linha_falta"> <input name="nu_chamada_<%=nu_chamada_falta %>" class="borda_edit" type="hidden" value="<%=nu_chamada%>"> 
      <input name="nu_matricula_<%=nu_chamada_falta %>" type="hidden" value="falta"> 
    </td>
    <td width="780" class="tabela_fundo_linha_falta">&nbsp;</td>
    <td width="50" class="tabela_fundo_linha_falta">
<div align="center">&nbsp; 

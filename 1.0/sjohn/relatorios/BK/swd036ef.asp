...
IF NOT RS3.EOF then
	...
	tit = "<font style=""font-size:12pt;""><b>"&cabec_1&"</b></font><br><font style=""font-size:8pt;"">	"&cabec_2&"<br>"&cabec_3&"<br>"&cabec_4&"<br>"&cabec_5&"<br>"&cabec_6&"<br>"&cabec_7&"<br>"&cabec_8&"<br><font style=""font-size:18pt;"">Hist&oacute;rico Escolar - Ensino Fundamental</font>"																				
end if
...
if tipo = "EFA" then
	Notas_Tit(1, 2).AddText "<div align=""center""><B>S&eacute;rie / Ano</B></div>", "size=7;indenty=2; html=true", Font 	
else

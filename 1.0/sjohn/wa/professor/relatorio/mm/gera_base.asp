...
<%
	...
	if RS.eof or opt="rgnrt" then
		msg="rgnrt"
            ...
            if isnull(qto_falta) or qto_falta="" then
                 qto_falta="n"
            end if

                   ' response.write(unidade&", "&curso&", "&co_etapa&", "&turma&", "&periodo&", "&acumulado&", "&qto_falta&", "&ntazl&", "&ntvml&", 999, "&peso_m2_m1&", "&peso_m2_m2&", "&peso_m3_m1&", "&peso_m3_m2&", "&peso_m3_m3)

...
response.Redirect("index.asp?ori=02&opt=ok&nvg="&nvg&"&cod_cons="& cod_cons &"&co_usr_prof="&co_usr_prof&"")
...
sql_atualiza = "UPDATE TB_Professor SET NO_Professor = '"&nome&"', NO_Apelido_Professor = '"&apelido&"', IN_Sexo = '"&sexo&"', DA_Nascimento = #"&nasce&"#, NO_Logradouro = '"&rua&"', NU_Logradouro = "&numero&", TX_Complemento_Logradouro = '"&complemento&"', CO_Bairro = "&bairro&", CO_Municipio = "&ciddom&", CO_Pais = "&pais&", SG_UF = '"&estadodom&"', CO_CEP = '"&cep&"', NUS_Telefones = '"&telefones&"', SG_Estado_Natural = '"&estadonat&"', CO_Nacionalidade = "&nacionalidade&", CO_Municipio_Natural = "&cidadenat&", TX_EMail = '"&email&"', IN_Ativo_Escola ="&situacao_professor&", CO_Usuario= "&co_usr_prof&" WHERE CO_Professor = "& cod_cons 

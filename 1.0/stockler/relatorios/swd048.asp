...
'================================================================================================================			
			...
			altura_medias=40
			Set param_table2 = Pdf.CreateParam("width=533; height="&altura_medias&"; rows=3; cols=16; border=1; cellborder=0.1; cellspacing=0;")
			...
			Notas_Tit(1, 16).AddText "<div align=""center""><b>Carga</b></div>", "size=9;alignment=center;indenty=13;html=true", Font 			
...
'				End With 				
			...
			CON_N.Open ABRIRn
					...
					SQL_N = "Select * from "&tb_nota&" WHERE CO_Matricula = "& cod_cons
	...
	'		response.Write(cod_cons&"-"&soma_faltas&"<BR>")
			...
			if frequencia<100 then
				...
				Legenda(1, 1).Colspan= 9	
				Legenda(1, 10).RowSpan = 2					
				Legenda(1, 1).AddText "<b>Legenda:</b> A - Excelente   B - Bom   C - Suficiente   D - Insuficiente   E - Deficiente", "size=8;html=true", Font 
...
'if cod_cons=1417 then
'					response.Write(resultado_final_aluno&" -r")
'					response.end()
'end if

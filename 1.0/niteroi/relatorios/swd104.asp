...
'response.end()
			...
			linha=2
			'resultados=Calc_Med_An_Fin(unidade, curso, co_etapa, turma, vetor_matriculas, vetor_materia, caminho_nota, tb_nota, 5, 4, 5, "recuperacao", 0)		
			...
			for a=0 to ubound(alunos_encontrados)	
				...
				for n=0 to ubound(co_materia_exibe)	
					'response.Write(unidade&"-"&curso&"-"&co_etapa&"-"&turma&"-"&dados_alunos(0)&"-"&co_materia_exibe(n)&"-"&caminho_nota&"-"&tb_nota&"-3-"&tipo_calculo&"-"&outro)				
					...
					if	resultados_verifica(1)= "APR" or resultados_verifica(1)= "Apr" or resultados_verifica(1)= "&nbsp;"	then					
						...
						resultados = Calc_Seg_Media (unidade, curso, co_etapa, turma, dados_alunos(0), co_materia_exibe(n), caminho_nota, tb_nota, prd_seg_media, tipo_calculo, outro)	
					...
					'teste_m=co_materia_exibe(n)					
				next
				'teste_a=dados_alunos(0)
			next
'response.Write(unidade&"-"&curso&"-"&co_etapa&"-"&turma&"-"&teste_a&"-"&teste_m&"-"&caminho_nota&"-"&tb_nota&"-3-"&tipo_calculo&"-"&outro)				
'resultados = Calc_Prim_Media (unidade, curso, co_etapa, turma, teste_a, teste_m, caminho_nota, tb_nota,3, tipo_calculo, outro)	
'response.Write(resultados&"<BR>")				
'response.End()
			limite=0
			Do While True

...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="tb_caminho">
        <tr>            
...
%></td>
        ...
        <tr> 
          ...
          <form name="form1" method="post" action="faleconosco.asp?opt=mail" onSubmit="return checksubmit()">
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr> 
                  <td width="333" height="20"> <div align="right"><font class="form_dado_texto"> Digite 
                      seu email:</font></div></td>
                  <td width="661" height="20"><font class="form_dado_texto"> 
                ...
                <tr> 
                  <td height="20"> <div align="right"><font class="form_dado_texto"> Tipo 
                      de email:</font></div></td>
                  <td height="20"><select name="tipo" class="select_style" id="tipo">
                ...
                <tr> 
                  <td height="20"> <div align="right"><font class="form_dado_texto"> Assunto:</font></div></td>
                  <td height="20"><input name="assunto" type="text" class="textInput" id="assunto" size="75"></td>
                </tr>
                <tr> 
                  <td height="20" valign="top"> <div align="right"><font class="form_dado_texto"> Mensagem:</font></div></td>
                  <td height="20"><textarea name="mensagem" cols="75" rows="15" wrap="VIRTUAL" class="textInput" id="mensagem"></textarea></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  <td height="20" colspan="2"><table width="100%" border="0" align="center" cellspacing="0">
                      <tr> 

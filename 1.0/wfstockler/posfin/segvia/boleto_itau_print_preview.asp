...
<br />			<font class="cn">
	...
	<TR>
		<TD colspan="2" align=right><FONT class=ct>Autentica&ccedil;&atilde;o Mec&acirc;nica</FONT><BR><BR><BR></TD>
		</TR>
</TABLE>
...
<BR>
<img src="../../img/boleto_itau/corte.gif" border=0 width="660">
<BR>
<FONT class=cn>Recortar na linha pontilhada abaixo do código de barras</FONT>
<%next%>
        </DIV>
    </DIV>
...
<table width='640' cellspacing=5 cellpadding=0 border=0>
	<tr>
			<form name='forma'>
						<td align="center"><input type=button value=' Imprimir Boleto' onClick='DoPrintFromPreview()' name='button'></td>
			</form>
	</tr>
</table>

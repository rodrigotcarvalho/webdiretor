	...
	While not RS1.EOF
		...
		While not RS2.EOF
			etapa = RS2("CO_Etapa")	
				...
				RS.open "TB_Autoriza_WF", CON_WF, 2, 2 'which table do you want open
				RS.addnew
			...
			for per= 2 to 14
				...
				Set RS = Server.CreateObject("ADODB.Recordset")
				sql= "UPDATE TB_Autoriza_WF SET "&wrk_variavel &"='B' WHERE NU_Unidade="&unidade&" AND CO_Curso='"&curso&"' AND CO_Etapa='"&etapa&"'"

...
'response.Write(gera_relatorio_aluno&"<BR>")
		...
		'CABEÇALHO==========================================================================================		
					...
					y_texto=formatnumber(Page.Height - altura_logo_gde,0)
					...
					SET Param = Pdf.CreateParam("x="&x_texto&";y="&y_texto&"; height=100; width="&width_texto&"; alignment=center; color=#000000; html=true")

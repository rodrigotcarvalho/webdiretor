...
'periodo_check= dados_opt(1)
	...
	CON1.Open ABRIR1
		...
		SQLal = "SELECT * FROM TB_Alunos WHERE CO_Matricula ="& cod_cons
...
if RS_tb.eof then
%>
                    <div align="center"><font class="style1"> <%response.Write("<br><br><br><br><br>N&atilde;o existe Boletim para este aluno!")%></div>
                      </div>
                    <%
else
...
<div align="center">    <% if unidade = 1 then
	logo = "logo_niteroi_preto.gif"
else
	logo = "logo_arariboia_preto.gif"
end if%>    
        <img src="../../img/<%response.write(logo)%>"> </div></td>
...
tb_nota=RS_tb("TP_Nota")
	...
	call boletim_escolar (unidade,curso,etapa,turma,CAMINHOn,tb_nota,cod_cons,"WFI")	
	%>
        <%
end if					
					%>

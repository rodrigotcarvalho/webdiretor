...
'					SESSION("ano_letivo") = ano_form
					for cmv=0 to ubound(co_materia_verifica)
						...
						compara_m3 = parametros_gerais_novo(unidade_t, curso_t, co_etapa_t, turma, co_materia_res(0),"compara_m3",0)					
						aproxima_m3 = parametros_gerais_novo(unidade_t, curso_t, co_etapa_t, turma, co_materia_res(0),"aproxima_m3",0)											
...
'				end if												
				...
				dados_gravados = insereTbAnoHistorico(co_matricula, ano_form, seq_historico, curso_t, co_etapa_t, "Colégio Maria Raythe", "Brasil", no_munic, co_uf, nu_aprovado, NULL, ano_form,  "A", NULL, frequencia)								
				...
				'response.Write("<BR>"&co_materia_exibe(co))		
					...
					if resultado_disciplina(0)="&nbsp;" or resultado_disciplina(0)="" or isnull(resultado_disciplina(0)) then
						...
						media = resultado_disciplina(0) 'converte_conceito(unidade_t, curso_t, co_etapa_t, turma_t, 6, materia, resultado_disciplina(0)	, outro)

...
<table width="980" height="170" border="0" align="center" cellpadding="0" cellspacing="0" background="../../../../img/fundo_interno.gif" bgcolor="#FFFFFF">
  <tr> 
    <td valign="top"> <table width="980" border="0" align="right" cellpadding="0" cellspacing="0" class="tb_corpo">
        <tr> 
          <td width="980"><FORM METHOD="POST" ENCTYPE="multipart/form-data" ACTION="envia.asp?opt=f&al=<%Response.Write(ano_letivo_wf)%>&env=<%Response.Write(ambiente_escola)%>" target="_parent">
              <table width="980" border="0" align="right" cellpadding="0" cellspacing="0" class="tb_corpo">
                <tr bgcolor="#FFFFFF" background="../../../../img/fundo_interno.gif"> 
                  <td width="300" height="20"> <div align="right"><font class="form_dado_texto"> 
                  Nome da Pasta de Documentos: </font></div></td>
                  <td width="680" height="20"> <select name="tipo_doc" class="borda" onChange="gravarTipo(this.value)">
                                    <%
...
%>
                ...
                <tr> 
                  <td  width="300"> <div align="right"><font class="form_dado_texto">Arquivo 
                      1: </font></div></td>
                  <td width="680"> <INPUT TYPE=FILE SIZE=60 NAME="FILE1" class="borda"></td>
                </tr>
                <tr> 
                  <td width="300"> <div align="right"><font class="form_dado_texto">Arquivo 
                      2: </font></div></td>
                  <td width="680"> <INPUT TYPE=FILE SIZE=60 NAME="FILE2" class="borda"></td>
                </tr>
                <tr> 
                  <td width="300"> <div align="right"><font class="form_dado_texto">Arquivo 
                      3: </font></div></td>
                  <td width="680"> <INPUT TYPE=FILE SIZE=60 NAME="FILE3" class="borda"></td>
                </tr>
                <tr> 
                  <td width="300"> <div align="right"><font class="form_dado_texto">Arquivo 
                      4: </font></div></td>
                  <td width="680"> <INPUT TYPE=FILE SIZE=60 NAME="FILE4" class="borda"></td>
                </tr>
                <tr> 
                  <td width="300"> <div align="right"><font class="form_dado_texto">Arquivo 
                      5: </font></div></td>
                  <td width="680"> <INPUT TYPE=FILE SIZE=60 NAME="FILE5" class="borda"></td>
                </tr>
                <tr> 
                  <td colspan="2"><hr width="980"></td>
                </tr>
                <tr> 

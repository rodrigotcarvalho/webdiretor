...
%>
                      <div align="center">
                        <%response.Write("<br><br><br><br><br><font class=tabela_rodape>Não existe Boletim de Avaliações para este aluno!</font>")%>
                        </font></div>
                      <%
else
...
%>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
                          <td width="180" rowspan="2" class="tabela"> 
                            <div align="left">Disciplina</div></td>
                          <td width="33" rowspan="2"  class="tabela"><div align="center">F</div></td>
                          ...
                          <td width="190" rowspan="2" class="tabela"> 
                            <div align="center">Alterado 
                              por</div></td>
                          <td width="100" rowspan="2" class="tabela"> <div align="center">Data/Hora</div></td>
                        </tr>
                        <tr>
                          <td width="33"  class="tabela"> 
...
> <div align="right"><font class="tabela_rodape"> T-Teste, MT–Média dos Testes, PR-Prova, 
                              MP–Média das Provas, N-Nota, M-M&eacute;dia e P-Peso</font></div></td>
                        </tr>
                      </table>
...
%>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
                          <td width="190" rowspan="2" class="tabela"> 
                            <div align="left">Disciplina</div></td>
                          <td width="37" rowspan="2"  class="tabela"><div align="center">F</div></td>
                          ...
                          <td colspan="2"  class="tabela"> <div align="center">PR2</div>
                            <div align="center"></div></td>
                          <td width="37" class="tabela"> 
                            <div align="center">M1</div></td>
                          <td width="37"  class="tabela"> 
                          ...
                          <td width="37"  class="tabela"> 
                            <div align="center">M3</div></td>
                          <td width="167" rowspan="2" class="tabela"> <div align="center">Alterado 
                              por</div></td>
                          <td width="105" rowspan="2" class="tabela"> <div align="center">Data/Hora</div></td>
                        </tr>
                        <tr>
                          <td width="37"  class="tabela"> 
                            <div align="center">N</div></td>
		...
		> <div align="right"><font class="tabela_rodape"> T-Teste, MT–Média dos Testes, 
                              PR-Prova, MP–Média das Provas, N-Nota, M-M&eacute;dia 
...
%>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
                          ...
                          <td width="37"  class="tabela"> 
                            <div align="center">M3</div></td>
                          <td width="164" rowspan="2" class="tabela"> <div align="center">Alterado 
                              por</div></td>
                          <td width="105" rowspan="2" class="tabela"> <div align="center">Data/Hora</div></td>
                        </tr>
                        <tr>

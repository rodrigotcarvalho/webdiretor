		...
		tp_vinc_familiar_aux=RSCONTATO("TP_Contato_Vinc")
			...
			'response.Write(">>"&nascimento)
				if isnull(nascimento) or nascimento="" then
					...
					mes_n = vetor_nascimento(1)
					ano_n = vetor_nascimento(2)
'					mes_n = vetor_nascimento(0)					
'					dia_n = vetor_nascimento(1)
'					ano_n = vetor_nascimento(2)
...
'								ano_n = vetor_nascimento(2)								
			...
			if isnull(emissao) or emissao="" then
				...
				mes_e = vetor_emissao(1)
				ano_e = vetor_emissao(2)
'				mes_e = vetor_emissao(0)				
'				dia_e = vetor_emissao(1)
'				ano_e = vetor_emissao(2)				
...
%>
                      ...
                      <tr> 
                        ...
                        <td width="140" height="10">
<%if opt="i" then%>
<marquee id="mqLooper1" loop="1" onStart="MM_callJS('document.inclusao.nome_familiar.focus()')"></marquee>
<%end if%>						 
                        </td>
                        <td width="19"> 

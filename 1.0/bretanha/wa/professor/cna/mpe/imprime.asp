...
if periodo=4 then
	if nota = "TB_NOTA_A" Then	
		CAMINHOn = CAMINHO_na
		Call notas(CAMINHO_al,CAMINHOn,unidade,curso,co_etapa,turma,co_materia,periodo,ano_letivo,co_usr,"A","imp",4)	
		'response.Redirect("imprime_a.asp?p="&p&"&obr="&obr)
	elseif nota = "TB_NOTA_B" Then
		CAMINHOn = CAMINHO_nb
		Call notas(CAMINHO_al,CAMINHOn,unidade,curso,co_etapa,turma,co_materia,periodo,ano_letivo,co_usr,"B","imp",4)
		'response.Redirect("imprime_b.asp?p="&p&"&obr="&obr)
	elseif nota = "TB_NOTA_C" Then
		CAMINHOn = CAMINHO_nc
		Call notas(CAMINHO_al,CAMINHOn,unidade,curso,co_etapa,turma,co_materia,periodo,ano_letivo,co_usr,"C","imp",4)

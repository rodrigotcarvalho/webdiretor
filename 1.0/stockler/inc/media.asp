...
periodofil = periodo
		...
		SQLnFIL = "SELECT * FROM "&notaFIL&" where CO_Matricula ="& codigo &" AND CO_Materia ='"& materia_fil &"' AND CO_Materia_Principal ='"& materia_fil &"'"
...
periodofil = periodo
		...
		Set RSnFIL = Server.CreateObject("ADODB.Recordset")
		SQLnFIL = "SELECT * FROM "&notaFIL&" where CO_Matricula ="& codigo &" AND CO_Materia ='"& materia_fil &"' AND CO_Materia_Principal ='"& materia &"'"
		RSnFIL.Open SQLnFIL, CONn
...
periodofil = periodo
		...
		Set RSnFIL = Server.CreateObject("ADODB.Recordset")
		SQLnFIL = "SELECT * FROM "&notaFIL&" where CO_Matricula ="& codigo &" AND CO_Materia ='"& materia &"' AND CO_Materia_Principal ='"& materia &"'"
		RSnFIL.Open SQLnFIL, CONn

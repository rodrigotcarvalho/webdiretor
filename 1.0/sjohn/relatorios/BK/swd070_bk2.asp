...
if ubound(aluno_ordena)=-1 then
	...
	Row.Cells(1).AddText "<div align=""Center""><font style=""font-size:8pt;"">N&atilde;o existem alunos com notasdispon&iacute;veis para c&aacute;lculo da m&eacute;dia solicitada</font></div>", param_table2	

...
<%end if%>
          <td width="170" rowspan="2" class="tabela" 
><div align="center">Alterado por</div></td>
          <td width="115" rowspan="2" class="tabela" 
...
> <div align="center"> 
              <%
			  				if showapr="s" then
	if va_sapr="" or isnull(va_sapr) or va_sapr="&nbsp;"then
								response.Write("&nbsp;")
	else						
...
<%else%>  
    <td colspan="2"><div align="right"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">F- 
        Faltas , N-Nota Apr, P-Peso Apr, SAPR – Média das Aprs, PR- Prova e MP 
        – Média Período</font></div></td>
<%end if%>		
  </tr>
  <tr> 

...
ano_letivo = session("ano_letivo") 
		...
		'Response.write("OK"&RSal("DT_Incio_FI"))		
...
<table width="170" style="BORDER-TOP: #a8adb0 1px solid; BORDER-RIGHT: #a8adb0 1px solid; BORDER-LEFT: #a8adb0 1px solid; BORDER-BOTTOM: #a8adb0 1px solid">
  ...
  <%IF tp="R" THEN%> 
<!--  <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#336600">
<div align="center"><font class="menu_lista">Coordena&ccedil;&atilde;o de Ensino</font></div></td>
  ...
  <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#336600"> 
      <div align="center"><font class="menu_lista">Relat&oacute;rios</font></div></td>
  </tr>
  <!--
<tr> 
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
  ...
  <tr> 
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
                onmouseout="this.className='menuc'"><img src="img/menu_seta.gif" width="19" height="15" /><a href="resultados/avprog/index.asp" class="menu_sublista">Relat&oacute;rios 
      Parciais</a></td>
  </tr>
<!--  <tr> 
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
  ...
  <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#336600">
<div align="center"><font class="menu_lista">Informa&ccedil;&otilde;es</font></div></td>-->
    <td height="24" class=menud  style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menue'" onmouseout="this.className='menuf'"><div align="center"><a href="docs/index.asp" class="menu_lista">Informa&ccedil;&otilde;es</a></div></td>
  </tr>
 <!--   <tr> 
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
...
<div align="center"><font class="menu_lista">Agenda do Ano Letivo</font></div></td>
 ...
 <% 
  ...
  <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#336600"><div align="center"><font class="menu_lista">Posi&ccedil;&atilde;o 

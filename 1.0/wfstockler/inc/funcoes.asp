...
tipoR = tipoResponsavel(session("co_user"))
ligaRematricula = ehPeriodoRematricula()
...
<%if ligaRematricula = "S" then
    if tipoR="F" then
%>
 <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#006699"><div align="center"><font class="menu_lista">Rematr&iacute;cula 
        Escolar</font></div></td>
  </tr>
  <tr> 
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
                onmouseout="this.className='menuc'"><img src="img/menu_seta.gif" width="19" height="15" /><a href="rematricula/rem/index.asp" class="menu_sublista">Renovar Matr&iacute;cula</a></td>
  </tr>
<%end if
end if
%>
  ...
  <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#006699"><div align="center"><font class="menu_lista">Aproveitamento 
        Escolar</font></div></td>
  </tr>
  <tr> 
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
  ...
  <tr> 
    <td height="24" class=menud  style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menue'" onmouseout="this.className='menuf'"><div align="center"><a href="docs/index.asp" class="menu_lista">Documentos</a></div></td>
  </tr>
<!--  <tr> 
    <td height="24" class=menua style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
...
<!--  <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#006699"><div align="center"><font class="menu_lista">Agenda 
...
<% if tp="R" then%>  
  <tr>
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#006699"><div align="center"><font class="menu_lista">Posi&ccedil;&atilde;o 
      Financeira</font></div></td>
  </tr>
  <tr>
    <td height="24" class="menua" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
                onmouseout="this.className='menuc'"><img src="img/menu_seta.gif" alt="" width="19" height="15" /><a href="posfin/extrato/index.asp" class="menu_sublista">Extrato</a></td>
  </tr>
  <tr>
    <td height="24" class="menua" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid" onmouseover="this.className='menub'" 
                onmouseout="this.className='menuc'"><img src="img/menu_seta.gif" alt="" width="19" height="15" /><a href="posfin/segvia/index.asp" class="menu_sublista">2&ordf; 
      Via de Boleto</a></td>
  </tr>
<%END IF%>  
  <tr> 
    <td height="24" style="BORDER-RIGHT: #cccccc 1px solid; BORDER-TOP: #ffffff 1px solid; BORDER-BOTTOM: #999999 1px solid"  bgcolor="#006699"><div align="center"><font class="menu_lista">Seguran&ccedil;a</font></div></td>
  </tr>
  <tr> 

...
>
  <tr> 
    ...
    <td width="741" bgcolor="#FFFFFF"><table width="100%" border="0" align="right" cellspacing="0">
        ...
        <tr> 
          <td colspan="2"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>FATOS RELEVANTES
...
response.Write(no_curso)%> </td>
  ...
  <tr> 
    <td colspan="2"> <table width="1000" border="0" cellspacing="0" bordercolor="#000000" bgcolor="#FFFFFF">
        <tr > 
          <td height="10" colspan="4" class="tabelaTit"><div align="left">Fatos Relevantes Resumidos</div></td>
        </tr>
        <tr > 
          <td class="tabelaTit" width="30">&nbsp;</td>
          <td class="tabelaTit" width="594" height="10"><div align="left">Fato Relevante</div></td>
...
END IF%>
        ...
        <tr> 
          <td height="15"  class="tabelaTit" colspan="4"><table width="1000" border="0" cellspacing="0" bordercolor="#000000" bgcolor="#FFFFFF">
              <tr> 
                <td height="10" colspan="7" class="tabelaTit"><div align="left">Fatos Relevantes 
                Detalhados</div></td>
              </tr>
              <tr> 
                <td width="30" height="10"  class="tabelaTit">&nbsp; </td>
                <td width="130"  class="tabelaTit"> <div align="left">Data / Hora</div></td>
                <td width="305"  class="tabelaTit"> <div align="left">Fato Relevante</div></td>
...
%>
              <tr> 
                ...
                <td width="305"  class="tabela"> <div align="left"> Nenhum fato relevante
                cadastrado para este Aluno</div></td>
